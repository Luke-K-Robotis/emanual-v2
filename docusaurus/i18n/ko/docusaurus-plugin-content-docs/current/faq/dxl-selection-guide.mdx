...
## 기타 제어기
로보티즈는 [다이나믹셀 시스템](https://emanual.robotis.com/docs/kr/platform/)과 [교육용 키트](/docs/edu)에서 사용되는 다양한 제어기를 제공하고 있습니다. 자세한 내용은, [제어기](https://emanual.robotis.com/docs/en/parts/all-controller/) 페이지를 참고하세요.
...
### 로보플러스
CM 시리즈와 교육용 키트에서 사용할 수 있는 소프트웨어인, R+ (로보플러스)는 유저 친화적 프로그래밍 환경을 지원합니다. 더 많은 정보는 [로보플러스](https://emanual.robotis.com/docs/kr/software/#로보플러스)를 참고하세요. 
...
[Software]: https://emanual.robotis.com/docs/kr/software/
