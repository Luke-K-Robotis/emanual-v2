...
title: "PC에서 파이썬 예제 다운로드 하기"
sidebar_label: "PC에서 파이썬 예제 다운로드 하기"
...
4. Python 편집창에서 예제 프로그램 코드가 열린 것을 확인한 후 `장치 선택`을 클릭합니다.
    ...
    ![](/img/edu/engineer/kit2/tsk3_python_code_download_01_kr.webp)  

    ![](/img/edu/engineer/kit2/tsk3_python_code_download_02_kr.webp)  

5. `로봇 연결하기` 창이 나타나면 `새로 고침`을 눌러 검색된 장치를 선택하고 `연결하기`를 누릅니다.
  
    ![](/img/edu/engineer/kit2/tsk3_python_code_download_03_kr.webp) 

6. 장치 연결이 완료되면 표시된 `다운로드` 버튼을 눌러 제어기에 예제 프로그램을 다운로드합니다.

    ![](/img/edu/engineer/kit2/tsk3_python_code_download_04_kr.webp)
