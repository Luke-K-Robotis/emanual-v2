...
4. R+ Task 3.0을 실행시킨 후, 왼쪽 하단의 `연결`버튼을 클릭 해주세요.

    ![](/img/edu/engineer/kit1/remote_pairing_01.png)  

5. BT-410 동글을 사용할 경우 반드시 `Use USB Dongle` 옵션을 선택해주세요.

    ![](/img/edu/engineer/kit1/remote_pairing_02.png)  

6. 사용할 시리얼 포트를 선택해 주세요.

    ![](/img/edu/engineer/kit1/remote_pairing_03.png)  

7. 연결 버튼을 클릭하여, PC와 제어기를 연결시켜 주세요.   

    ![](/img/edu/engineer/kit1/remote_pairing_04.png)  

8. 연결이 성공적으로 완료되면 '삐비빅' 소리가 납니다.  

    ![](/img/edu/engineer/kit1/remote_pairing_05.png)  
