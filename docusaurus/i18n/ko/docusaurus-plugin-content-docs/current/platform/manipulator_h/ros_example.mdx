...
```
![](/img/platform/manipulator_h/manipulator_h_rviz.webp)
...
![](/img/platform/manipulator_h/manipulator_h_gui.webp)  
...
```
![](/img/platform/manipulator_h/manipulator_h_gazebo.webp)  
