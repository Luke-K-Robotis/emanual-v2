...
`Reference` : [Creating new robot manager](https://emanual.robotis.com/docs/en/software/robotis_framework_packages/tutorials/#creating-new-robot-manager)
...
[std_msgs/Int32]: https://emanual.robotis.com/docs/en/popup/std_msgs_int32_message/
[std_msgs/String]: https://emanual.robotis.com/docs/en/popup/std_msgs_string/
[std_msgs/Bool]: https://emanual.robotis.com/docs/en/popup/std_msgs_bool_msg/
...
[geometry_msgs/WrenchStamped]: https://emanual.robotis.com/docs/en/popup/geometry_msgs_WrenchStamped_msg/
[sensor_msgs/PointCloud2]: https://emanual.robotis.com/docs/en/popup/sensor_msgs_PointCloud2_msg/
[sensor_msgs/Imu]: https://emanual.robotis.com/docs/en/popup/sensor_msgs_IMU_msg/
[sensor_msgs/JointState]: https://emanual.robotis.com/docs/en/popup/sensor_msgs_JointState_msg/
[visualization_msgs/MarkerArray]: https://emanual.robotis.com/docs/en/popup/visualization_msgs_MarkerArray_msg/
[StartAction.msg]: https://emanual.robotis.com/docs/en/popup/StartAction.msg/
[robotis_controller_msgs/StatusMsg]: https://emanual.robotis.com/docs/en/popup/StatusMsg.msg/
[robotis_controller_msgs/JointCtrlModule]: https://emanual.robotis.com/docs/en/popup/JointCtrlModule.msg/
[robotis_controller_msgs/GetJointModule]: https://emanual.robotis.com/docs/en/popup/GetJointModule.srv/
[robotis_controller_msgs/Status]: https://emanual.robotis.com/docs/en/popup/StatusMsg.msg/
[thormang3_action_module]: /docs/platform/thormang3/thormang3_ros_packages#thormang3-action-module
[thormang3_action_module_msgs/StartAction]: https://emanual.robotis.com/docs/en/popup/StartAction.msg/
[thormang3_action_module_msgs/IsRunning]: https://emanual.robotis.com/docs/en/popup/(thormang3_action_module_msgs)IsRunning.srv/
...
[thormang3_offset_tuner_msgs/JointOffsetData.msg]: https://emanual.robotis.com/docs/en/popup/JointOffsetData.msg/
[thormang3_offset_tuner_msgs/JointOffsetPositionData.msg]: https://emanual.robotis.com/docs/en/popup/JointOffsetPositionData.msg/
[thormang3_offset_tuner_msgs/JointTorqueOnOff.msg]: https://emanual.robotis.com/docs/en/popup/JointTorqueOnOff.msg/
[thormang3_offset_tuner_msgs/JointTorqueOnOffArray.msg]: https://emanual.robotis.com/docs/en/popup/JointTorqueOnOffArray.msg/
[thormang3_offset_tuner_msgs/GetPresentJointOffsetData.srv]: https://emanual.robotis.com/docs/en/popup/GetPresentJointOffsetData.srv/
[thormang3_manipulation_module_msgs/KinematicsPose]: https://emanual.robotis.com/docs/en/popup/KinematicsPose.msg/
[thormang3_manipulation_module_msgs/JointPose]: https://emanual.robotis.com/docs/en/popup/JointPose.msg/
[thormang3_manipulation_module]: /docs/platform/thormang3/thormang3_ros_packages#thormang3-manipulation-module
[thormang3_manipulation_module_msgs/GetJointPose]: https://emanual.robotis.com/docs/en/popup/GetJointPose.srv/
[thormang3_manipulation_module_msgs/GetKinematicsPose]: https://emanual.robotis.com/docs/en/popup/GetKinematicsPose.srv/
[thormang3_feet_ft_module]: /docs/platform/thormang3/thormang3_ros_packages#thormang3-feet-ft-module
[thormang3_feet_ft_module_msgs/BothWrench]: https://emanual.robotis.com/docs/en/popup/BothWrench.msg/
[thormang3_foot_step_generator/FootStepCommand]: https://emanual.robotis.com/docs/en/popup/FootStepCommand.msg/
[thormang3_foot_step_generator/Step2DArray]: https://emanual.robotis.com/docs/en/popup/Step2DArray.msg
[thormang3_walking_module_msgs/GetReferenceStepData]: https://emanual.robotis.com/docs/en/popup/GetReferenceStepData.srv/
[thormang3_walking_module]: /docs/platform/thormang3/thormang3_ros_packages#thormang3-walking-module
[thormang3_walking_module_msgs/GetReferenceStrpData]: https://emanual.robotis.com/docs/en/popup/GetReferenceStepData.srv/
[thormang3_walking_module_msgs/AddStepDataArray]: https://emanual.robotis.com/docs/en/popup/AddStepDataArray.srv/
[thormang3_walking_module_msgs/SetBalanceParam]: https://emanual.robotis.com/docs/en/popup/SetBalanceParam.srv/
[thormang3_walking_module_msgs/IsRunning]: https://emanual.robotis.com/docs/en/popup/(thormang3_walking_module_msgs)IsRunning.srv/
[thormang3_walking_module_msgs/WalkingStart]: https://emanual.robotis.com/docs/en/popup/StartWalking.srv/
[thormang3_walking_module_msgs/RemoveExistingStepData]: https://emanual.robotis.com/docs/en/popup/RemoveExistingStepData.srv/
[thormang3_walking_module_msgs/StepData]: https://emanual.robotis.com/docs/en/popup/StepData.msg/
[thormang3_walking_module_msgs/BalanceParam]: https://emanual.robotis.com/docs/en/popup/BalanceParam.msg/
[thormang3_head_control_module]: /docs/platform/thormang3/thormang3_ros_packages#thormang3-head-control-module
[thormang3_head_control_module_msgs/HeadJointPose]: https://emanual.robotis.com/docs/en/popup/HeadJointPose.msg
[robotis_controller_msgs/SyncWriteItem]: https://emanual.robotis.com/docs/en/popup/SyncWriteItem.msg
[robotis_controller_msgs/SetModule]: https://emanual.robotis.com/docs/en/popup/SetModule.srv
[robotis_controller_msgs/LoadOffset]: https://emanual.robotis.com/docs/en/popup/LoadOffset.srv
[thormang3_tuning_module_msgs/JointOffsetData.msg]: https://emanual.robotis.com/docs/en/popup/JointOffsetData2.msg
[thormang3_tuning_module_msgs/JointOffsetPositionData.msg]: https://emanual.robotis.com/docs/en/popup/JointOffsetPositionData2.msg
[thormang3_tuning_module_msgs/JointsOffsetPositionData.msg]: https://emanual.robotis.com/docs/en/popup/JointsOffsetPositionData.msg
[thormang3_tuning_module_msgs/JointTorqueOnOffArray.msg]: https://emanual.robotis.com/docs/en/popup/JointTorqueOnOffArray2.msg
[thormang3_tuning_module_msgs/JointTorqueOnOff.msg]: https://emanual.robotis.com/docs/en/popup/JointTorqueOnOff2.msg
[thormang3_tuning_module_msgs/GetPresentJointOffsetData.srv]: https://emanual.robotis.com/docs/en/popup/GetPresentJointOffsetData2.srv
[JointPose.msg]: https://emanual.robotis.com/docs/en/popup/JointPose.msg/
[JointFeedBackGain.msg]: https://emanual.robotis.com/docs/en/popup/JointFeedBackGain.msg/
[thormang3_alarm_module_msgs/JointOverload.msg]: https://emanual.robotis.com/docs/en/popup/JointOverload.msg/
[thormang3_alarm_module_msgs/JointOverloadStatus.msg]: https://emanual.robotis.com/docs/en/popup/JointOverloadStatus.msg/
[IsRunning.srv]: https://emanual.robotis.com/docs/en/popup/(thormang3_action_module_msgs)IsRunning.srv/
[laser_assembler/AssembleScan2]: https://emanual.robotis.com/docs/en/popup/laser_assembler_AssembleScan2_srv/
...
[KinematicsPose.msg]: https://emanual.robotis.com/docs/en/popup/KinematicsPose.msg/
[GetReferenceStepData.srv]: https://emanual.robotis.com/docs/en/popup/GetReferenceStepData.srv/
[AddStepDataArray.srv]: https://emanual.robotis.com/docs/en/popup/AddStepDataArray.srv/
[SetBalanceParam.srv]: https://emanual.robotis.com/docs/en/popup/SetBalanceParam.srv/
[BothWrench.msg]: https://emanual.robotis.com/docs/en/popup/BothWrench.msg/
[GetJointPose.srv]: https://emanual.robotis.com/docs/en/popup/GetJointPose.srv/
[GetKinematicsPose.srv]: https://emanual.robotis.com/docs/en/popup/GetKinematicsPose.srv/
[Remote Control(GUI Demo)]: /docs/platform/thormang3/thormang3_operation#gui-program
[FootStepCommand.msg]: https://emanual.robotis.com/docs/en/popup/FootStepCommand.msg/
[Step2D.msg]: https://emanual.robotis.com/docs/en/popup/Step2D.msg/
[Step2DArray.msg]: https://emanual.robotis.com/docs/en/popup/Step2DArray.msg/
[BalanceParam.msg]: https://emanual.robotis.com/docs/en/popup/BalanceParam.msg/
[DampingBalanceParam.msg]: https://emanual.robotis.com/docs/en/popup/DampingBalanceParam.msg/
[PoseXYZRPY.msg]: https://emanual.robotis.com/docs/en/popup/PoseXYZRPY.msg/
[PoseZRPY.msg]: https://emanual.robotis.com/docs/en/popup/PoseZRPY.msg/
[RobotPose.msg]: https://emanual.robotis.com/docs/en/popup/RobotPose.msg/
[StepData.msg]: https://emanual.robotis.com/docs/en/popup/StepData.msg/
[StepPositionData.msg]: https://emanual.robotis.com/docs/en/popup/StepPositionData.msg/
[StepTimeData.msg]: https://emanual.robotis.com/docs/en/popup/StepTimeData.msg/
[WalkingJointStatesStamped.msg]: https://emanual.robotis.com/docs/en/popup/WalkingJointStatesStamped.msg/
[RemoveExistingStepData.srv]: https://emanual.robotis.com/docs/en/popup/RemoveExistingStepData.srv/
[SetDampingBalanceParam.srv]: https://emanual.robotis.com/docs/en/popup/SetDampingBalanceParam.srv/
[SetJointFeedBackGain.srv]: https://emanual.robotis.com/docs/en/popup/SetJointFeedBackGain.srv/
[StartWalking.srv]: https://emanual.robotis.com/docs/en/popup/StartWalking.srv/
[HeadJointPose.msg]: https://emanual.robotis.com/docs/en/popup/HeadJointPose.msg/
...
[humanoid_nav_msgs/PlanFootsteps]: https://emanual.robotis.com/docs/en/popup/humanoid_nav_msgs_planfootsteps_srv/
