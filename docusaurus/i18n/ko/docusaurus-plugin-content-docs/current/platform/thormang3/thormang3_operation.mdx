...
3. Run Visualization Tool  
  ...
  ```
    ...
    ![](/img/platform/thormang3/thormang3_047.png)
...
6. Check all joints are switched to selected mode.  
    ![](/img/platform/thormang3/thormang3_048.png)
...
7. Initial Posture  
  ...
  Click `Robot Init Pose` button at the top of demo program(Effective regardless of current mode)  
    ...
    ![](/img/platform/thormang3/thormang3_049.png)

    ![](/img/platform/thormang3/thormang3_050.png)
...
1. Move to Robot Init Pose
  - Click `Robot Init Pose` button on the top.  
    ...
    ![](/img/platform/thormang3/thormang3_051.jpg)
...
2. Measure FT Air  
  ...
  - **THORMANG3 must be hanging on the lift for this procedure.**
    ...
    ![](/img/platform/thormang3/thormang3_052.jpg)
...
3. Measure FT Ground  
    ...
    ![](/img/platform/thormang3/thormang3_053.jpg)
...
- Assemble LaserScan  
  ...
  Click `Make PointCloud` button in the `Basic Control` of the demo program.  
      ...
      ![](/img/platform/thormang3/thormang3_056.png)
  ...
  3. Check the pointcloud  
    Assembled pointcloud can be seen on the RViz screen.  
      ...
      - Check PointCloud on the 3D screen  
        ...
        ![](/img/platform/thormang3/thormang3_057.png)
...
- Head Joint Control  
  ...
  ![](/img/platform/thormang3/thormang3_058.png)
...
![](/img/platform/thormang3/thormang3_059.png)
...
![](/img/platform/thormang3/thormang3_060.jpg)
...
1. Move to Robot Init Pose
  - Click the `Robot Init Pose` button.  
    ...
    ![](/img/platform/thormang3/thormang3_061.png)
...
4. Balance On
  ...
  - Click `On` button in the `Balance Control`.
    ...
    ![](/img/platform/thormang3/thormang3_064.jpg)
...
![](/img/platform/thormang3/thormang3_075.png)
...
### How to use GUI program
![](/img/platform/thormang3/thormang3_tuner_client_01.png)    
...
[thormang3_sensors.launch]: https://emanual.robotis.com/docs/en/popup/thormang3_sensors.launch
[thormang3_manager.launch]: https://emanual.robotis.com/docs/en/popup/thormang3_manager.launch
...
[Usage]: /docs/platform/thormang3/thormang3_ros_packages#thormang3-walking-module
...
[thormang3_sensors]: /docs/platform/thormang3/thormang3_ros_packages#thormang3-sensors/
[thormang3_manager]: /docs/platform/thormang3/thormang3_ros_packages#thormang3-manager/
[ROBOTIS-THORMANG-OPC]: /docs/platform/thormang3/thormang3_ros_packages#opc-packages
[ROBOTIS-THORMANG-Common]: /docs/platform/thormang3/thormang3_ros_packages#common-packages
[Example Setting for OPC]: /docs/platform/thormang3/getting_started#example-setting-for-opc
...
[thormang3_foot_step_generator]: /docs/platform/thormang3/thormang3_ros_packages#thormang3-foot-step-generator
[How to calibrate feet ft sensors]: /docs/platform/thormang3/thormang3_operation#calibrate-ft-sensors
[footstep_planner]: /docs/platform/thormang3/thormang3_ros_packages#footstep-planner
