...
import GettingStartedRev2 from '@site/docs/_partials/platform/op3/getting_started_rev2.mdx';
...
![](/img/platform/op3/op3_connection.webp)   
...
#### How to Connect
 - **SSH**
   ...
   ![](/img/platform/op3/op3_connection_ssh2.webp)
