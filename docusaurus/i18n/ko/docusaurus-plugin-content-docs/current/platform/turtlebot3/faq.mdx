...
2. Press and hold the `SW2` button and click the `Reset` button. If the `Status` LED is blinking, release the `SW2` button. See [Boot Sequence](https://emanual.robotis.com/docs/en/parts/controller/opencr10/#boot-sequence) for more information.
