...
![](/img/platform/turtlebot3/more_info/additional_sensors/touch_sensor.png)

(Front side)

![](/img/platform/turtlebot3/more_info/additional_sensors/touch_sensor_front.png)

(Back side)

![](/img/platform/turtlebot3/more_info/additional_sensors/touch_sensor_back.png)
...
![](/img/platform/turtlebot3/more_info/additional_sensors/IR_sensor.png)

![](/img/platform/turtlebot3/more_info/additional_sensors/IR_sensor_front.png)
...
![](/img/platform/turtlebot3/more_info/additional_sensors/sonar.png)
...
![](/img/platform/turtlebot3/more_info/additional_sensors/illumination.png)

![](/img/platform/turtlebot3/more_info/additional_sensors/illumination_front.png)
...
![](/img/platform/turtlebot3/more_info/additional_sensors/led.png)

![](/img/platform/turtlebot3/more_info/additional_sensors/led_top.png)
