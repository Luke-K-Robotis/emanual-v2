...
![](/img/platform/turtlebot3/overview/challenges/competition_autorace.webp)
...
For more information or if you want to launch it in your remote PC, please visit [Autonomous Driving](/docs/platform/turtlebot3/autonomous_driving#autonomous-driving) section.

#### Task Mission using TurtleBot3 and OpenManipulator on RDS

![](/img/platform/turtlebot3/overview/challenges/competition_pick_and_place.webp)
...
For more information about it or if you want to launch it in your remote PC, please visit [Manipulation](/docs/platform/turtlebot3/manipulation#bringup) section.
...
![](/img/platform/turtlebot3/overview/challenges/autorace_dankook_1.webp)
![](/img/platform/turtlebot3/overview/challenges/autorace_dankook_2.webp)
...
#### AutoRace RBIZ Challenge 2017
![](/img/platform/turtlebot3/autonomous_driving/autorace_rbiz_challenge_2017_robots_2.webp)
...
[learn_the_construct]: /docs/platform/turtlebot3/learn#the-construct
