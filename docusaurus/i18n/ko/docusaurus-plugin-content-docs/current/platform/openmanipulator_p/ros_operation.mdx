...
```
  ...
  ![](/img/platform/openmanipulator_p/OpenManipulator_GUI.webp) 

  Check the status of the OpenMANIPULATOR-P (joint states, kinematics pose).  
  
  ![](/img/platform/openmanipulator_p/OpenManipulator_GUI2.webp) 
  ...
  ![](/img/platform/openmanipulator_p/OpenManipulator_GUI3.webp)  
  ...
  ![](/img/platform/openmanipulator_p/OpenManipulator_GUI4.webp)    
  ...
  ![](/img/platform/openmanipulator_p/OpenManipulator_GUI5.webp) 
