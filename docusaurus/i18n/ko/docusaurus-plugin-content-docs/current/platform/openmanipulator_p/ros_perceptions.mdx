...
#### Astra Pro
![](/img/platform/openmanipulator_x/OpenManipulator_camera_Astra_pro.webp)  
...
#### Realsense D435
![](/img/platform/openmanipulator_x/OpenManipulator_camera_Realsense_D435.webp)  
...
1. **[Raspberry Pi]** Setting up the camera hardware.
    ...
    ![](/img/platform/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-1.webp)

2. Select **3 Interfacing Options**.

    ![](/img/platform/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-2.webp)

3. Select **P1 Camera**.
    
    ![](/img/platform/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-3.webp)

4. Enable camera interface.

    ![](/img/platform/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-4.webp)    
    
    ![](/img/platform/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-5.webp)
...
![](/img/platform/openmanipulator_x/OpenManipulator_AR_Marker.webp)
