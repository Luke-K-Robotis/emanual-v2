...
## Dimension
![](/img/platform/openmanipulator_p/dimension.webp)

If you have a gripper([RH-P12-RN(A)](https://emanual.robotis.com/docs/en/platform/rh_p12_rna/)), see below.

![](/img/platform/openmanipulator_p/dimension_with_gripper.webp)

## Workspace
![](/img/platform/openmanipulator_p/ws1.webp)
  
![](/img/platform/openmanipulator_p/ws2.webp)  

## Home Position
The diagram below shows the “home position” of DYNAMIXEL-P from OpenMANIPULATOR-P.

![](/img/platform/openmanipulator_p/home_position.webp)

## D-H Configuration
![](/img/platform/openmanipulator_p/d_h_configuration.webp)
...
![](/img/platform/openmanipulator_p/mass1.webp)

Total Mass : 5,324g

### Link 1

![](/img/platform/openmanipulator_p/mass2.webp)
...
![](/img/platform/openmanipulator_p/mass3.webp)
...
![](/img/platform/openmanipulator_p/mass4.webp)
...
![](/img/platform/openmanipulator_p/mass5.webp)
...
![](/img/platform/openmanipulator_p/mass6.webp)
