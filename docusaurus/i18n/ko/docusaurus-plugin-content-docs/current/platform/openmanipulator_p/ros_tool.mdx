...
![](/img/platform/openmanipulator_p/open_manipulator_gripper_assembly_01.webp)

### Assembly Manual
1. Fix FRP42_A110K to the tip of OpenMANIPUALTOR-P with eight WB_M3X08_NYLOK_K screws.
 
    ![](/img/platform/openmanipulator_p/open_manipulator_gripper_assembly_02.webp)

2. Assemble RH-P12-RN Gripper on fixed frame(FRP42_A110K) and tighten four WB_M3X08_NYLOK_K screws.
  
    ![](/img/platform/openmanipulator_p/open_manipulator_gripper_assembly_03.webp)
...
3. Connect OpenMANIPULATOR-P and RH-P12-RN with CABLE_4P_180MM Cable.
    ...
    ![](/img/platform/openmanipulator_p/open_manipulator_gripper_assembly_04.webp)
...
![](/img/platform/openmanipulator_p/open_manipulator_gripper_operation_01.webp)


To activate RH-P12-RN (Gripper), Click the `Gripper open` button.


![](/img/platform/openmanipulator_p/open_manipulator_gripper_operation_02.webp)
