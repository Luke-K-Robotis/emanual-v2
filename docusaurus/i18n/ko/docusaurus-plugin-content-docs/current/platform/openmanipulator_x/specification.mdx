...
## Dimension
![](/img/platform/openmanipulator_x/OpenManipulator_Chain_spec_side.webp)
...
## Inertia
![](/img/platform/openmanipulator_x/manipulator-x-inertia.webp)

Total Mass : 711.37 gram

### Joint 1
![](/img/platform/openmanipulator_x/manipulator-x-inertia_joint1.webp)
...
![](/img/platform/openmanipulator_x/manipulator-x-inertia_joint2.webp)
...
![](/img/platform/openmanipulator_x/manipulator-x-inertia_joint3.webp)
...
![](/img/platform/openmanipulator_x/manipulator-x-inertia_joint4.webp)
...
![](/img/platform/openmanipulator_x/omx_urdf_graph.webp)  
...
![](/img/platform/openmanipulator_x/rviz_om_view.webp) 
