...
[프로그래밍(명령어)]: https://emanual.robotis.com/docs/en/software/rplus2/task/#프로그래밍명령어/
# 프로그래밍(파라미터)
R+ m.Task 2.0에서 사용하는 파라미터는 R+ Task 2.0과 동일합니다.  
R+ Task 2.0 매뉴얼의 [프로그래밍(파라미터)]를 참고하세요.

[프로그래밍(명령어)]: https://emanual.robotis.com/docs/en/software/rplus2/task/#프로그래밍파라미터/
# 유용한 정보
## 변수, 함수 참조 찾기
...
- [제어기호환표](https://emanual.robotis.com/docs/en/parts/controller/controller_compatibility/)를 참고하여, 제공된 제어기와 호환이 되는지 확인 하세요.
...
[로보플러스 매니저 1.0 펌웨어 업데이트]: https://emanual.robotis.com/docs/en/software/rplus1/manager/#펌웨어-업데이트/
[R+ Manager 2.0 펌웨어 업데이트]: https://emanual.robotis.com/docs/en/software/rplus2/manager/#펌웨어-업데이트/