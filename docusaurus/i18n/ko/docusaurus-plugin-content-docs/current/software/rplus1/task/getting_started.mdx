...
[룰 체크]: https://emanual.robotis.com/docs/en/software/rplus1/task/task_misc/#룰-체크/
[에러 메시지]: https://emanual.robotis.com/docs/en/software/rplus1/task/task_misc/#에러-메시지/
