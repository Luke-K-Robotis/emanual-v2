...
![img](/img/software/rplus1/motion/roboplusmotion_icon.webp)
...
![img](/img/software/rplus1/motion/roboplus_motion.webp)
...
![img_install](/img/software/roboplus_install.webp)
...
![img](/img/software/rplus1/motion/rmfm_robotmotion.webp)
...
![img](/img/software/rplus1/motion/rmfm_filemotion.webp)
...
2. 통신 포트를 선택합니다.  
    ...
    ![img](/img/software/rplus1/motion/conn_portselection.webp)

3. 로봇에 연결합니다. 연결 메뉴를 선택합니다.

    ![img](/img/software/rplus1/motion/conn_connecticon.webp)

    ![img](/img/software/rplus1/motion/conn_connectmenu.webp)
...
4. 로봇의 연결을 끊습니다.  
    ...
    ![img](/img/software/rplus1/motion/conn_disconnecticon.webp)
...
- 다운로드 버튼을 누르고 완료되기를 기다립니다.
  ...
  ![img](/img/software/rplus1/motion/down_menu.webp)

- 파일 모션의 내용이 로봇 모션에 옮겨진 것을 확인합니다.

  ![img](/img/software/rplus1/motion/down_result.webp)
...
![img](/img/software/rplus1/motion/playstop_motion_play.webp)
...
- 모션 실행 시도시 다음과 같은 문제가 발생할 수 있습니다.
  - 이 경우는 로봇 모션 창에서 작업할 경우 나타납니다. 이 문제는 Next나 Exit로 연결된 페이지가 수정되었고, 제어기 메모리가 작아서 임시로 저장할 수 없기  때문입니다.
    ...
    ![img](/img/software/rplus1/motion/playstop_motion_robot_play_error.webp)
  ...
  - 이 경우는 파일 모션 창에서 작업할 경우 나타납니다. 제어기가 아닌 PC에 데이터가 있는 경우 제어기 메모리가 작아서 Next나 Exit로 연결된 페이지를 임시로 저장할 수 없기 때문입니다.
    ...
    ![img](/img/software/rplus1/motion/playstop_motion_file_play_error.webp)
...
![img](/img/software/rplus1/motion/playstop_motion_stop.webp)
...
![img](/img/software/rplus1/motion/playstop_e_stop.webp)
...
![img](/img/software/rplus1/motion/poseedit_concept.webp)
...
![img](/img/software/rplus1/motion/basic_motion_edit.webp)

#### 관절 선택하기
마우스로 해당 줄을 클릭하면 1개의 관절을 선택할 수 있습니다. 여러 개의 관절을 선택하는 방법은 다음과 같습니다.
- 연속적으로 여러 관절을 선택

  ![img](/img/software/rplus1/motion/basic_joint_selection_3.webp)
...
- 개별적으로 여러 관절을 선택
  ...
  ![img](/img/software/rplus1/motion/basic_joint_selection_4.webp)
...
- 전체 관절 선택
  - 버튼을 눌러서 선택
    ...
    ![img](/img/software/rplus1/motion/basic_joint_selection_1.webp)

  - 메뉴를 선택

    ![img](/img/software/rplus1/motion/basic_joint_selection_2.webp)
...
![img](/img/software/rplus1/motion/basic_torque_1.webp)

토크를 On/Off시키는 방법은 다음과 같습니다.
- "켜기"버튼을 누르면 선택된 관절의 토크가 On됩니다.

  ![img](/img/software/rplus1/motion/basic_torque_2.webp)

- "끄기"버튼을 누르면 선택된 관절의 토크가 Off됩니다.

  ![img](/img/software/rplus1/motion/basic_torque_3.webp)

- 토크 토글(Toggle) 기능은 선택된 관절의 토크 On/Off상태를 전환시킵니다.

  ![img](/img/software/rplus1/motion/basic_torque_4.webp)

#### 관절 값 바꾸기
포즈에서 관절을 선택하면 해당 모터의 위치 값을 바꿀 수 있습니다.

![img](/img/software/rplus1/motion/basic_joint_value_1.webp)


#### 포즈 실행
포즈 실행은 스텝의 포즈를 로봇의 포즈로 옮겨서 로봇이 해당 포즈를 취하게 합니다.

![img](/img/software/rplus1/motion/stepwritebutton.webp)

![img](/img/software/rplus1/motion/basic_pose_1.webp)

#### 포즈 캡쳐
포즈 캡쳐(Capture)란, 로봇의 포즈를 스텝의 포즈로 옮겨서 데이터에 저장합니다.

![img](/img/software/rplus1/motion/stepgobutton.webp)

![img](/img/software/rplus1/motion/basic_pose_2.webp)
...
![img](/img/software/rplus1/motion/pose_copy_from_pose.webp)

![img](/img/software/rplus1/motion/pose_copy_from_memo.webp)

- 포즈 복사: 메뉴를 선택하거나 Ctrl+C를 눌러서 실행합니다.

  ![img](/img/software/rplus1/motion/pose_copy.webp)

- 포즈 붙여넣기: 메뉴를 선택하거나 Ctrl+V를 눌러서 실행합니다.

  ![img](/img/software/rplus1/motion/pose_paste.webp)
...
![img](/img/software/rplus1/motion/pose_mask.webp)

![img](/img/software/rplus1/motion/pose_mask_pic.webp)
...
![img](/img/software/rplus1/motion/poseutility.webp)
...
![img](/img/software/rplus1/motion/poseutility_robotselect.webp)
...
![img](/img/software/rplus1/motion/poseutility_3dview.webp)
...
![img](/img/software/rplus1/motion/poseutility_3djoint1.webp)

해당 관절을 마우스로 클릭하면 관절 값이 나타납니다. 관절 값은 모터 값이 아닌 각도로 표시됩니다.

![img](/img/software/rplus1/motion/poseutility_3djoint2.webp)
...
1. 교환하기
    ...
    ![img](/img/software/rplus1/motion/poseutility_mirror_exchange.webp)

    ![img](/img/software/rplus1/motion/poseutility_mirror1.webp)

2. 대칭
    대칭은 좌/우 한 쪽의 포즈를 기준으로 좌/우 대칭이 되도록 반대쪽의 포즈를 만들어 주기 위해 사용합니다.

    ![img](/img/software/rplus1/motion/poseutility_mirror_symmetry.webp)

    ![img](/img/software/rplus1/motion/poseutility_mirror2.webp)
...
![img](/img/software/rplus1/motion/poseutility_vieworigin.webp)
...
![img](/img/software/rplus1/motion/poseutility_ik_kinematics.webp)
...
![img](/img/software/rplus1/motion/poseutility_ik_inversekinematics.webp)
...
- Left Foot : 왼쪽 발만 움직이는 끝점이며 발바닥 가운데에 위치합니다.
  ...
  ![img](/img/software/rplus1/motion/poseutility_ik_selectendpoint.webp)
...
- 마우스로 더블 클릭을 하거나 `Enter`키를 누르면 값을 변경할 수 있는 컨트롤이 나타납니다.
  ...
  ![img](/img/software/rplus1/motion/poseutility_ik_descrip.webp)

- X(mm): X축 방향으로 mm단위로 이동합니다.

  ![img](/img/software/rplus1/motion/poseutility_ik_xmove.webp)

- Y(mm): Y축 방향으로 mm단위로 이동합니다.

  ![img](/img/software/rplus1/motion/poseutility_ik_ymove.webp)

- Z(mm): Z축 방향으로 mm단위로 이동합니다.

  ![img](/img/software/rplus1/motion/poseutility_ik_zmove.webp)

- &phi;(&deg;): X축을 기준으로 각도 단위로 회전합니다.

  ![img](/img/software/rplus1/motion/poseutility_ik_xamove.webp)

- &theta;(&deg;): Y축을 기준으로 각도 단위로 회전합니다.

  ![img](/img/software/rplus1/motion/poseutility_ik_yamove.webp)

- &psi;(&deg;): Z축을 기준으로 각도 단위로 회전합니다.

  ![img](/img/software/rplus1/motion/poseutility_ik_zamove.webp)
...
#### 포즈 실행/캡쳐
![img](/img/software/rplus1/motion/poseutility_gowritestep.webp)
...
![img](/img/software/rplus1/motion/step_concept_1.webp)

모션 스텝에는 모션의 실행 속도를 결정하는 재생 시간이 추가되어 있습니다. 스텝 편집기는 스텝을 보다 편리하게 편집할 수 있는 기능을 제공합니다.

![img](/img/software/rplus1/motion/step_editor.webp)
...
![img](/img/software/rplus1/motion/step_add.webp)

#### 스텝 삽입

선택한 스텝 앞에 새로운 스텝을 삽입합니다.

![img](/img/software/rplus1/motion/step_insert.webp)

#### 스텝 삭제

선택한 스텝을 리스트에서 삭제합니다.

![img](/img/software/rplus1/motion/step_delete.webp)

#### 스텝 이동

선택한 스텝의 순서를 바꿉니다.

![img](/img/software/rplus1/motion/step_move.webp)
...
- 아래쪽의 스크롤바로 시간을 바꿀 수 있습니다.
  ...
  ![img](/img/software/rplus1/motion/step_stop_time.webp)
...
- 아래쪽의 스크롤바로 시간을 바꿀 수 있습니다.
  ...
  ![img](/img/software/rplus1/motion/step_play_time.webp)
...
- 선택한 스텝을 복사할 수 있습니다.
  ...
  ![img](/img/software/rplus1/motion/step_copy.webp)

#### 스텝 잘라내기

- 선택한 스텝을 잘라냅니다.

  ![img](/img/software/rplus1/motion/step_cut.webp)

#### 스텝 붙여넣기

- 복사 혹은 잘라내기한 스텝을 붙여넣습니다. 붙여넣기할 때 선택한 스텝의 내용은 대체됩니다.

  ![img](/img/software/rplus1/motion/step_paste.webp)
...
![img](/img/software/rplus1/motion/pageeditor.webp)
...
- 연속적으로 여러 페이지를 선택
  ...
  ![img](/img/software/rplus1/motion/page_selection_2.webp)
...
- 개별적으로 여러 페이지를 선택
  ...
  ![img](/img/software/rplus1/motion/page_selection_1.webp)
...
- 전체 페이지 선택
  - 버튼을 눌러서 선택
    ...
    ![img](/img/software/rplus1/motion/page_selection_3.webp)
...
![img](/img/software/rplus1/motion/page_next_concept.webp)

이어지는 페이지는 연결될 페이지 번호를 사용합니다.

![img](/img/software/rplus1/motion/page_next.webp)

#### 마무리(Exit) 페이지

모션 정지를 명령했을 때, 대부분 현재 실행 중인 모션으로 인해 로봇은 매우 불안한 상태에 놓입니다. 보다 안정적인 상태로 로봇을 만들고 모션을 정지하고 싶을 때 마무리 페이지 기능을 사용합니다.

![img](/img/software/rplus1/motion/page_exit_concept.webp)

마무리 페이지는 연결될 페이지 번호를 사용합니다.

![img](/img/software/rplus1/motion/page_exit.webp)
...
- 선택한 페이지를 복사합니다.
  ...
  ![img](/img/software/rplus1/motion/page_copy.webp)

#### 페이지 잘라내기

- 선택한 페이지를 잘라냅니다.

  ![img](/img/software/rplus1/motion/page_cut.webp)

#### 페이지 붙여넣기

- 복사하거나 잘라낸 페이지를 붙여넣습니다. 붙여넣기할 때 선택된 페이지의 내용은 대체됩니다.

  ![img](/img/software/rplus1/motion/page_paste.webp)
...
- 모션 실행시 현재 페이지를 반복할 횟수입니다.
  ...
  ![img](/img/software/rplus1/motion/page_repeat.webp)
...
- 모션 실행시 현재 페이지의 재생 배속입니다. "스텝 실행 시간"과 달리 페이지 전체에 영향을 줍니다..
  ...
  - 1.0배속보다 크면 전체적으로 빨라집니다.
    ...
    ![img](/img/software/rplus1/motion/page_play_speed.webp)
...
- 관성력은 0 ~ 127까지 값을 설정해서 조절할 수 있습니다.(기본 값은 32입니다.)
  ...
  ![img](/img/software/rplus1/motion/page_compliance.webp)
...
- 7단계: 매우 높음
  ...
  ![img](/img/software/rplus1/motion/page_compliance_2.webp)
...
2. 로봇 모션 창을 선택한 후, 다른 이름으로 저장하기 메뉴를 선택합니다.
  ...
  ![img](/img/software/rplus1/motion/saveas.webp)
...
![img](/img/software/rplus1/motion/offset_menu.webp)
...
- -값은 모터를 기준으로 CW방향으로 더 움직인다는 뜻입니다.
  ...
  ![img](/img/software/rplus1/motion/offset_edit3.webp)

### 모션 오프셋 초기화

- 모션 오프셋 값을 모두 0으로 초기화시킵니다.

  ![img](/img/software/rplus1/motion/offset_reset.webp)

### 모션 오프셋 저장

- 현재 수정한 오프셋을 저장시킵니다. 이 기능은 오프셋 정보를 제어기 내부에 저장시킵니다.

  ![img](/img/software/rplus1/motion/offset_save.webp)

### 모션 오프셋 파일로 저장

- 현재 로봇의 오프셋 정보를 파일로 저장하여 PC에 보관할 수 있습니다. PC상에 모션 오프셋 파일은 확장자가 ofs인 형태로 존재합니다.

  ![img](/img/software/rplus1/motion/offset_file_save.webp)

### 모션 오프셋 다운로드

- PC에 보관중인 모션 오프셋 파일(ofs)을 로봇에 다운로드할 수 있습니다.

  ![img](/img/software/rplus1/motion/offset_download.webp)
...
- 페이지 편집창, 스텝 편집창, 포즈 편집창을 방향키로 포커스를 이동시킬 수 있습니다.
  ...
  ![img](/img/software/rplus1/motion/arrow_move.webp)
...
- `Enter`키를 누르면 설정창으로 포커스가 이동되고, 수정한 뒤 다시 `Enter`를 누르면 돌아갑니다.
  ...
  ![img](/img/software/rplus1/motion/joint_move.webp)
...
- 로봇의 포즈 편집창
  ...
  ![img](/img/software/rplus1/motion/robot_move.webp)

- 모션 오프셋 편집창

  ![img](/img/software/rplus1/motion/offset_move.webp)
...
![img](/img/software/rplus1/motion/robotinfo_xml.webp)
...
- **T**: 3D 변환에 사용되는 회전과 이동 정보가 포함된 3x4 행렬입니다. 각 요소는 공백 문자(Space)로 구분됩니다.
  ...
  ![img](/img/software/rplus1/motion/robotinfo_xml_matrix.webp)

- **id**: 다이나믹셀의 경우 id를 입력합니다.
- **type**: 움직이는 방법에 대해 정의합니다.
  - 모터 몸체가 움직이는 경우는 type을 “body”로 지정합니다.

    ![img](/img/software/rplus1/motion/robotinfo_xml_part.webp)

  - 몸체는 고정되고 연결된 혼(Horn)이 움직이는 경우는 고정할 대상에 “body”을 지정하고 움직일 대상에 “horn”을 지정합니다.

    ![img](/img/software/rplus1/motion/robotinfo_xml_part2.webp)
...
| 이름        | 모양                                                    | 파일            |
|:------------|:--------------------------------------------------------|:----------------|
| F1          | ![img](/img/software/rplus1/motion/f1.webp)          | f1.igs          |
| F2          | ![img](/img/software/rplus1/motion/f2.webp)          | f2.igs          |
| F3          | ![img](/img/software/rplus1/motion/f3.webp)          | f3.igs          |
| F4          | ![img](/img/software/rplus1/motion/f4.webp)          | f4.igs          |
| F5          | ![img](/img/software/rplus1/motion/f5.webp)          | f5.igs          |
| F6          | ![img](/img/software/rplus1/motion/f6.webp)          | f6.igs          |
| F7          | ![img](/img/software/rplus1/motion/f7.webp)          | f7.igs          |
| F8          | ![img](/img/software/rplus1/motion/f8.webp)          | f8.igs          |
| F9          | ![img](/img/software/rplus1/motion/f9.webp)          | f9.igs          |
| F10         | ![img](/img/software/rplus1/motion/f10.webp)         | f10.igs         |
| F11         | ![img](/img/software/rplus1/motion/f11.webp)         | f11.igs         |
| F12         | ![img](/img/software/rplus1/motion/f12.webp)         | f12.igs         |
| F15 + F16   | ![img](/img/software/rplus1/motion/f15+16.webp)      | f15.igs         |
| F51         | ![img](/img/software/rplus1/motion/f51.webp)         | f51.igs         |
| F52         | ![img](/img/software/rplus1/motion/f52.webp)         | f52.igs         |
| F53         | ![img](/img/software/rplus1/motion/f53.webp)         | f53.igs         |
| F56         | ![img](/img/software/rplus1/motion/f56.webp)         | f56.igs         |
| F57         | ![img](/img/software/rplus1/motion/f57.webp)         | f57.igs         |
| F58         | ![img](/img/software/rplus1/motion/f58.webp)         | f58.igs         |
| F60         | ![img](/img/software/rplus1/motion/f60.webp)         | f60.igs         |
| WA          | ![img](/img/software/rplus1/motion/wa.webp)          | wa,igs          |
| BU          | ![img](/img/software/rplus1/motion/bu.webp)          | bu.igs          |
| CM-5        | ![img](/img/software/rplus1/motion/cm5.webp)         | cm-5.igs        |
| ADAPTOR-CM5 | ![img](/img/software/rplus1/motion/adaptor_cm5.webp) | adaptor_cm5.igs |
| BATTERY     | ![img](/img/software/rplus1/motion/battery.webp)     | battery.igs     |
| AX-12       | ![img](/img/software/rplus1/motion/ax12.webp)        | ax-12.igs       |
| AX-12 Horn  | ![img](/img/software/rplus1/motion/ax12_horn.webp)   | ax-12_horn.igs  |
| AX-S1       | ![img](/img/software/rplus1/motion/axs1.webp)        | ax-s1.igs       |
