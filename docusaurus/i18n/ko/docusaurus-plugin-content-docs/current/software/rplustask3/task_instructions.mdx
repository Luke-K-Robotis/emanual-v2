...
![](/img/software/rplus_task3_kr/task3_026.webp)
...
![](/img/software/rplus_task3_kr/task3_027.webp)
...
![](/img/software/rplus_task3_kr/task3_028.webp)

- 아래는 프로그램 끝을 만나 “강제 종료”되는 경우입니다.

![](/img/software/rplus_task3_kr/task3_029.webp)
...
![](/img/software/rplus_task3_kr/task3_030.webp)

- 아래는 “프로그램 시작”, “만약”의 구간을 나타낸 그림입니다.

![](/img/software/rplus_task3_kr/task3_031.webp)

- 아래 그림과 같이 실행문이 한줄일 경우에는 구간기호가 생략될 수 있습니다.

![](/img/software/rplus_task3_kr/task3_032.webp)
...
![](/img/software/rplus_task3_kr/task3_033.webp)

## 실행문
장치에 명령을 내리거나 수학적인 계산을 수행하는 명령어입니다. 자세한 설명은 하위 항목을 참고하세요.

![](/img/software/rplus_task3_kr/task3_034.webp)

### 계산
- 두 값을 연산하여 하나의 결과를 내는 명령어입니다. (C = A + B)

![](/img/software/rplus_task3_kr/task3_035.webp)

- 덧셈( + ), 뺄셈( - ), 곱셈( * ), 나눗셈( / ), MOD(%), AND( & ), OR( \| )을 선택할 수 있습니다.

![](/img/software/rplus_task3_kr/task3_036.webp)
...
![](/img/software/rplus_task3_kr/task3_037.webp)

### 로드
- 하나의 값을 다른 하나로 대입하는 명령어입니다.

![](/img/software/rplus_task3_kr/task3_038.webp)

- 변수의 값을 읽거나 쓸 때 사용합니다.
- 아래는 “속도”라는 변수에 값을 쓰고, 변수 값을 읽어 감속모터에 설정하는 예제 입니다.

![](/img/software/rplus_task3_kr/task3_039.webp)

- 장치의 값을 읽거나 쓸 때 사용합니다.
- 아래는 포트2번에 연결된 감속모터에 속도 값을 설정하는 예제입니다.

![](/img/software/rplus_task3_kr/task3_040.webp)
...
![](/img/software/rplus_task3_kr/multiple_expression_1.webp)


- 다중 수식을 사용하게 되면 제어기 내부에 임시 변수가 생성되기 때문에 태스크에서 사용된 변수와 문법 검사 결과의 변수 갯수가 다를 수 있습니다.

![](/img/software/rplus_task3_kr/multiple_expression_2.webp)

- 잘못된 수식을 입력하면 오류창이 나타납니다.

![](/img/software/rplus_task3_kr/multiple_expression_3.webp)
...
![](/img/software/rplus_task3_kr/task3_041.webp)

- 레이블과 점프는 반드시 하나의 함수 구간 내에 존재해야 합니다.

![](/img/software/rplus_task3_kr/task3_042.webp)


## 조건문
조건절의 결과가 참이냐 거짓이냐에 따라 프로그램의 흐름을 분기하는 명령어입니다. 자세한 설명은 하위 항목을 참고하세요.

![](/img/software/rplus_task3_kr/task3_043.webp)
...
![](/img/software/rplus_task3_kr/task3_044.webp)
...
![](/img/software/rplus_task3_kr/task3_045.webp)
...
![](/img/software/rplus_task3_kr/task3_046.webp)

- 그림과 같이 실행할 코드가 한 줄일 경우 구간 기호를 생략할 수 있습니다.

![](/img/software/rplus_task3_kr/task3_047.webp)
...
![](/img/software/rplus_task3_kr/task3_048.webp)

- 그림과 같이 실행할 코드가 한 줄일 경우 구간 기호를 생략할 수 있습니다.

![](/img/software/rplus_task3_kr/task3_049.webp)
...
- 아래는 만약과 아니면 을 사용하여 “변수 값이 100과 같으면?”과 “변수 값이 100과 다르면”을 모두 판단하는 예제입니다.
  ...
  ![](/img/software/rplus_task3_kr/task3_050.webp)

- 그림과 같이 실행할 코드가 한 줄일 경우 구간 기호를 생략할 수 있습니다.

  ![](/img/software/rplus_task3_kr/task3_051.webp)

## 반복문
프로그램에서 여러 번 반복적인 수행이 필요한 경우 사용하는 명령어입니다. 반복 구간과 반복 조건을 설정하여 다양한 방법으로 반복을 설정할 수 있습니다. 자세한 설명은 하위 항목을 참고하세요.

![](/img/software/rplus_task3_kr/task3_052.webp)
...
- 아래는 무조건 반복을 사용하여 화면에 숫자 100을 출력하는 예제입니다. 무조건 반복의 구간 내에서 화면 출력을 진행하기 때문에 멈추지 않고 실행됩니다.
  ...
  ![](/img/software/rplus_task3_kr/task3_053.webp)

- 그림과 같이 실행할 코드가 한 줄일 경우 구간 기호를 생략할 수 있습니다.

  ![](/img/software/rplus_task3_kr/task3_054.webp)
...
- 아래는 조건 반복을 활용하여 1.024초 동안만 화면에 숫자 100을 출력하는 예제입니다.
  ...
  ![](/img/software/rplus_task3_kr/task3_055.webp)

- 아래는 조건 반복과 변수를 활용하여 10회 동안만 화면에 숫자 100을 출력하는 예제입니다.

  ![](/img/software/rplus_task3_kr/task3_056.webp)
...
- 아래는 조건 대기와 타이머를 사용하여 1.024초 동안 대기하는 예제입니다.
  ...
  ![](/img/software/rplus_task3_kr/task3_059.webp)

- 아래는 조건 대기를 사용하여 재생되는 모션이 끝날 때까지 기다리는 예제입니다.

  ![](/img/software/rplus_task3_kr/task3_060.webp)

- 아래는 조건 대기를 사용하여 재생되는 멜로디가 끝날 때까지 기다리는 예제입니다.

  ![](/img/software/rplus_task3_kr/task3_061.webp)
...
- 아래는 LED를 깜박이는 기능을 함수로 만들어 사용한 예제입니다.
  ...
  ![](/img/software/rplus_task3_kr/task3_064.webp)

- 아래는 함수를 사용하기 위해 호출할 함수를 선택하는 과정입니다

  ![](/img/software/rplus_task3_kr/task3_065.webp)

- 함수 내에서 자기 자신을 호출할 수 없습니다.

  ![](/img/software/rplus_task3_kr/task3_066.webp)
...
- 아래는 “복귀”를 사용하지 않고 함수를 끝까지 실행한 예제입니다.
  ...
  ![](/img/software/rplus_task3_kr/task3_067.webp)

- 아래는 “복귀”를 사용하여 함수가 실행되는 도중에 복귀한 예제입니다.

  ![](/img/software/rplus_task3_kr/task3_068.webp)
...
- 아래는 콜백 함수를 사용하여 받은 무선 데이터를 “수신데이터” 변수에 저장하는 예제입니다.
  ...
  ![](/img/software/rplus_task3_kr/task3_069.webp)
