...
![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/labview_logo.png)

* [Download LabVIEW for Windows](http://www.ni.com/download-labview/)

  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/a1.png)
...
* Run LabVIEW, then click <kbd>Tools</kbd> → <kbd>Import</kbd> → <kbd>Shared Library (.dll)...</kbd>.
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/b1.png)

* Select <kbd>Create VIs for a shared library</kbd>, then click <kbd>Next</kbd>.

  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/b2.png)

* Set paths to where the `.dll` and `.h` of DYNAMIXEL SDK c version is located, then click <kbd>Next</kbd>.

  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/b3.png)
...
```
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/b4.png)

* Check whether all the functions are successfully listed for the import, then click <kbd>Next</kbd>.

  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/b5.png)

* Change `Project Library Name` and `Project Library Path` properly. Then click <kbd>Next</kbd>.

  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/b6.png)

* The DYNAMIXEL SDK functions for the LabVIEW will be structed as the blocks shows. Click <kbd>Next</kbd>.

  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/b7.png)

* Here doesn't have any items that should be edited. Click <kbd>Next</kbd>.

  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/b8.png)

* The list shows what kind of files should be built during the import. Click <kbd>Next</kbd>.

  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/b9.png)

* Wait for the progress. When it finishes importing, click <kbd>Next</kbd>.

  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/b10.png)

* Click <kbd>Finish</kbd> and see the list of generated libraries.

  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/b11.png)

* Now, make the sources by using the generated LabVIEW libraries.

  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/b12.png)

# Function Reference
* The function reference file is located in `[DynamixelSDK folder]/labview/dxl_x86_c.lvlib/dxl_x86_c.lvlib`

  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/2.png)

  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/4.png)

  ![](/img/software/dynamixel/dynamixel_sdk/library_setup/labview/windows/library_file/1.png)
