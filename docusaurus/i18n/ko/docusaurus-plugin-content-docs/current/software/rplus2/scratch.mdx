...
# 개요
## 로보플러스 스크래치 설명
![](/img/software/rplus2/scratch/r+scratch_1.jpg)
...
10. **스크래치 열기**  
  스크래치 2.0 오프라인 에디터 이 설치되어 있으면 선택한 제어기에서 제공되는 예제 프로젝트들이 아래 그림과 같이 표시 됩니다.
    ...
    ![](/img/software/rplus2/scratch/r+scratch_5.jpg)
...
11. **도움말 보기**  
  도움말 보기를 클릭하면 아래 그림과 같은 도움말 파일이 있는 폴더가 표시 됩니다.
    ...
    ![](/img/software/rplus2/scratch/r+scratch_4.jpg)
...
1. 다음 그림과 같이 micro USB 케이블을 이용해 제어기를 연결합니다.
    ...
    ![](/img/software/rplus2/scratch/r+scratch_2.jpg)

2. Micro USB 케이블을 연결하고 전원을 켜면 “연결 포트 선택”을 클릭했을 때 아래와 같이 “ROBOTIS Virtual COM Port” 가 표시됩니다.
    
    ![](/img/software/rplus2/scratch/r+scratch_3.jpg)
...
1. 다음 그림과 같이 무선 통신 모듈을 연결합니다.  
  ![](/img/software/rplus2/scratch/untitled-1.jpg)
...
3. 추가한 블루투스는 다음과 같이 목록에 “Bluetooth Serial Port” 로 표시됩니다.  
  ![](/img/software/rplus2/scratch/r+scratch_6.jpg)
...
![](/img/software/rplus2/scratch/r+scratch_7.jpg)

만약 아래와 같이 “USB 직렬 장치” 로 표시된다면 드라이버를 업데이트 해야 합니다.

![](/img/software/rplus2/scratch/r+scratch_8.jpg)

USB 직렬 장치를 마우스로 우클릭하여 드라이버 소프트웨어 업데이트를 선택합니다.

![](/img/software/rplus2/scratch/r+scratch_9.jpg)

컴퓨터에서 드라이버 소프트웨어 찾아보기를 선택합니다.

![](/img/software/rplus2/scratch/r+scratch_10.jpg)

컴퓨터의 장치 드라이버 목록에서 직접 선택을 선택합니다.

![](/img/software/rplus2/scratch/r+scratch_11.jpg)

ROBOTIS Virtual COM Port 를 선택한 후 다음을 클릭하여 설치를 완료 합니다.

![](/img/software/rplus2/scratch/r+scratch_13.jpg)
...
1. 로보플러스 스크래치의 `도움말 보기`를 클릭하면 생성되는 탐색기에서 폴더 경로를 복사합니다.
    ...
    ![](/img/software/rplus2/scratch/r+scratch_15.jpg)
    
    ![](/img/software/rplus2/scratch/r+scratch_15-1.jpg)

2. 스크래치 2.0 오프라인 에디터에서 키보드의 `Shift` 키를 누른 상태에서 `파일` 메뉴를 클릭하고 그림과 같이 `HTTP 확장 기능 불러오기`를 선택합니다.

    ![](/img/software/rplus2/scratch/r+scratch_14.jpg)

3. 아래와 같이 새 창이 열리면 파일 이름에 복사해둔 폴더 경로를 붙여넣은 다음, 표시되는 파일 중 추가하고자 하는 \*.json 파일을 선택합니다.

    ![](/img/software/rplus2/scratch/r+scratch_16.jpg)
    
    ![](/img/software/rplus2/scratch/r+scratch_16-1.jpg)

4. 아래 그림과 같이 선택한 블록들이 “추가 블록” 에 표시됩니다.

    ![](/img/software/rplus2/scratch/r+scratch_17.jpg)
