...
![img](/img/software/opencm_ide/opencm9.04_windows1.webp)
...
![img](/img/software/opencm_ide/opencm9.04_windows2.webp)
...
![img](/img/software/opencm_ide/opencm9.04_windows3.webp)          
...
![img](/img/software/opencm_ide/opencm9.04_windows4.webp)

그 장치를 선택하고 “마우스 오른쪽 버튼  드라이버 소프트웨어 업데이트”를 실행 합니다.

![img](/img/software/opencm_ide/opencm9.04_windows5.webp)

다음으로 “컴퓨터에서 드라이버 소프트웨어 찾아보기”를 선택한다.

![img](/img/software/opencm_ide/opencm9.04_windows6.webp)

“찾아보기”를 클릭해서 위에서 압축을 해제한 디렉토리(ROBOTIS\drivers)를 지정한다

![img](/img/software/opencm_ide/opencm9.04_windows7.webp)

다음을 클릭하면 설치가 진행된다.

![img](/img/software/opencm_ide/opencm9.04_windows8.webp)

성공적으로 USB 드라이버를 설치하였다면 아래와 같이 “드라이버 소프트웨어를 업데이트했습니다”라는 창이 나타난다.

![img](/img/software/opencm_ide/opencm9.04_windows9.webp)
...
![img](/img/software/opencm_ide/opencm9.04_windows10.webp)

#### ROBOTIS OpenCM.exe 실행

압축을 푼 디렉토리(\ROBOTIS)에 ROBOTIS_OpenCM.exe 파일을 더블클릭 한다.

![img](/img/software/opencm_ide/opencm9.04_windows11.webp)

그러면 아래와 같이 ROBOTIS OpenCM 툴이 실행된다.

![img](/img/software/opencm_ide/opencm9.04_windows12.webp)

##### Blink 예제를 Open

파일 → 예제 → 01.Basics → b_Blinlk 순으로 선택한다.

![img](/img/software/opencm_ide/opencm9.04_windows13.webp)

##### 보드 선택

도구 → 보드에서 ROBOTIS OpenCM9.04를 선택합니다.

![img](/img/software/opencm_ide/opencm9.04_windows14.webp)

##### 시리얼 포트 선택

반드시 이전 단계에서 확인했던 COM 포트 번호를 선택합니다.

![img](/img/software/opencm_ide/opencm9.04_windows15.webp)

##### 다운로드 수행

아래에서 표시된 다운로드 버튼을 클릭합니다. 다운로드가 시작되는 동안 보드의 녹색 LED가 계속 켜집니다. 다운로드가 끝나면 보드가 리셋되고 Blink 예제가 실행되면서 LED가 깜빡입니다.

![img](/img/software/opencm_ide/opencm9.04_windows16.webp)
...
![img](/img/software/opencm_ide/opencm9.04_26.webp)
...
![img](/img/software/opencm_ide/opencm9.04_mac1.webp)

다운로드가 완료되면 아래 dmg파일을 더블 클릭해서 Mount를 진행합니다.

![img](/img/software/opencm_ide/opencm9.04_mac2.webp)

마운트 후 설치창이 뜨면 마우스로 ROBOTIS 아이콘을 Application 쪽으로 드래그 합니다.

![img](/img/software/opencm_ide/opencm9.04_mac3.webp)

그러면 다음과 같이 설치가 진행됩니다.

![img](/img/software/opencm_ide/opencm9.04_mac4.webp)

#### ROBOTIS OpenCM 실행

Finder를 이용해서 Application 폴더를 보면 ROBOTIS.app 응용프로그램 패키지가 있고 이것을 더블클릭해서 실행합니다.

![img](/img/software/opencm_ide/opencm9.04_mac5.webp)

아래와 같은 그림에서 Open 버튼을 선택합니다.

![img](/img/software/opencm_ide/opencm9.04_mac6.webp)

아래와 같이 ROBOTIS OpenCM이 실행됩니다.

![img](/img/software/opencm_ide/opencm9.04_mac7.webp)

#### Blink 예제 Open

파일 → Examples → 01. Basics → b_Blink 순으로 선택합니다.

![img](/img/software/opencm_ide/opencm9.04_mac8.webp)

#### 보드 선택

ROBOTIS OpenCM9.04를 선택합니다.

![img](/img/software/opencm_ide/opencm9.04_mac9.webp)

#### 시리얼 포트 선택

tty.usbmodemXXX로 선택합니다. 뒤의 숫자는 PC마다 다릅니다.

![img](/img/software/opencm_ide/opencm9.04_mac10.webp)
...
![img](/img/software/opencm_ide/opencm9.04_mac11.webp)
...
![img](/img/software/opencm_ide/opencm_ide_027.webp)

압축을 풀면 아래와 같이 ROBOTIS 폴더가 생성됩니다.

![img](/img/software/opencm_ide/opencm_ide_028.webp)
...
![img](/img/software/opencm_ide/opencm_ide_029.webp)
...
![img](/img/software/opencm_ide/opencm_ide_030.webp)
...
![img](/img/software/opencm_ide/opencm_ide_031.webp)

#### ROBOTIS OpenCM 실행

아래와 같이 ROBOTIS_OpenCM를 더블 클릭하거나 터미널에서 ./ROBOTIS_OpenCM을 입력후 엔터를 하면 실행합니다.

![img](/img/software/opencm_ide/opencm_ide_032.webp)

실행 버튼을 클릭합니다.

![img](/img/software/opencm_ide/opencm_ide_033.webp)

그러면 아래와 같이 실행됩니다.

![img](/img/software/opencm_ide/opencm_ide_034.webp)

#### Blink 예제 열기

파일 → 예제 → 01. Basics → b_Blink 순으로 선택합니다.

![img](/img/software/opencm_ide/opencm_ide_035.webp)

#### 보드선택

도구 → 보드에서 ROBOTIS OpenCM9.04를 선택합니다.

![img](/img/software/opencm_ide/opencm_ide_036.webp)
...
![img](/img/software/opencm_ide/opencm_ide_037.webp)
...
![img](/img/software/opencm_ide/opencm_ide_038.webp)
...
![img](/img/software/opencm_ide/opencm_ide_039.webp)
...
![img](/img/software/opencm_ide/opencm9.04_ide2.webp)
...
![img](/img/software/opencm_ide/opencm9.04_ide3.webp)

그리고 이러한 자동 하이라이트(Auto highlight) 기능은 아래 경로의 keyword.txt 파일을 이용해서 얼마든지 수정하거나 추가할 수 있습니다,

![img](/img/software/opencm_ide/opencm9.04_ide4.webp)

![img](/img/software/opencm_ide/opencm9.04_ide5.webp)

#### 자동포맷 기능 사용
도구 →자동포맷 기능을 활용하면 뒤죽박죽으로 타이핑한 코드들이 보기 좋게 정렬이 됩니다.

![img](/img/software/opencm_ide/opencm9.04_ide6.webp)

아래와 같은 코드가 Ctrl+T만 누르면 한번에 보기 좋게 코드가 정렬이 됩니다.

![img](/img/software/opencm_ide/opencm9.04_ide7.webp)

#### 주석 처리 및 해제
아래 편집→주석추가/주석삭제를 선택하거나 단축키 Ctrl+/를 누르면 주석처리가 되고 다시 한번 더 누르면 주석이 해제 됩니다.

![img](/img/software/opencm_ide/opencm9.04_ide8.webp)

![img](/img/software/opencm_ide/opencm9.04_ide9.webp)

위와 같이 블록 처리를 하고 나서 Ctrl+/를 누르면 아래와 같이 주석 처리가 됩니다.

![img](/img/software/opencm_ide/opencm9.04_ide10.webp)
...
![img](/img/software/opencm_ide/opencm9.04_ide11.webp)

Ctrl+&#125;를 계속해서 눌러보면 아래와 같이 오른쪽으로 한 탭씩 이동합니다.

![img](/img/software/opencm_ide/opencm9.04_ide12.webp)

### 컴파일 및 다운로드 하기

코드를 작성하고 나면 컴파일 메뉴를 이용해 자신이 구현한 코드가 문법에 맞는지 오류가 없는지 체크하면서 프로그래밍을 하는 것이 좋습니다.

![img](/img/software/opencm_ide/opencm9.04_ide13.webp)
...
![img](/img/software/opencm_ide/opencm9.04_ide15.webp)

모든 코드가 에러 없이 컴파일이 잘된다면 다운로드를 해보자. 간단히 아래쪽 방향의 화살표를 누르면 컴파일과 다운로드를 한번에 수행하게 된다.

![img](/img/software/opencm_ide/opencm9.04_ide16.webp)
...
![img](/img/software/opencm_ide/opencm9.04_ide19.webp)

선택된 COM1번 포트를 통해 통신하고 싶다면 툴바 상단 오른쪽 시리얼 모니터 아이콘을 클릭하면 시리얼 모니터가 실행된다. 참고로 Ctrl + Shift + M 단축키를 눌러서 실행시킬 수 있습니다.

![img](/img/software/opencm_ide/opencm9.04_ide20.webp)

![img](/img/software/opencm_ide/opencm9.04_ide21.webp)
...
1. 스케치북 위치 : 사용자 기본 작업 디렉토리입니다. 기본적인 스케치 파일의 저장하기 및 불러오기 경로입니다.
    ...
    ![img](/img/software/opencm_ide/opencm9.04_ide24.webp)

2. Editor language: 글꼴을 변경합니다.

    ![img](/img/software/opencm_ide/opencm9.04_ide25.webp)
...
![img](/img/software/opencm_ide/opencm9.04lib1.webp)
...
![img](/img/software/opencm_ide/opencm9.04lib2.webp)

![img](/img/software/opencm_ide/opencm9.04lib3.webp)
...
![img](/img/software/opencm_ide/opencm9.04lib4.webp)

![img](/img/software/opencm_ide/opencm9.04lib5.webp)
...
![img](/img/software/opencm_ide/opencm9.04restore1.webp)
...
![img](/img/software/opencm_ide/opencm9.04restore2.webp)
...
![img](/img/software/opencm_ide/opencm9.04_sensor.webp)

주의할 점은 5핀에 할당된 핀들이 양쪽 40핀 IO에도 공유가 되어 있으므로 아래 쓰고 있는 포트에 할당된 IO핀은 헤더에서 쓰지 않아야 합니다.

![img](/img/software/opencm_ide/opencm9.04_sensor1.webp)
...
2. 동작 확인
    ...
    ![img](/img/software/opencm_ide/opencm9.04_sensor8.webp)

3. 동작 코드
    DMS 센서 모듈과 같이 5핀 중에 3핀으로 구성된 센서는 그냥 아날로그 입력 핀만 계속 Read하면 됩니다. 별다른 초기 코드가 필요 없습니다.

    ![img](/img/software/opencm_ide/opencm9.04_sensor9.webp)

### Gyro 센서
1. 연결도 및 센서 내부 구조
    로보티즈 자이로 센서도 마찬가지로 OpenCM9.04의 5핀 포트에 연결해서 X, Y 각속도(회전 가속도)를 측정할 수 있습니다.

    ![img](/img/software/opencm_ide/opencm9.04_sensor3.webp)
...
2. 동작 코드
    ...
    ![img](/img/software/opencm_ide/opencm9.04_sensor13.webp)

    DMS 센서 모듈과 동일하게 루프에서 단순히 아날로그 핀값을 읽기만 하면 됩니다.

    ![img](/img/software/opencm_ide/opencm9.04_sensor14.webp)
...
2. 동작 확인
    ...
    ![img](/img/software/opencm_ide/opencm9.04_sensor15.webp)
...
2. 동작 코드
    ...
    ![img](/img/software/opencm_ide/opencm9.04_sensor16.webp)

    ![img](/img/software/opencm_ide/opencm9.04_sensor17.webp)
...
![opencm9.04_digita1.jpg](/img/software/opencm_ide/opencm9.04_digita1.webp)
...
![opencm9.04_digita2.jpg](/img/software/opencm_ide/opencm9.04_digita2.webp)
...
![opencm9.04_digita9.png](/img/software/opencm_ide/opencm9.04_digita9.webp)
...
![opencm9.04_digita3.jpg](/img/software/opencm_ide/opencm9.04_digita3.webp)
...
![opencm9.04_digita4.jpg](/img/software/opencm_ide/opencm9.04_digita4.webp)
...
![opencm9.04_digita5.jpg](/img/software/opencm_ide/opencm9.04_digita5.webp)
...
![opencm9.04_digita6.jpg](/img/software/opencm_ide/opencm9.04_digita6.webp)
...
![opencm9.04_digita7.jpg](/img/software/opencm_ide/opencm9.04_digita7.webp)
...
![opencm9.04_digita8.png](/img/software/opencm_ide/opencm9.04_digita8.webp)

## 아날로그 입출력
아날로그 입력은 반드시 OpenCM9.04 실크스크린의 ANALOG IN 영역에 위치한 0번~9번핀만 아날로그 입력이 됩니다.  
아날로그 출력은 TIMER를 활용한 PWM출력을 통해 아날로그 출력을 대신합니다.

![opencm9.04_analog1.jpg](/img/software/opencm_ide/opencm9.04_analog1.webp)

### 핀3번에 가변저항으로 아날로그 입력을 받습니다.

아래와 같이 3번핀에 가변저항을 연결하고 전압은 3.3V를 연결합니다.

![opencm9.04_analog2.jpg](/img/software/opencm_ide/opencm9.04_analog2.webp)

![opencm9.04_analog3.jpg](/img/software/opencm_ide/opencm9.04_analog3.webp)
...
![opencm9.04_analog4.jpg](/img/software/opencm_ide/opencm9.04_analog4.webp)

![opencm9.04_analog5.jpg](/img/software/opencm_ide/opencm9.04_analog5.webp)
...
![opencm9.04_analog6.jpg](/img/software/opencm_ide/opencm9.04_analog6.webp)
...
![opencm9.04_analog7.jpg](/img/software/opencm_ide/opencm9.04_analog7.webp)

OpenCM9.04에 다운로드 해보면 Status LED가 반복적으로 천천히 켜졌다가 꺼지는 동작을 합니다.

![img](/img/software/opencm_ide/opencm9.04_analog8.webp)
...
![opencm9.04_serial1.jpg](/img/software/opencm_ide/opencm_ide_107.webp)
...
![opencm9.04_serial2.jpg](/img/software/opencm_ide/opencm_ide_108.webp)
...
![opencm9.04_serial3.png](/img/software/opencm_ide/opencm_ide_109.webp)
...
![opencm9.04_serial4.png](/img/software/opencm_ide/opencm_ide_110.webp)
...
![opencm9.04_serial5.jpg](/img/software/opencm_ide/opencm_ide_111.webp)
...
![opencm9.04_interruption1.jpg](/img/software/opencm_ide/opencm9.04_interruption1.webp)

![opencm9.04_interruption2.jpg](/img/software/opencm_ide/opencm9.04_interruption2.webp)
...
![opencm9.04_interruption3.png](/img/software/opencm_ide/opencm9.04_interruption3.webp)
...
![opencm9.04_dynamixel.png](/img/software/opencm_ide/opencm9.04_dynamixel.webp)
...
![opencm9.04_dynamixel1.png](/img/software/opencm_ide/opencm9.04_dynamixel1.webp)
...
![opencm9.04_dynamixel2.png](/img/software/opencm_ide/opencm9.04_dynamixel2.webp)
...
![opencm9.04_dynamixel3.png](/img/software/opencm_ide/opencm9.04_dynamixel3.webp)
...
![opencm9.04_dynamixel4.png](/img/software/opencm_ide/opencm9.04_dynamixel4.webp)
...
![opencm9.04_dynamixel5.png](/img/software/opencm_ide/opencm9.04_dynamixel5.webp)
...
![opencm9.04_dynamixel6.png](/img/software/opencm_ide/opencm9.04_dynamixel6.webp)

E-manual에서 150도에 해당하는 위치는 아래의 그림과 같이 512 와 매칭됨을 확인할 수 있습니다.   

![opencm9.04_dynamixel7.png](/img/software/opencm_ide/opencm9.04_dynamixel7.webp)
...
![opencm9.04_dynamixel8.png](/img/software/opencm_ide/opencm9.04_dynamixel8.webp)
...
![opencm9.04_dynamixel9.png](/img/software/opencm_ide/opencm9.04_dynamixel9.webp)
...
![opencm9.04_dynamixel10.png](/img/software/opencm_ide/opencm9.04_dynamixel10.webp)
...
![opencm9.04_dynamixel11.png](/img/software/opencm_ide/opencm9.04_dynamixel11.webp)
...
![opencm9.04_dynamixel12.png](/img/software/opencm_ide/opencm9.04_dynamixel12.webp)
...
![opencm9.04_dynamixel13.png](/img/software/opencm_ide/opencm9.04_dynamixel13.webp)
...
![opencm9.04_dynamixel14.png](/img/software/opencm_ide/opencm9.04_dynamixel14.webp)
...
![img](/img/software/opencm_ide/opencm9.04_rc100_2.webp)

> 블루투스를 이용해서 RC100 조종기와 연결하기

### RC-100B + ZIG-100/ZIG-110A를 이용한 지그비 연결

![img](/img/software/opencm_ide/opencm9.04_20.webp)
...
![img](/img/software/opencm_ide/opencm904_04.webp)

![img](/img/software/opencm_ide/opencm9.04_rc100_4.webp)
...
![img](/img/software/opencm_ide/opencm9.04_rc100_5.webp)

![img](/img/software/opencm_ide/opencm9.04_rc100_6.webp)
...
![img](/img/software/opencm_ide/opencm9.04_rc100_7.webp)
...
![img](/img/software/opencm_ide/opencm9.04_bkp1.webp)

예제를 선택하면 아래와 같은 코드가 나타납니다.

![img](/img/software/opencm_ide/opencm9.04_bkp2.webp)
...
![img](/img/software/opencm_ide/opencm9.04_bkp3.webp)

![img](/img/software/opencm_ide/opencm9.04_bkp4.webp)

![img](/img/software/opencm_ide/opencm9.04_bkp5.webp)
