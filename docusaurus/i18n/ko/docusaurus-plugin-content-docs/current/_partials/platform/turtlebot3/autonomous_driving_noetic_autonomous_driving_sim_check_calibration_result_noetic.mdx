...
![](/img/platform/turtlebot3/autonomous_driving/noetic_camera_calibration_rqt_image_view.webp)
...
```
    ...
    ![](/img/platform/turtlebot3/autonomous_driving/noetic_rpi_extrinsic_calibration_rqt.webp)
