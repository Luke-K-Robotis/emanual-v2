...
![](/img/platform/turtlebot3/quick_start/sbc_setup/micro_sd_reader.png)
...
[![](/img/icon_download.png) **Download** Raspberry Pi Imager from raspberrypi.org](https://www.raspberrypi.org/software/)
...
![](/img/icon_unfold.png) **Click here to expand more details about How to install Raspberry Pi Imager.**
</summary>  
Install either the `deb` or `apt` rpi-imager release.

1. `deb`  
Download deb file  
![](/img/platform/turtlebot3/quick_start/sbc_setup/sbc_setup1.png)  
  ```bash
$ cd Downloads
...
![](/img/platform/turtlebot3/quick_start/sbc_setup/sbc_setup_jazzy.png)  
...
![](/img/platform/turtlebot3/quick_start/sbc_setup/sbc_config_set.png)  
...
![](/img/platform/turtlebot3/quick_start/sbc_setup/sbc_config_set2.png)
![](/img/platform/turtlebot3/quick_start/sbc_setup/sbc_config_set3.png)  
...
1. Boot Up the Raspberry Pi  
  ...
  ![](/img/platform/turtlebot3/quick_start/sbc_setup/sbc_setup3.png)  
...
![](/img/platform/turtlebot3/quick_start/sbc_setup/ros2_sbc_netcfg.png)  
...
<details>
<summary>
![](/img/icon_unfold.png) **Click here to expand more details about how to connect through ssh**
</summary>
...
```  
![](/img/platform/turtlebot3/quick_start/sbc_setup/sshd_config2.png)  
...
$ ifconfig
```  
![](/img/platform/turtlebot3/quick_start/sbc_setup/sshd_config3.png)  
...
<details>
<summary>
![](/img/icon_unfold.png) **If you are using the TurtleBot3 2GB, make sure to create swap memory for building packages.** Otherwise, you may run out of memory and package building may fail.
</summary>
...
$ free -h
```  
![](/img/platform/turtlebot3/quick_start/sbc_setup/swap.png)
</details>
...
|:---:|:---:|:---:|
|![](/img/platform/turtlebot3/more_info/appendix_lds/lds_small.png)|![](/img/platform/turtlebot3/more_info/appendix_lds/lds_ld08_small.png)|![](/img/platform/turtlebot3/more_info/appendix_lds/lds_coind4_small.png)|  
...
<details>
<summary>
![](/img/icon_unfold.png) **Method 1. Using the camera-ros package**  
</summary>
...
<details>
<summary>
![](/img/icon_unfold.png) **Method 2. Using the v4l2-camera package**
</summary>
...
![](/img/platform/turtlebot3/quick_start/sbc_setup/rpi_config1.png)  
...
![](/img/platform/turtlebot3/quick_start/sbc_setup/rpi_config2.png)  
...
![](/img/platform/turtlebot3/quick_start/sbc_setup/camera_name.png)  
...
> **More Info**  
For detailed specifications and advanced settings, please check the [13.More Info - 13.1.Appendixes - Raspberry Pi Camera](/docs/platform/turtlebot3/appendix_raspi_cam) for a comprehensive guide on hardware capabilities and software features. 

> **Camera Calibration**  
If you plan to use advanced vision features like camera calibration, you can find the detailed instructions [here](/docs/platform/turtlebot3/appendix_raspi_cam#camera-calibration).  

> **Trouble Shooting**  
If the error message `Unable to open camera calibration file` appears, check the solution [here](/docs/platform/turtlebot3/appendix_raspi_cam#trouble-shooting).  
...
Next Step : [OpenCR Setup](/docs/platform/turtlebot3/opencr_setup#opencr-setup)
