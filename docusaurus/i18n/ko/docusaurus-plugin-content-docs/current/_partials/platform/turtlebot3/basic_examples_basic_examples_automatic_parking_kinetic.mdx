...
```
    ...
    **NOTE**: Specify `${TB3_MODEL}`: `burger`, `waffle`, `waffle_pi` before excuting the command. You can permanently configure your TurtleBot model according to the [Export TURTLEBOT3_MODEL](/docs/platform/turtlebot3/export_turtlebot3_model) instructions.
