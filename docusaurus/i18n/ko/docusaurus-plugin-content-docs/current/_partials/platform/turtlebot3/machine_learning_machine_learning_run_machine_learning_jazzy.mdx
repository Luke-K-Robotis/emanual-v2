...
```  
    !<a href="/img/platform/turtlebot3/machine_learning/action_graph.png" target="_blank">action_graph</a>  
<br />
...
```  
    **NOTE**: The graph is recorded from the time you run the node. For full recording, turn it on before you start learning.
    ...
    !<a href="/img/platform/turtlebot3/machine_learning/result_graph.png" target="_blank">result_graph</a>  
<br />
...
[http://localhost:6006](http://localhost:6006)  
    ![](/img/platform/turtlebot3/machine_learning/tensorboard.png)
