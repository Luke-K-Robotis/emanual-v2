...
![](/img/platform/turtlebot3/quick_start/basic_operation/rc100b_with_bt410.webp)
...
$ rqt
  ```  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_1.webp)
...
2. When the topic monitor is opened, the topic values are not monitored by default. Click the checkbox next to each topic to monitor the topic.  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_2.webp)

3. To see more detailed topic messages, click the `▶` icon next to the checkbox.  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_3.webp)
  ...
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_4.webp)
  ...
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_5.webp)
  ...
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_6.webp)

  - `/sensor_state` indicates a message containing encoder values, battery and torque.  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_7.webp)

  - `/scan` indicates a message with LDS data.  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_8.webp)
