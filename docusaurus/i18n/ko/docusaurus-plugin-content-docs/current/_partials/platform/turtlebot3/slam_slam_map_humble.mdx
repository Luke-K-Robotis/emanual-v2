...
This map is used for the [Navigation](/docs/platform/turtlebot3/navigation).

![](/img/platform/turtlebot3/slam/map.webp)
...
![](/img/platform/turtlebot3/slam/large_map.webp)
