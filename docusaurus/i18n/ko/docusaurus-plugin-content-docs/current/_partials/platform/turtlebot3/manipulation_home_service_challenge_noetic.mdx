...
```
    **NOTE**: Specify `${TB3_MODEL}`: `waffle`, `waffle_pi` before excuting the command. Set the permanent export setting by following [Export TURTLEBOT3_MODEL](/docs/platform/turtlebot3/export_turtlebot3_model) instruction.
    ...
    !<a href="/img/platform/turtlebot3/manipulation/home_service_challenge/noetic/TurtleBot3_with_Open_Manipulator.webp" target="_blank">turtlebot3_manipulation_view</a>
...
```
    ...
    !<a href="/img/platform/turtlebot3/manipulation/home_service_challenge/noetic/simulation_rviz.webp" target="_blank">simulation_rviz</a>
...
1. Navigating to a target in the living room.
  - Find a target, and reach it using a Navigation package.  
    ...
    ![demo_1](/img/platform/turtlebot3/manipulation/home_service_challenge/noetic/demo_1.webp)
...
2. Approaching the target.
  - For the approach to the target with precise, TurtleBot3 wheels are directly controlled by computing target's location from AR marker. (Used Topic : `/tb3_hsc/cmd_vel`). To produce a reliable performance, Closed-loop and control system can be used for the specified number of times.
    ...
    ![demo_2](/img/platform/turtlebot3/manipulation/home_service_challenge/noetic/demo_2.webp)
...
5. Navigating to the place where the object will be placed.
   - Find a next target, and reach it using a Navigation package.
    ...
    ![demo_3](/img/platform/turtlebot3/manipulation/home_service_challenge/noetic/demo_3.webp)
...
8. Returning to the starting point using the navigation package.
   ...
   ![demo_4](/img/platform/turtlebot3/manipulation/home_service_challenge/noetic/demo_4.webp)
...
```
   ...
   !<a href="/img/platform/turtlebot3/manipulation/home_service_challenge/noetic/simulation_gazebo.webp" target="_blank">gazebo</a>
