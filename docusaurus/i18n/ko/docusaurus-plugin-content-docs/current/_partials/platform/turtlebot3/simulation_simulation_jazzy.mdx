...
```
![](/img/platform/turtlebot3/simulation/turtlebot3_empty_world_sim.webp)
...
```
![](/img/platform/turtlebot3/simulation/turtlebot3_world_sim.webp)
...
```
![](/img/platform/turtlebot3/simulation/turtlebot3_house_sim.webp)
...
![](/img/platform/turtlebot3/simulation/turtlebot3_gazebo_rviz.webp)
</details>
