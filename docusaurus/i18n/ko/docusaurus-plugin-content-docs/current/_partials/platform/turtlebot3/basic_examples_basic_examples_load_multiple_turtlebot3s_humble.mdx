...
<iframe width="640" height="360" src="https://www.youtube.com/embed/IVut8qZOrEk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  - **What is Load Multiple TurtleBot3s example?**  
    ...
    ![](/img/platform/turtlebot3/basic_examples/load_multiple_turtlebot3s/explain1.png)  
    - You can assign a unique namespace to each TurtleBot3's `node`, `topic`, `frame` so you can identify each TurtleBot3.  
    ![](/img/platform/turtlebot3/basic_examples/load_multiple_turtlebot3s/explain2.png)  
...
- You can see three TurtleBot3s as in the picture below.  
   ![](/img/platform/turtlebot3/basic_examples/load_multiple_turtlebot3s/multi_robot_gazebo.png)  
<br />

- Nodes and topics are completely separated by namespace.  
  ![](/img/platform/turtlebot3/basic_examples/load_multiple_turtlebot3s/node_graph_gazebo.png)  
...
- Frames are completely saparated by namespace.  
  ![](/img/platform/turtlebot3/basic_examples/load_multiple_turtlebot3s/frames_graph_gazebo.png)  
...
- **Change robot namespace.**  
  ...
  ![](/img/platform/turtlebot3/basic_examples/load_multiple_turtlebot3s/multi_robot_code.png)  
<br />
...
:::
  ...
  ![](/img/platform/turtlebot3/basic_examples/load_multiple_turtlebot3s/multi_robot_turtlebot3_world.png)  
...
```
  ![](/img/platform/turtlebot3/basic_examples/load_multiple_turtlebot3s/imu_hpp.png)  

```bash
$ nano ~/turtlebot3_ws/src/ld08_driver/src/lipkg.cpp  
```
  ![](/img/platform/turtlebot3/basic_examples/load_multiple_turtlebot3s/lipkg_cpp.png)  
<br />
...
- Nodes and topics are completely separated by namespace.  
  ![](/img/platform/turtlebot3/basic_examples/load_multiple_turtlebot3s/node_graph_reality.png)  
