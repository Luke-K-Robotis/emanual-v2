...
<details>
<summary>
![](/img/icon_unfold.png) **Click here for details about building TurtleBot3 packages from source.**
</summary>
...
$ ifconfig
  ```  
  ![](/img/platform/turtlebot3/quick_start/quick_start/network_configuration2.png)
...
3. Press `Ctrl`+`END` or `Alt`+`/` to move the cursor to the end of the line.  
  ...
  ![](/img/platform/turtlebot3/quick_start/quick_start/network_configuration3.png)
