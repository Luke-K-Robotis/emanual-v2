...
$ ifconfig
  ```  
  ![](/img/platform/turtlebot3/quick_start/quick_start/network_configuration2.webp)
...
3. Press `Ctrl`+`END` or `Alt`+`/` to move the cursor to the end of the line.  
  ...
  ![](/img/platform/turtlebot3/quick_start/quick_start/network_configuration3.webp)
