...
![](/img/platform/turtlebot3/quick_start/opencr_setup/opencr_setup.webp)  
...
6. A successful firmware upload for the TurtleBot3 Burger will look like this:  
  ![](/img/platform/turtlebot3/quick_start/opencr_setup/shell01.webp)
...
10. Upload the TurtleBot3 firmware sketch with `Ctrl` + `U` or the upload icon.  
  ![](/img/platform/turtlebot3/quick_start/opencr_setup/o2.webp)  
  ![](/img/platform/turtlebot3/quick_start/opencr_setup/o3.webp)
...
![](/img/platform/turtlebot3/quick_start/opencr_setup/opencr_models.webp)
