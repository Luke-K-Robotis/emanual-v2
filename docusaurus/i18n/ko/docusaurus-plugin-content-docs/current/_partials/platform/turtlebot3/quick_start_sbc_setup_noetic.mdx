import QuickStartRosGpgKeyExpirationIncident from '@site/docs/_partials/platform/turtlebot3/quick_start_ros_gpg_key_expiration_incident.mdx';
...
[![](/img/icon_download.png) **Download** `Raspberry Pi 3B+` ROS Noetic image](https://www.robotis.com/service/download.php?no=2008)
...
[![](/img/icon_download.png) **Download** `Raspberry Pi 4B (2GB or 4GB)` ROS Noetic image](https://www.robotis.com/service/download.php?no=2066)
...
![](/img/platform/turtlebot3/quick_start/sbc_setup/rpi_imager.gif)  
1. Click `CHOOSE OS`.  
...
![](/img/platform/turtlebot3/quick_start/sbc_setup/disks.gif)  
...
[![](/img/icon_download.png) Download or install GParted GUI tool](https://gparted.org/download.php)

![](/img/platform/turtlebot3/quick_start/sbc_setup/gparted.gif)  
...
![](/img/platform/turtlebot3/quick_start/sbc_setup/network_setup.gif)  
...
$ source ~/.bashrc  
  ```  
![](/img/platform/turtlebot3/quick_start/sbc_setup/ros1_sbc_netcfg.gif)  

### NEW LDS-02 Configuration

|LDS-01|LDS-02|
|:---:|:---:|
|![](/img/platform/turtlebot3/more_info/appendix_lds/lds_small.png)|![](/img/platform/turtlebot3/more_info/appendix_lds/lds_ld08_small.png)|
...
<details>
<summary>
![](/img/icon_unfold.png) **Click to expand : Manual SBC Setup Instructions**
</summary>
...
1. ![](/img/icon_download.png) Download the proper `Ubuntu 20.04.1(Focal) Preinstalled Server` image on your PC.
