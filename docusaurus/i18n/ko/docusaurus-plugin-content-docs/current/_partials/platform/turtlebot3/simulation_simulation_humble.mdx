...
Please follow the [PC Setup](/docs/platform/turtlebot3/quick_start) instructions if you did not install required packages and dependent packages.
...
2. TurtleBot3 World  
![](/img/platform/turtlebot3/simulation/gazebo_world.png)
```bash
...
<details>
<summary>
![](/img/icon_unfold.png) Read more about **How to visualize Simulation data(RViz2)**
</summary>
