...
<details>
<summary>
![](/img/icon_unfold.png) Read more about **TurtleBot3 Simulation**
</summary>
...
Please follow the [PC Setup](/docs/platform/turtlebot3/quick_start) instructions if you did not install all required packages and dependent packages.  
**[Remote PC]**  
```bash
$ cd ~/catkin_ws/src/
...
1. Empty World  
![](/img/platform/turtlebot3/simulation/turtlebot3_empty_world.png)  
**[Remote PC]**  
```bash
...
2. TurtleBot3 World  
![](/img/platform/turtlebot3/simulation/turtlebot3_world_bugger.png)  
**[Remote PC]**  
```bash
...
3. TurtleBot3 House  
![](/img/platform/turtlebot3/simulation/turtlebot3_house.png)  
**[Remote PC]**  
```bash
...
<details>
<summary>
![](/img/icon_unfold.png) Read more about **How to run Autonomous Collision Avoidance**
</summary>
...
<details>
<summary>
![](/img/icon_unfold.png) Read more about **How to visualize Simulation data(RViz)**
</summary>
...
![](/img/platform/turtlebot3/simulation/turtlebot3_gazebo_rviz.png)
</details>
