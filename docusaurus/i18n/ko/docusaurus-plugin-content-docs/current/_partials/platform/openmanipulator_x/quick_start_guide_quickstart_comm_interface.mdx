...
<img src="/img/platform/openmanipulator_x/OpenManipulator_u2d2_setup2.webp" width="800" />
...
<img src="/img/platform/openmanipulator_x/OpenManipulator_opencr_setup2.webp" width="800" />
...
3. Open the example from `File > Examples > OpenCR > 10.Etc > usb_to_dxl`  
  ![](/img/platform/openmanipulator_x/OpenManipulator_opencr_utd_setup.webp)  
  > Open the `usb to dxl` example.

4. Upload the example to OpenCR.  
  ![](/img/platform/openmanipulator_x/upload_use_to_dxl.webp)
