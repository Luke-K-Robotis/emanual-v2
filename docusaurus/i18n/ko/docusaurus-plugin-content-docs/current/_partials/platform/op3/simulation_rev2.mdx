...
![](/img/platform/op3/op3_gazebo.png)
...
[OP3 Tutorials]: /docs/platform/op3/tutorials#tutorials
[Controller File]: https://emanual.robotis.com/docs/en/popup/position_controller.yaml/
[World File]: https://emanual.robotis.com/docs/en/popup/robotis_op3_gazebo_worlds_empty.world/
