...
**참고**: Startup Configuration은 펌웨어 v45부터 지원합니다.
...
**참고**: RAM Restore에 대한 사용방법은 [RAM 영역 복구](https://emanual.robotis.com/docs/kr/software/dynamixel/dynamixel_wizard2/#ram-영역-복구)을 참고하세요.
