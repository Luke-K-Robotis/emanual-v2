...
[RoboPlus Task]: https://emanual.robotis.com/docs/kr/software/rplus1/task/getting_started/
[RoboPlus Task 2.0]: https://emanual.robotis.com/docs/kr/software/rplus2/task/#시작하기/
[RoboPlus Manager]: https://emanual.robotis.com/docs/kr/software/rplus1/manager/
[RoboPlus Manager 2.0]: https://emanual.robotis.com/docs/kr/software/rplus2/manager/
[시작 버튼 눌림 횟수]: https://emanual.robotis.com/docs/kr/software/rplus1/task/programming_02/#시작버튼-눌림횟수/
[자동꺼짐타이머 바로가기]: https://emanual.robotis.com/docs/kr/software/rplus1/task/programming_02/#자동꺼짐-타이머/
[USB 드라이버 설치 페이지]: https://emanual.robotis.com/docs/kr/popup/usb_driver_install/
