...
**참고**: U2D2을 이용 시, 높은 통신 Baud rate에서 안정적인 통신을 위해서는 [USB 포트의 응답지연시간(Latency)](https://emanual.robotis.com/docs/kr/software/dynamixel/dynamixel_wizard2/#포트-응답-속도-설정) 을 낮춰주세요. 
...
[DYNAMIXEL Protocol 1.0]: https://emanual.robotis.com/docs/kr/dxl/protocol1/
...
[다이나믹셀 통신]: https://emanual.robotis.com/docs/kr/dxl/protocol1/#communication-overview/
[하드웨어 구성 통신]: https://emanual.robotis.com/docs/kr/dxl/ax/ax-12w/#pin-assignment/
