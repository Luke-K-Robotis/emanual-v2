...
![](/img/parts/interface/u2d2_power_hub/product_image.png)
...
# 각 부 명칭
![](/img/parts/interface/u2d2_power_hub/layout.png)
...
1. 네 개의 플라스틱 서포터를 `U2D2 파워 허브 보드`의 각 모퉁이에 조립한다.  
    ...
    ![](/img/parts/interface/u2d2_power_hub/u2d2_phb_06.jpg)

2. 플라스틱 리벳을 사용해서 `U2D2`를 `U2D2 파워 허브 보드`에 조립한다.

    ![](/img/parts/interface/u2d2_power_hub/u2d2_phb_07.jpg)

3. `U2D2`와 `U2D2 파워 허브 보드`를 연결하기 위해 3P 또는 4P 케이블을 그림과 같이 연결한다 (3P와 4P 케이블을 동시에 사용할 수 있음).

    ![](/img/parts/interface/u2d2_power_hub/u2d2_phb_03.jpg)

4. `다이나믹셀`과 `U2D2`를 연결하기 위한 별도의 케이블을 연결한다 (다이나믹셀 모델에 따라 변환케이블이 필요할 수 있음).

    ![](/img/parts/interface/u2d2_power_hub/u2d2_phb_04.jpg)

5. 케이블의 반대쪽을 `다이나믹셀`에 연결한다 (다이나믹셀 모델에 따라 변환케이블이 필요할 수 있음).

    ![](/img/parts/interface/u2d2_power_hub/u2d2_phb_05.jpg)
...
:::
    ...
    ![](/img/parts/interface/u2d2_power_hub/u2d2_phb_01.jpg)![](/img/parts/interface/u2d2_power_hub/u2d2_phb_02.jpg)

7. 다이나믹셀에 전원을 공급하려면 `U2D2 파워 허브 보드`의 전원 스위치를 켠다.

    ![](/img/parts/interface/u2d2_power_hub/u2d2_phb_08.jpg)

## 커넥터 정보
|        Item         |                             TTL                              |                            RS-485                            |                               Power                                |
|:-------------------:|:------------------------------------------------------------:|:------------------------------------------------------------:|:------------------------------------------------------------------:|
|       핀번호        |                `1` GND<br />`2` VDD<br />`3` DATA                |         `1` GND<br />`2` VDD<br />`3` DATA+<br />`4` DATA-         |                        `1` GND<br /> `2` VDD                         |
|     다이어그램      |        ![](/img/dxl/jst_b3beha_diagram.png)        |        ![](/img/dxl/jst_b4beha_diagram.png)        |         ![](/img/dxl/molex_39281023_diagram.png)         |
|       하우징        |   ![](/img/dxl/JST_EHR-3.png)<br />[JST EHR-03]    |   ![](/img/dxl/JST_EHR-4.png)<br />[JST EHR-04]    | ![](/img/dxl/molex_39012020.png)<br />[MOLEX 39-01-2020] |
|      PCB 헤더       | ![](/img/dxl/JST_B3B_EH-A.png)<br />[JST B3B-EH-A] | ![](/img/dxl/JST_B4B-EH-A.png)<br />[JST B4B-EH-A] | ![](/img/dxl/molex_39281023.png)<br />[MOLEX 39-28-1023] |
