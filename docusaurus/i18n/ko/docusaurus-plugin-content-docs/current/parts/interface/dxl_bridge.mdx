...
- Instruction Packet에 대한 자세한 정보는, [다이나믹셀 프로토콜 1.0](https://emanual.robotis.com/docs/kr/dxl/protocol1/#instruction-packet) or [프로토콜 2.0](https://emanual.robotis.com/docs/kr/dxl/protocol2/#instruction-packet)을 참고하세요.
