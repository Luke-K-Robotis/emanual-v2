...
[PC 에서 작성한 태스크 코드를 제어기로 다운로드]: https://emanual.robotis.com/docs/kr/software/rplus1/task/getting_started/#프로그램-다운로드/
[제어기의 태스크 코드 실행 결과를 PC 의 화면에 출력]: https://emanual.robotis.com/docs/kr/software/rplus1/task/getting_started/#프로그램-결과-출력/
[RoboPlus 의 가상 로봇 조종]: https://emanual.robotis.com/docs/kr/software/rplus1/task/getting_started/#가상로봇-조종/
