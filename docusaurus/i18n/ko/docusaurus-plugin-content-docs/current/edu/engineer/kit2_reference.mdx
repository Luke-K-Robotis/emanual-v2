...
:::
    ...
    ![](/img/edu/engineer/kit2/pi_booting.png)

2. 앱이 설치된 기기에서 와이파이 설정을 선택합니다.

3. 네크워크 목록에서 `Robotis_Rpi_XXXX`를 찾아 선택합니다.

    ![](/img/edu/engineer/kit2/kit2_wifi_01_kr.png)
...
4. 비밀번호 입력창이 나타나면 `robotis0` 을 입력한 후 연결합니다.
   ...
   ![](/img/edu/engineer/kit2/kit2_wifi_02_kr.png)
...
6. 스트리밍 기능이 지원되는 MAX-E2 또는 Commando를 선택하여 스트리밍 기능을 실행하면 아래 화면과 같이 스트리밍 기능을 활용해 로봇을 조종할 수 있습니다.
    ...
    ![](/img/edu/engineer/kit2/kit2_streaming_select_example.png)
    > 예제 선택

    ![](/img/edu/engineer/kit2/kit2_streaming_select_example_02.png)
    > 스트리밍 화면
...
- 보드의 뒷면에서 사용하는 모델의 명칭을 확인하세요.
  ...
  ![](/img/edu/engineer/kit2/sbc_update/rpizero2w_back_side.png)
...
2. Raspberry Pi Zero 2 W가 부팅 되면, PC의 와이파이 검색창에서 `Robotis_Rpi_XXXX` (XXXX는 제어기 MAC 주소 4자리) 또는 `Robotis_Rpi` 이름의 AP에 연결하세요.
    ...
    ![](/img/edu/engineer/kit2/rpi_wifi_scan_02.png)
...
:::note
    ...
    **참고**: 접근을 위해 계정과 비밀번호를 입력을 요청할 수 있습니다. 아래 `계정`과 `패스워드`를 입력하세요.  
    `계정`: pi  
    `패스워드`: robotis0  
    ![](/img/edu/engineer/kit2/sbc_update/eng_sbc_updaye_password_request.png)
...
3. PC의 윈도우 탐색 창을 여세요. (Window10 단축키: `Win` + `E`)
    ...
    ![](/img/edu/engineer/kit2/sbc_update/file_explore_01_kr.png)

4. PC의 윈도우 탐색기 주소창에 **\\\raspberrypi.local** 를 입력하면,`robotis` 폴더가 나타납니다.

    ![](/img/edu/engineer/kit2/sbc_update/file_explore_02_kr.png)

5. 폴더로 접근 후, 다운로드한 `dxl.rts` 파일을 `robotis` 폴더에 복사하세요.

    ![](/img/edu/engineer/kit2/sbc_update/copy_rts_kr.png)

    ![](/img/edu/engineer/kit2/sbc_update/copy_rts_02_kr.png)
...
4. 설치한 Imager를 실행하세요.
    ...
    ![](/img/edu/engineer/kit2/run_win32diskimager.png)

5. 2번 에서 압축해제한 **.img** 파일를 선택하세요.

    ![](/img/edu/engineer/kit2/select_rpi_image_extracted_01.png)

    ![](/img/edu/engineer/kit2/select_rpi_image_extracted_02.png)

6. 선택한 이미지를 저장할 저장매체를 선택하세요.

    ![](/img/edu/engineer/kit2/select_sdcard_drive.png)
...
:::
    ...
    ![](/img/edu/engineer/kit2/rpi_wifi_scan_01.png)  
      > 부팅 완료 전 와이파이 검색 결과
