...
## 부품 목록
![](/img/edu/engineer/kit1/kit1_parts_list_kr.png)
...
![](/img/edu/engineer/kit1/cm550_2_kr.png)
...
![](/img/edu/engineer/kit1/rivet_assembly_6mm_kr.png)  
...
![](/img/edu/engineer/kit1/rivet_assembly_12mm_kr.png)
...
- **참고**: [로보플러스 엔지니어 다운로드 방법](https://emanual.robotis.com/docs/kr/popup/engineer/engineer_app_installation/)
...
![](/img/edu/engineer/kit1/engineer_app_configuration_kr.png)
...
6. 확인한 문자를 왼쪽 상자에 입력한 후 `검색` 을 누릅니다.  
  ![](/img/edu/engineer/kit1/bluetooth_connection_6_kr.png)

7. 검색된 목록 중 제어기의 주소와 일치하는 항목을 선택하면 블루투스 통신 연결이 완료되고, 로봇이 실행됩니다.  
  ![](/img/edu/engineer/kit1/bluetooth_connection_7_kr.png)
...
![](/img/edu/engineer/kit1/engineer_app_emotion_3_kr.png)

##### 모드 메뉴

|                        아이콘                         | 모드 설명                                                                                                                                                       |
|:-----------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------|
|  ![](/img/edu/engineer/kit1/icon_demo.png)  | **DEMO : 감성인식 모드**<br />기본 데모 모드로 스마트 기기 화면을 통해 감정상태를 표현합니다.<br />로봇이나 스마트 기기를 터치하면 다양한 반응을 합니다.            |
|  ![](/img/edu/engineer/kit1/icon_face.png)  | **FACE : 얼굴인식 모드**<br />스마트 기기의 카메라로 얼굴을 인식하고 추적하는 모드입니다.<br />AR 기술을 적용해 추적하는 얼굴 위에 스티커를 입힙니다.               |
| ![](/img/edu/engineer/kit1/icon_object.png) | **OBJECT : 객체인식 모드**<br />사전에 등록된 물건을 카메라로 인식하고 말하는 모드입니다.<br />바나나, 볼펜, 차 열쇠, 지갑, 지폐 등 12종의 물건을 말할 수 있습니다. |
| ![](/img/edu/engineer/kit1/icon_voice.png)  | **VOICE : 음성인식 모드**<br />등록된 음성 명령을 인식하고 실행하는 모드입니다.<br />모드 변경 및 옵션 메뉴 실행, 종료 등의 명령을 인식합니다.                      |
|  ![](/img/edu/engineer/kit1/icon_clap.png)  | **CLAP : 박수감지 모드**<br />제어기의 마이크 센서를 통해 박수소리를 인식하는 모드입니다.<br />인식한 박수소리의 숫자만큼 Dr.R이 따라서 박수를 칩니다.              |

##### 옵션메뉴

|                        아이콘                         | 옵션 설명                                                                                    |
|:-----------------------------------------------------:|:---------------------------------------------------------------------------------------------|
| ![](/img/edu/engineer/kit1/icon_motor.png)  | **MOTOR : 다이나믹셀 점검**<br />로봇의 다이나믹셀 상태를 각각 테스트해 볼 수 있는 메뉴입니다. |
| ![](/img/edu/engineer/kit1/icon_offset.png) | **OFFSET : 모션오프셋**<br />모션 동작시 각 관절의 기본 위치를 설정하는 기능입니다.            |
...
![](/img/edu/engineer/kit1/max_controller_kr.png)
...
|                         아이콘                         | 메뉴 설명                                                                    |
|:------------------------------------------------------:|:-----------------------------------------------------------------------------|
| ![](/img/edu/engineer/kit1/icon_remote.png)  | **REMOTE** : 기본 조종 모드 화면을 불러오는 버튼입니다.                      |
| ![](/img/edu/engineer/kit1/icon_gesture.png) | **GESTURE** : 등록된 스마트 기기의 동작 제스처로 로봇을 조종하는 기능입니다. |
|  ![](/img/edu/engineer/kit1/icon_clap.png)   | **CLAP** : 박수소리를 감지하고 감지한 횟수만큼 MAX-E1이 박수를 칩니다.       |

### SPI
#### 리모컨 화면  

![](/img/edu/engineer/kit1/spi_controller_kr.png)
...
|:-----------------------------------------------------:|:-------------------------------------------------------------------|
| ![](/img/edu/engineer/kit1/icon_remote.png) | **REMOTE** : 기본 조종 모드 화면을 불러오는 버튼입니다.            |
| ![](/img/edu/engineer/kit1/icon_music.png)  | **MUSIC** : 스마트 기기를 통해 로봇과 함께 연주를 하는 기능입니다. |
|  ![](/img/edu/engineer/kit1/icon_clap.png)  | **CLAP** : 박수소리를 감지하고 감지한 횟수만큼 SPI가 움직입니다.   |
...
`Ctrl` + `Shift` 를 누른 상태에서 `명령 프롬프트` 를 클릭해도 됩니다.
    ...
    ![](/img/edu/engineer/kit1/obj_classification_cmd_01_kr.png)

2. 명령 프롬프트가 실행되면 아래와 같은 화면이 나타납니다.

    ![](/img/edu/engineer/kit1/obj_classification_cmd_02_kr.png)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_cmd_03_kr.png)

4. pip패키지가 성공적으로 업그레이드되면 아래와 같이 표시됩니다.

    ![](/img/edu/engineer/kit1/obj_classification_cmd_04_kr.png)
...
1. `D 드라이브`에 `!R+Smart` 폴더를 만들어 주세요.
    ...
    ![](/img/edu/engineer/kit1/obj_classification_mkdir_01_kr.png)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_mkdir_02_kr.png)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_mkdir_03_kr.png)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_tensor_01_kr.png)

2. 진행여부를 묻습니다. `y` 입력후, `Enter Key`를 눌러 패키지 설치를 진행합니다.

    ![](/img/edu/engineer/kit1/obj_classification_tensor_02_kr.png)

3. 성공적으로 설치되면 아래의 사진과 같이 나옵니다.

    ![](/img/edu/engineer/kit1/obj_classification_tensor_03_kr.png)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_tensor_04_kr.png)
...
:::
    ...
    ![](/img/edu/engineer/kit1/obj_classification_tensor_05_kr.png)
...
2. `!R+Smart` 폴더에 다운로드받은 `retrain.py` 파일을 복사한 다음, 객체 추가를 위한 `photos` 폴더를 만듭니다.
    ...
    ![](/img/edu/engineer/kit1/obj_classification_tensor_retrain_kr.png)

3. `photos` 폴더 안에 `001 dummy`, `002 banana` 그리고 `003 pineapple`과 같이 객체 이미지를 추가할 하위 폴더를 만들고 객체와 관련된 이미지를 각각의 폴더에 추가합니다.

    ![](/img/edu/engineer/kit1/obj_classification_image_01_kr.png)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_img_learning_01_kr.png)
...
2. 학습이 완료되면 아래와 같이 `Smart_OC.txt` 와 `Smart_OC.pb` 파일이 `!R+Smart` 폴더에 생성됩니다.
   ...
   ![](/img/edu/engineer/kit1/obj_classification_oc_kr.png)
...
2. 스마트 기기의 저장공간에서 `RoboPlus` > `ROBOTIS ENGINEER` > `CUSTOM` 폴더를 찾아 들어갑니다.
    ...
    ![](/img/edu/engineer/kit1/obj_classification_application_01_kr.png)  
    ![](/img/edu/engineer/kit1/obj_classification_application_02_kr.png)  
    ![](/img/edu/engineer/kit1/obj_classification_application_03_kr.png)
...
4. 데이터베이스를 사용하기 위해서 `Db` 폴더를 생성합니다.
    ...
    ![](/img/edu/engineer/kit1/obj_classification_application_05_kr.png)

5. `!R+Smart` 에서 생성된 학습파일인 `Smart_OC.txt` 와 `Smart_OC.pb` 을 `Db` 폴더에 복사합니다.  

    ![](/img/edu/engineer/kit1/obj_classification_application_06_kr.png)
...
7. `User` 탭으로 이동합니다.
    ...
    ![](/img/edu/engineer/kit1/obj_classification_test_01_kr.png)

8. 3번 단계에서 생성한 `Project 1` 프로젝트 폴더의 `설정` 아이콘을 클릭합니다.   

    ![](/img/edu/engineer/kit1/obj_classification_test_02_kr.png)

9. `비전` > `객체 분류` 를 선택합니다.

    ![](/img/edu/engineer/kit1/obj_classification_test_03_kr.png)

10. 이미지 폴더가 추가되었는지 확인합니다.

    ![](/img/edu/engineer/kit1/obj_classification_test_04_kr.png)
...
![](/img/edu/engineer/kit1/engineer_edu_metarials_kr.png)
...
4. R+ Manager 2.0 을 실행합니다.
    ...
    ![](/img/edu/engineer/kit1/BLE_signal_power_01_kr.png)

5. `업데이트 검사` 를 클릭한 다음, R+ Manager 2.0이 최신 버전인지 확인합니다.

    ![](/img/edu/engineer/kit1/BLE_signal_power_02_kr.png)  
    ![](/img/edu/engineer/kit1/BLE_signal_power_03_kr.png)

6. `모든제품` 탭을 선택합니다.

    ![](/img/edu/engineer/kit1/BLE_signal_power_04_kr.png)

7. 제품 중에서 CM-550을 선택 후 `확인` 을 클릭합니다.

    ![](/img/edu/engineer/kit1/BLE_signal_power_05_kr.png)

8.  `업데이트 & 테스트` 를 클릭합니다.

    ![](/img/edu/engineer/kit1/BLE_signal_power_06_kr.png)

9. `다음` 을 클릭합니다.

    ![](/img/edu/engineer/kit1/BLE_signal_power_07_kr.png)

10. 제어기가 연결된 포트를 선택합니다.

    ![](/img/edu/engineer/kit1/BLE_signal_power_08_kr.png)

11. 제어기와 PC의 통신속도를 선택합니다 (기본 통신속도는 57600 bps로 고정되어 있습니다).

    ![](/img/edu/engineer/kit1/BLE_signal_power_09_kr.png)

12. 제어기 검색이 완료되면 `다음` 을 클릭합니다.

    ![](/img/edu/engineer/kit1/BLE_signal_power_10_kr.png)

13. 제어기와 연결된 부품의 펌웨어가 모두 최신 버전이라면 `다음` 을 클릭하거나, 업데이트가 필요한 경우 화면의 안내에 따라 펌웨어 업데이트를 진행합니다.

    ![](/img/edu/engineer/kit1/BLE_signal_power_11_kr.png)

14. 제어기와 PC가 성공적으로 연결이 되면, 아래 그림과 같이 컨트롤 테이블이 표시됩니다.

    ![](/img/edu/engineer/kit1/BLE_signal_power_12_kr.png)

15. 컨트롤 테이블을 스크롤해서 `139`번 주소의 `BLE Signal Power` 를 찾습니다.

    ![](/img/edu/engineer/kit1/BLE_signal_power_13_kr.png)

16. 화면 오른쪽의 `BLE Signal Power` 에서 값을 선택 후 저장합니다.  
  큰 값을 선택할수록 신호가 강해지며, 통신이 불안정할 경우 신호 세기를 높여주세요.  

    ![](/img/edu/engineer/kit1/BLE_signal_power_14_kr.png)
...
17. 마지막으로, `BLE Signal Power` 의 값이 저장되었는지 확인해주세요.
    ...
    ![](/img/edu/engineer/kit1/BLE_signal_power_15_kr.png)
...
2. 그림과 같이 충전지를 충전기와 연결합니다.  
  ![](/img/edu/engineer/kit1/battery_charging_2_kr.png)

3. 그림과 같이 빨간색 LED가 표시되면 충전 중인 상태이며, 녹색 LED가 표시되면 충전이 완료된 상태입니다.  
  ![](/img/edu/engineer/kit1/battery_charging_3_kr.png)
...
5. 충전지는 충전용 커넥터와 로봇 작동용 커넥터가 연결되어 있습니다. 충전지를 충전할 때에는 반드시 `로봇 작동용` 커넥터를 분리해 주세요.  
  ![](/img/edu/engineer/kit1/battery_charging_5_kr.png)
...
[2XL430-W250 매뉴얼 바로가기]: /docs/dxl/x/2xl430-w250
...
[제어기와 PC 연결하기]: https://emanual.robotis.com/docs/kr/popup/engineer/connect_controller_pc/
[PC에서 태스크 예제 다운로드 하기]: https://emanual.robotis.com/docs/kr/popup/engineer/task_download_pc/
[PC에서 모션 예제 다운로드 하기]: https://emanual.robotis.com/docs/kr/popup/engineer/motion_download_pc/
[제어기와 스마트기기 연결하기]: https://emanual.robotis.com/docs/kr/popup/engineer/connect_controller_mobile/
[스마트기기에서 태스크 예제 다운로드 하기]: https://emanual.robotis.com/docs/kr/popup/engineer/task_download_mobile/
[스마트기기에서 모션 예제 다운로드 하기]: https://emanual.robotis.com/docs/kr/popup/engineer/motion_download_mobile/
