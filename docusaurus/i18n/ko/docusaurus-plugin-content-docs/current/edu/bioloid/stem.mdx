...
# 시작하기
## Level 1 부품 목록
![](/img/edu/bioloid/pr05_e01_standard_partlist_01_KR.png)

![](/img/edu/bioloid/pr05_e01_standard_partlist_02_KR.png)

## Level 2 부품 목록
![](/img/edu/bioloid/pr05_e01_expansion_partlist_01_KR.png)

![](/img/edu/bioloid/pr05_e01_expansion_partlist_02_KR.png)
...
![](/img/edu/bioloid/bp_act_01_kr.png)
...
[](/img/edu/bioloid/bp_act_02_kr.jpg)
...
1. 배터리 분리
    ...
    ![](/img/edu/bioloid/bp_battery_separate_KR.png)

2. 충전기 연결

    ![](/img/edu/bioloid/bp_charger_conn_KR.png)

3. 충전

    충전중(붉은색 LED), 충전완료(녹색 LED)

    ![](/img/edu/bioloid/bp_charging_KR.png)


- SMPS 를 로봇에 직접 연결하면 외부 전원으로 로봇을 구동할 수도 있습니다.  

  ![](/img/edu/bioloid/bp_smps_KR.png)  

- 배터리에는 충전용 커넥터와 로봇 작동용 커넥터가 연결되어 있습니다.

  ![](/img/edu/bioloid/bp_battery_KR.jpg)  
