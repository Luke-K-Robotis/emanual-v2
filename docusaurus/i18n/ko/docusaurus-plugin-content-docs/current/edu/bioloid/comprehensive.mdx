...
# 시작하기
## 부품 목록
![](/img/edu/bioloid/comprehensivekit_partlist_kr.png)
...
1. 전원을 인가합니다.충전이 안되었을 경우 POWER LED가 점등되지 않습니다. 충전하기를 참조하십시오.  
    ...
    ![](/img/edu/bioloid/bioloid_cm5_action-01_kr.png)

2. MODE 버튼을 눌러서 PLAY 에 LED 가 깜빡이도록 합니다. MODE 버튼을 누르면 LED 가 이동합니다.

    ![](/img/edu/bioloid/bioloid_cm5_action-02_kr.png)

3. START 버튼을 누르면 프로그램이 실행됩니다. 프로그램이 실행되면 LED 는 깜빡거리지 않고 계속 켜져 있습니다.

    ![](/img/edu/bioloid/bioloid_cm5_action-03_kr.png)
...
1. CM-5 에 SMPS 를 연결합니다.
    ...
    ![](/img/edu/bioloid/bioloid_cm5_charging-01_kr.png)

2. CM-5 의 전원스위치를 켠 후, U 버튼을 누릅니다.

    ![](/img/edu/bioloid/bioloid_cm5_charging-02_kr.png)
...
4. [무조건 반복] 명령어 입력  
  ...
  프로그램 시작의 &#123; 와 &#125; 사이 구간의 빈 줄을 더블클릭 하거나 선택 후 Enter 키를 누르면 **명령어 종류 선택** 창이 뜹니다. 명령어 종류 중 "반복문 > 무조건 반복 (while(1))" 을 선택합니다.
    ...
    ![](/img/edu/bioloid/tutorial_printscr_1_05_kr.png)
5. [로드] 명령어 입력  
  화면에 출력할 값을 **화면 출력** 으로 입력하기 위해 **로드** 명령어를 사용합니다. 무조건 반복의 &#123; 와 &#125; 사이 구간의 빈 줄에 "실행문 > 로드 (값 입력하기)" 를 선택하여 입력합니다.

    ![](/img/edu/bioloid/tutorial_printscr_1_06_kr.png)
...
6. 숫자 **1** 을 [화면 출력] 으로 로드  
  ...
  제어기 > 화면 출력 을 선택하고 확인 버튼을 누릅니다.
    ...
    ![](/img/edu/bioloid/tutorial_printscr_1_07_kr.png)  

    같은 방법으로 우측 파라미터 **?** 에는 상수 > 숫자 > 1 을 입력합니다.

    ![](/img/edu/bioloid/tutorial_printscr_1_08_kr.png)  

    로드 명령어의 파라미터를 모두 입력한 화면은 아래와 같습니다.

    ![](/img/edu/bioloid/tutorial_printscr_1_09_kr.png)
...
7. 숫자 **2** 를 [화면 출력 후 줄 바꿈] 으로 로드  
  화면 출력 아래의 &#125; (무조건 반복의 구간 끝)를 선택하고 스페이스(Space) 키를 눌러 빈 줄을 추가한 후 위 5. ~ 6. 에서와 동일한 방법으로 로드 명령어를 추가하고, 이번에는 "제어기 > 화면 출력 후 줄 바꿈" 에 상수 숫자 2 를 로드합니다. 최종 완성된 태스크 코드는 아래와 같습니다.
    ...
    ![](/img/edu/bioloid/tutorial_printscr_1_10_kr.png)

8. 태스크 코드 저장 하기  
  Ctrl + S 를 누르거나 도구 모음의 저장 버튼을 눌러 저장합니다.

    ![](/img/edu/bioloid/tutorial_printscr_1_11_kr.png)
...
1. **프로그램 출력용 모니터** 창 띄우기  
  프로그램 실행 시 화면 출력을 보기 위해서는 반드시 프로그램 실행 전에 **프로그램 출력용 모니터** 창을 띄워야 합니다. 프로그램 출력용 모니터 창을 띄우는 방법은 아래와 같이 여러 가지가 있습니다.
    - 프로그램 다운로드 창에서 프로그램 출력 보기 버튼을 클릭
      ...
      ![](/img/edu/bioloid/tutorial_printscr_3_01_kr.png)
...
[화면 출력 후 줄 바꿈]: /docs/software/rplus1/task/programming_02#화면출력줄바꿈
[태스크 코드 작성]: /docs/software/rplus1/task/programming_01#프로그래밍
[프로그램 시작]: /docs/software/rplus1/task/programming_01#프로그램-시작
[무조건 반복]: /docs/software/rplus1/task/programming_01#무조건-반복
[명령줄 만들기]: /docs/software/rplus1/task/programming_01#줄-삽입
[로드]: /docs/software/rplus1/task/programming_01#로드
[화면 출력]: /docs/software/rplus1/task/programming_02#화면출력줄바꿈
[파라미터에 대한 설명]: /docs/software/rplus1/task/programming_02#제어기-파라미터
[태스크 코드 다운로드 방법]: /docs/software/rplus1/task/getting_started#프로그램-다운로드
## 버튼과 LED
- `학습 목표`: `U` 버튼을 누르면 AUX LED 가 켜지고, `D` 버튼을 누르면 AUX LED 가 꺼지게 합니다. `START` 버튼을 누르면 종료됩니다.

### 태스크 코드 작성
![](/img/edu/bioloid/tutorial_button_led_01_kr.png)
...
![](/img/edu/bioloid/attackingduck_kr.png)
...
![](/img/edu/bioloid/attackingduck_tsk-01_kr.png)
...
4. 전방에 물체 감지 시 공격  
  AX-S1 의 중앙 거리센서에 물체가 감지되면 부리공격을 호출하여 공격합니다.
    ...
    ![](/img/edu/bioloid/attackingduck_tsk-02_kr.png)

    ![](/img/edu/bioloid/attackingduck_tsk-03_kr.png)
...
![](/img/edu/bioloid/attackingduck_action_kr.png)


## 장애물 감지차
장애물을 피하며 주행하는 지능형 자동차를 만들어 보겠습니다. 조립서의 2-2-9. 장애물 감지 차를 참조하여 하드웨어를 완성하십시오.

![](/img/edu/bioloid/detectcar_kr.png)
...
AX-12+ 를 장애물 감지차의 바퀴로 사용하기 위해 바퀴 모드(무한 회전 모드)로 변경합니다. 변경 방법은 [로보플러스 매니저] 를 사용하여 AX-12+ 의 CW 위치 제한 값과 CCW 위치 제한 값을 모두 0 으로 설정하면 됩니다.
 ...
 ![](/img/edu/bioloid/detectcar-01_KR.png)

### 태스크 코드 작성

 ![](/img/edu/bioloid/detectcar-02_KR.png)
 ...
 3. 물체 감지 유무 값(장애물 감지 방향)에 따라 적절한 동작 함수를 호출합니다.
    ...
    ![](/img/edu/bioloid/detectcar-03_KR.png)
...
![](/img/edu/bioloid/detectcar-result_KR.png)
...
![](/img/edu/bioloid/walkingdroid_01_kr.png)
...
![](/img/edu/bioloid/wd_async_motion_kr.png)
...
![](/img/edu/bioloid/motion_status_kr.png)
...
![](/img/edu/bioloid/wd_task_01_kr.png)
...
4. 만약 좌회전 해도 중앙 거리센서에 물체가 감지되는 경우 감지되지 않을 때까지 좌회전합니다.
    ![](/img/edu/bioloid/wd_task_02_kr.png)
...
다운로드한 태스크 코드를 PLAY 시킵니다. 보행 경로 상에 장애물을 설치해 놓고 보행 드로이드가 장애물을 피해서 보행하는 것을 확인합니다.
  ...
  ![](/img/edu/bioloid/wd_result_kr.png)
...
앞서 [보행 드로이드 제작 2(태스크 코드)](#보행-드로이드-제작-2태스크-코드) 에서 작성한 태스크 코드를 기반으로
  ...
  ![](/img/edu/bioloid/wd_task_rc_kr.png)
...
2. 끌어 놓기(Drag & Drop)로 .bpg 열기  
  ...
  ![](/img/edu/bioloid/convert_bpg_tsk_1_kr.png)
...
|:-----------------------------------------------:|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_01-1_kr.png) | ![](/img/edu/bioloid/cmd_01-2_kr.png) |
...
|                로보플러스 태스크                |             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_02-1_kr.png) | ![](/img/edu/bioloid/cmd_02-2_kr.png) |
...
|                로보플러스 태스크                |             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_04-1_kr.png) | ![](/img/edu/bioloid/cmd_04-2_kr.png) |
...
|                로보플러스 태스크                |             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_05-1_kr.png) | ![](/img/edu/bioloid/cmd_05-2_kr.png) |
...
|                로보플러스 태스크                |             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_06-1_kr.png) | ![](/img/edu/bioloid/cmd_06-2_kr.png) |
...
|                로보플러스 태스크                |             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_07-1_kr.png) | ![](/img/edu/bioloid/cmd_07-2_kr.png) |
...
|                로보플러스 태스크                |             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_08-1_kr.png) | ![](/img/edu/bioloid/cmd_08-2_kr.png) |
...
|                로보플러스 태스크                |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_09-3_kr.png) |

|             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_09-4_kr.png) |
...
|                로보플러스 태스크                |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_09_1_kr.png) |

|             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_09-2_kr.png) |
...
|                로보플러스 태스크                |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_10-1_kr.png) |

|             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_10-2_kr.png) |
...
|                로보플러스 태스크                |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_11-1_kr.png) |

|             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_11-2_kr.png) |
...
|                로보플러스 태스크                |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_12-1_kr.png) |

|             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_12-2_kr.png) |
...
|                로보플러스 태스크                |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_13-1_kr.png) |

|             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_13-2_kr.png) |
...
|                로보플러스 태스크                |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_14-1_kr.png) |

|             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_14-2_kr.png) |
...
|                로보플러스 태스크                |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_16-1_kr.png) |

|             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_16-2_kr.png) |
...
|                로보플러스 태스크                |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_17-1_kr.png) |

|             행동제어 프로그래머 1.0             |
|:-----------------------------------------------:|
| ![](/img/edu/bioloid/cmd_17-2_kr.png) |
...
![CM-5_to_PC-01](/img/parts/controller/cm-5/cm_5_connect_pc_01.png)
...
2. 사용할 통신 포트를 선택해야 합니다.  
  자동 찾기 기능을 이용하면 쉽게 통신 포트를 설정할 수 있습니다.
    ...
    ![](/img/edu/bioloid/select_port.png)

    - RoboPlus Task 가 제어기를 찾지 못하면 아래와 같은 에러 메시지가 나타납니다.

    ![](/img/edu/bioloid/cannot_find_controller.png)
...
3. 다운로드 메뉴를 선택합니다.
    ...
    ![](/img/edu/bioloid/download_button.png)

    만약, 프로그램에 오류가 있다면 오류를 찾아 수정해야 합니다. (룰 체크 에러 메시지 확인)

4. 다운로드를 진행합니다.

    ![](/img/edu/bioloid/download_progress_bar.png)
...
[펌웨어 업데이트]: /docs/software/rplus1/manager#펌웨어-업데이트
...
3. 다운로드 버튼을 누르고 완료되기를 기다립니다.
    ...
    ![](/img/edu/bioloid/down_menu.png)
    
4. 파일 모션의 내용이 로봇 모션에 옮겨진 것을 확인합니다.

    ![](/img/edu/bioloid/bioloid_down_motion_02.png)
...
|Robot|Description|
| :---: | :--- |
|1. 공룡  <br />![](/img/edu/bioloid/dinosaur_kr.jpg)|- 조립확인 태스크 코드 [Download] [BIO_CMP_Dinosaur_Check_KR.tsk]<br />- 데모용 태스크 코드 [Download] [BIO_CMP_Dinosaur_KR.tsk]<br />- 데모용 모션 파일 [Download] [BIO_CMP_Dinosaur_KR.mtn]<br />- [동영상](https://www.dropbox.com/s/116km4n144n3cax/2_10.wmv?dl=0)<br />- 다이나믹셀 설정값: AX-12+ ID[1]~ ID[15] : 관절모드 <br /> AX-S1 ID[100] <br />- 동작방법 : 보행 경로 상에 장애물을 설치해 놓고 공룡 로봇을 작동시킵니다. <br /> 공룡 로봇이 장애물을 공격하는 것을 확인합니다. <br /> 장애물이 없어지면 계속 걸어 갑니다.|
|2. 강아지   <br />![](/img/edu/bioloid/dog_kr.jpg)|- 조립확인 태스크 코드 [Download] [BIO_CMP_Puppy_Check_KR.tsk]<br />- 데모용 태스크 코드 [Download] [BIO_CMP_Puppy_KR.tsk]<br />- 데모용 모션 파일 [Download] [BIO_CMP_Puppy_KR.mtn]<br />- [동영상](https://www.dropbox.com/s/iemos074yusb15n/2_9.wmv?dl=0)<br />- 다이나믹셀 설정값: AX-12+ ID[1], ID[4] ~ ID[17] : 관절모드 <br /> AX-S1 ID[100] <br /> - 동작방법 : 주행 경로 상에 장애물을 설치해 놓고 강아지를 작동시킵니다. <br /> 소리가 나면 장애물을 피해가면서 보행하는 것을 확인합니다.<br /> 입을 만져주면 재롱을 부립니다.<br /> 일정 시간이 지나도록 아무 변화가 없으면 앉아서 잠을 잡니다.|
...
![](/img/edu/bioloid/cm5_fuse_kr.png)
...
2. 연결 버튼을 누릅니다.
    ...
    ![](/img/edu/bioloid/id_change_1_kr.png)
...
5. ID 목록 콤보박스를 클릭하면 현재 바꿀 수 있는 다이나믹셀의 ID를 볼 수 있습니다. 바꾸고자 하는 ID를 선택하고 적용 버튼을 누르십시오.
    ...
    ![](/img/edu/bioloid/id_change_2_kr.png)
...
2. 연결 버튼을 누릅니다.   
    ...
    ![](/img/edu/bioloid/mode_change_1_kr.png)
...
4. 바퀴 모드를 설정하려면 CW/CCW 위치 제한 컨트롤 테이블의 값을 모두 0으로 변경하면 됩니다. 다음과 같이 바퀴 모드 버튼을 클릭하여 쉽게 설정할 수도 있습니다.
    ...
    ![](/img/edu/bioloid/mode_change_2_kr.png)
...
2. 만약 다음 그림과 같이 리스트에서 다이나믹셀을 확인할 수 없다면 상세 검색 버튼을 누르시기 바랍니다.  
  ...
  ![](/img/edu/bioloid/dxl_search_kr.png)  
...
## 지그비 무선 조종
## 지그비 무선 조종
![](/img/edu/bioloid/zig-100_110_kr.png)
...
|:-------------------------------------------------------------:|:---------------------------------------------------:|
| ![](/img/edu/bioloid/rc-100_zig-100_insert4_kr.jpg) | ![](/img/edu/bioloid/cm100_zig110_kr.jpg) |
|             CM-510 에 ZIG-110 모듈을 장착한 모습              |         CM-5 에 ZIG-100 모듈을 장착한 모습          |
|      ![](/img/edu/bioloid/cm510_zig110_kr.png)      |  ![](/img/edu/bioloid/cm5_zig100_kr.png)  |
...
![](/img/edu/bioloid/broadcast_zig2cm5_kr.png)

##### RC-100과 다수 로봇과의 통신
![](/img/edu/bioloid/broadcast_rc2cm5_kr.png)
...
##### Zig2Serial과 다수 로봇과의 통신
![](/img/edu/bioloid/broadcast_zig2prm_kr.png)

##### RC-100과 다수 로봇과의 통신
![](/img/edu/bioloid/broadcast_rc2prm_kr.png)
...
[로보플러스 태스크]: /docs/software/rplus1/task/getting_started
[제어기 선택]: /docs/software/rplus1/task/task_misc#제어기-선택
[BIO_CMP_AttackingDuck_KR.tsk]: http://www.robotis.com/service/download.php?no=1181
[RoboPlus Manager]: /docs/software/rplus1/manager
[물체 감지 기준 값과 물체 감지 유무]: /docs/software/rplus1/task/programming_02#물체감지
[BIO_CMP_ObstacleDetectionCarExam_KR.tsk]: http://www.robotis.com/service/download.php?no=1214
[로봇 연결하기 참조]: /docs/software/rplus1/motion#로봇-연결하기
[BIO_CMP_WalkingDroidExam1_KR.mtn]: http://www.robotis.com/service/download.php?no=1241
[BIO_CMP_WalkingDroid_KR.tsk]: http://www.robotis.com/service/download.php?no=1246
...
[BIO_CMP_WalkingDroidExam_KR.tsk]: http://www.robotis.com/service/download.php?no=1243
[BIO_CMP_WalkingDroidExam_KR.mtn]: http://www.robotis.com/service/download.php?no=1242
[프로그램 시작의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#프로그램-시작
[프로그램 강제 종료의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#프로그램-강제종료
[구간 시작/끝의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#구간-시작끝
[계산의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#계산
[로드의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#로드
[레이블의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#레이블점프
[점프의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#레이블점프
[만약/아니면 만약/아니면의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#조건문
[무조건 반복의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#무조건-반복
[조건 반복의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#조건-반복
[횟수만큼 반복의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#횟수-반복
[반복 끝내기의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#반복-끝내기
[조건 대기의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#조건-대기
[콜백의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#콜백-함수
[함수 만들기/함수 호출의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#함수-만들기호출
[함수 강제 종료의 자세한 사용법은 여기를 참고하세요.]: /docs/software/rplus1/task/programming_01#함수-강제종료
[ZIG-100/110]: /docs/parts/communication/zig-110
[상대 로봇 무선 ID]: /docs/software/rplus1/manager#상대-로봇-무선-id
