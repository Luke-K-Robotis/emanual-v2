...
# 개요
![](/img/edu/bioloid/gp_main_KR.jpg)
...
- 로봇을 켜고 PLAY 모드를 실행 한 후, R / D / L / U 버튼을 누르면 다음 모드가 실행 됩니다.
  ...
  - L or R : 퍼포먼스 모드  
    ...
    ![](/img/edu/bioloid/bp_act_4_1_KR.jpg)
...
![](/img/edu/bioloid/bp_act_4_2_KR.jpg)
...
[기본 프로그램]: #기본-프로그램
[충전하기]: #충전하기
[RC-100의 채널 변경 방법]: /docs/parts/communication/rc-100#적외선-통신채널-설정-방법
[ZIG-110 세트]: /docs/parts/communication/zig-110
...
[절대 거리 센서]: /docs/parts/sensor/dms-80
