...
![](/img/software/mobile/apk_install/apk_install_01.png)
> 안드로이드 5.0(롤리팝, 왼쪽)과 안드로이드 8.0(오레오, 오른쪽)의 `설정` 메뉴

## 2. 보안 설정

![](/img/software/mobile/apk_install/apk_install_02.png)
...
### 3-1. 안드로이드 5.0(롤리팝) 설정방법
  ...
  ![](/img/software/mobile/apk_install/apk_install_03.png)

### 3-2. 안드로이드 8.0(오레오) 설정방법

  ![](/img/software/mobile/apk_install/apk_install_04.png)

  ![](/img/software/mobile/apk_install/apk_install_05.png)
  > 설정이 완료된 상태의 화면
...
기기마다 파일 브라우저가 다를 수 있으므로 사용하시는 기기의 설명서를 참고해 주세요.
  ...
  ![](/img/software/mobile/apk_install/apk_install_06.png)

### 4-2. 다운로드 폴더로 이동

  ![](/img/software/mobile/apk_install/apk_install_07.png)

### 4-3. 폴더 내에서 다운로드 받은 apk 파일 실행

  ![](/img/software/mobile/apk_install/apk_install_08.png)
