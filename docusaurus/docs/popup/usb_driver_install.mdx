...
sidebar_label: "Windoes Driver Installation"
---
...
Connect your controller to a PC via the USB cable.
  ...
  ![](/img/parts/controller/opencm904/connect_pc.png)
...
3. Right-Click the downloaded folder to extract.  
  ![](/img/faq/driver_installation_en/extracting_driver.png)

4. Click on **Install**  
  ![](/img/faq/driver_installation_en/install_inf.png)

5. Click on **Open**  
  ![](/img/faq/driver_installation_en/installing_driver.png)
...
3. Open **Device Manager**, and find **ROBOTIS Virtual COM Port**.  
  ![](/img/faq/driver_installation_en/device_manager.png)

4. Right-click on **ROBOTIS Virtual COM Port** and click on **Update Driver Software**.  
  ![](/img/faq/driver_installation_en/manual_installation_01.png)

5. Select **Browse my computer for driver software**.  
  ![](/img/faq/driver_installation_en/manual_installation_02.png)

6. Click on **Browse**.  
  ![](/img/faq/driver_installation_en/manual_installation_02_1.png)  

7. Locate the folder that contains driver files.  
  ![](/img/faq/driver_installation_en/manual_installation_03.png)  

8. Click **Next**. Successful installation will say “Windows has successfully updated your driver software”  
  ![](/img/faq/driver_installation_en/manual_installation_04.png)
...
![](/img/faq/driver_installation_en/check_resisterd_port.png)
