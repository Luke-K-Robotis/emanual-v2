...
# Introduction
![](/img/edu/bioloid/premium_product.png)
...
# Getting Started
## Part List
![](/img/edu/bioloid/premium_partlist_en_01.png)

![](/img/edu/bioloid/premium_partlist_en_02.png)
...
![](/img/parts/controller/cm-530/cm_530_turn_on.png)
...
![](/img/parts/controller/cm-530/cm_530_battery_check.jpg)
...
![](/img/edu/bioloid/premium_operation_01.jpg)

![](/img/edu/bioloid/premium_operation_02.jpg)
...
![](/img/edu/bioloid/premium_operation_03.jpg)
...
![](/img/edu/bioloid/premium_operation_04.jpg)
...
| ![](/img/edu/bioloid/premium_operation_05.jpg) | ![](/img/edu/bioloid/premium_operation_06.jpg) | ![](/img/edu/bioloid/premium_operation_07.jpg) |
|:--------------------------------------------------------:|:--------------------------------------------------------:|:--------------------------------------------------------:|
...
| ![](/img/edu/bioloid/premium_operation_08.jpg) | ![](/img/edu/bioloid/premium_operation_06.jpg) | ![](/img/edu/bioloid/premium_operation_09.jpg) |
|:--------------------------------------------------------:|:--------------------------------------------------------:|:--------------------------------------------------------:|
...
![](/img/edu/bioloid/premium_operation_10.jpg)
...
![](/img/edu/bioloid/premium_tutorial_01.png)
...
|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|
| ![](/img/edu/bioloid/premium_tutorial_02.png) | ![](/img/edu/bioloid/premium_tutorial_03.png) | ![](/img/edu/bioloid/premium_tutorial_04.png) | ![](/img/edu/bioloid/premium_tutorial_05.png) |

|                  Walk Sideways + Left                   |                  Walk Sideways + Right                  |                   Turn Left + Forward                   |                  Turn Right + Forward                   |
|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|
| ![](/img/edu/bioloid/premium_tutorial_06.png) | ![](/img/edu/bioloid/premium_tutorial_07.png) | ![](/img/edu/bioloid/premium_tutorial_08.png) | ![](/img/edu/bioloid/premium_tutorial_09.png) |

|                     Backward + Left                     |                    Backward + Right                     |                       Avoid Left                        |                       Avoid Right                       |
|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|
| ![](/img/edu/bioloid/premium_tutorial_10.png) | ![](/img/edu/bioloid/premium_tutorial_11.png) | ![](/img/edu/bioloid/premium_tutorial_12.png) | ![](/img/edu/bioloid/premium_tutorial_13.png) |

|                Forward + Left Diagonally                |               Forward + Right Diagonally                |               Backward + Left Diagonally                |               Backward + Right Diagonally               |
|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|
| ![](/img/edu/bioloid/premium_tutorial_14.png) | ![](/img/edu/bioloid/premium_tutorial_15.png) | ![](/img/edu/bioloid/premium_tutorial_16.png) | ![](/img/edu/bioloid/premium_tutorial_17.png) |
...
![](/img/edu/bioloid/premium_tutorial_20.png)
...
[Callback Function]: /docs/software/rplus1/task/programming_01#callback-function
- [Joint Offset]
...
[Joint Offset]: /docs/software/rplus1/task/programming_02#joint-offset
### Task Code Overview

1. `InitializationGyro` Call Function

  ![](/img/edu/bioloid/premium_tutorial_21.png)
...
2. Execute `BalancePage` to Apply Joint Offset
  ...
  ![](/img/edu/bioloid/premium_tutorial_22.png)
...
3. `InitializationGyro` Function
  ...
  ![](/img/edu/bioloid/premium_tutorial_23.png)
...
4. Calculating the adjustment value in the `Callback Function`
  ...
  ![](/img/edu/bioloid/premium_tutorial_24.png)
  ...
  ![](/img/edu/bioloid/premium_tutorial_25.png)
...
1. Execute RoboPlus Motion, then connect it to the controller(Please refer to [Connect Robot](/docs/software/rplus1/motion#connect-to-robot))

  ![](/img/edu/bioloid/premium_tutorial_26.png)

  ![](/img/edu/bioloid/premium_tutorial_27.jpg)

2. To add the “Block Ball” motion in page 14, input a name and step.

  ![](/img/edu/bioloid/premium_tutorial_28.jpg)

3. Turn off all motors, then set the robot’s pose.  The "Block ball on the right" pose is shown below.

  ![](/img/edu/bioloid/premium_tutorial_29.jpg)
...
4. Set the robot’s pose as above. When you press the "torque on" button, the robot’s current actuator values will automatically be saved. When you press the left arrow button, you can read the robot’s current input actuator values into Step’s Pose column.
  ...
  ![](/img/edu/bioloid/premium_tutorial_30.jpg)

5. You can adjust the pause and play durations. (Please refer for more information about [STEP STOP/PLAY](/docs/software/rplus1/motion#pause))

  ![](/img/edu/bioloid/premium_tutorial_31.jpg)
...
6. Designating the NEXT page as itself(14) will cause the robot to enter an infinite loop and maintain its pose.  Also designate an EXIT page for the robot to smoothly transiton into when it exits the infinite loop.
  ...
  ![](/img/edu/bioloid/premium_tutorial_32.jpg)
...
7. Make a motion to return to the standard position on the page designated as the Exit page (15). Add the following 3 steps and poses to page 15.
  ...
  ![](/img/edu/bioloid/premium_tutorial_33.jpg)

8. Additional settings ([Number of Repeats, Play Speed, etc](/docs/software/rplus1/motion#set-page-repeattime))

  You can also set the number of repeats, entire speed, etc. for each page.

  ![](/img/edu/bioloid/premium_tutorial_34.jpg)
...
Code to execute user-defined motions has been added to the task code written in "Adjusting using the Gyro Sensor."
  ...
  ![](/img/edu/bioloid/premium_tutorial_38.png)
...
(For more information, please refer to the [Motion Page](/docs/software/rplus1/task/programming_02#motion-page)).
...
1. Initializing Gripper Control
  ...
  ![](/img/edu/bioloid/premium_tutorial_39.png)
...
2. Revise Callback Function (Gyro Adjustment)
  ...
  ![](/img/edu/bioloid/premium_tutorial_40.png)
...
3. Gripper/Arm Control Function
  ...
  ![](/img/edu/bioloid/premium_tutorial_41.png)
...
4. Controlling the arm and gripper with a remote controller
  ...
  ![](/img/edu/bioloid/premium_tutorial_42.png)
...
[img_ex_beginner_01]: /img/edu/bioloid/premium_crossinggate.jpg
[img_ex_beginner_02]: /img/edu/bioloid/premium_universalgauge.jpg
[img_ex_beginner_03]: /img/edu/bioloid/premium_crocodilemouth.jpg
[img_ex_beginner_04]: /img/edu/bioloid/premium_pantilt.jpg
[img_ex_beginner_05]: /img/edu/bioloid/premium_parkinggate.jpg
[img_ex_beginner_06]: /img/edu/bioloid/premium_smartcar.jpg
[img_ex_beginner_07]: /img/edu/bioloid/premium_clappingcrab.jpg
[img_ex_beginner_08]: /img/edu/bioloid/premium_attackingduck.jpg
[img_ex_beginner_09]: /img/edu/bioloid/premium_distancelevelmeter.jpg
[img_ex_beginner_10]: /img/edu/bioloid/premium_linetracer.jpg
[img_ex_beginner_11]: /img/edu/bioloid/premium_walkingdroid.jpg
...
[img_ex_intermediate_01]: /img/edu/bioloid/premium_probingrobot.jpg
[img_ex_intermediate_02]: /img/edu/bioloid/premium_excavator.jpg
[img_ex_intermediate_03]: /img/edu/bioloid/premium_robotflower.jpg
[img_ex_intermediate_04]: /img/edu/bioloid/premium_fawn.jpg
[img_ex_intermediate_05]: /img/edu/bioloid/premium_turtle.jpg
[img_ex_intermediate_06]: /img/edu/bioloid/premium_gerwalk.jpg
[img_ex_intermediate_07]: /img/edu/bioloid/premium_battledroid.jpg
[img_ex_intermediate_08]: /img/edu/bioloid/premium_quadrupedrobot.jpg
[img_ex_intermediate_09]: /img/edu/bioloid/premium_bipedwalkingrobot.jpg
[img_ex_intermediate_10]: /img/edu/bioloid/premium_robotarm.jpg
...
[img_ex_advanced_01]: /img/edu/bioloid/premium_dinosaur.jpg
[img_ex_advanced_02]: /img/edu/bioloid/premium_puppy.jpg
[img_ex_advanced_03]: /img/edu/bioloid/premium_kingspider.jpg
[img_ex_advanced_04]: /img/edu/bioloid/premium_scorpion.jpg
[img_ex_advanced_05]: /img/edu/bioloid/premium_lizard.jpg
...
| ![](/img/edu/bioloid/premium_skin_01.jpg) | ![](/img/edu/bioloid/premium_skin_02.jpg) |
|:---------------------------------------------------:|:---------------------------------------------------:|
| ![](/img/edu/bioloid/premium_skin_03.jpg) | ![](/img/edu/bioloid/premium_skin_04.jpg) |
| ![](/img/edu/bioloid/premium_skin_05.jpg) | ![](/img/edu/bioloid/premium_skin_06.jpg) |

Samples of customized head skins

![](/img/edu/bioloid/premium_skin_07.jpg)

![](/img/edu/bioloid/premium_skin_08.jpg)

Samples of robots with customized skins

| ![](/img/edu/bioloid/premium_skin_09.jpg) | ![](/img/edu/bioloid/premium_skin_10.jpg) | ![](/img/edu/bioloid/premium_skin_11.jpg) |
|:---------------------------------------------------:|:---------------------------------------------------:|:---------------------------------------------------:|
| ![](/img/edu/bioloid/premium_skin_12.jpg) | ![](/img/edu/bioloid/premium_skin_13.jpg) | ![](/img/edu/bioloid/premium_skin_14.jpg) |
...
[More information](/docs/software/rplus1/task/programming_02#ir-sensor)
...
[More information](/docs/software/rplus1/task/programming_02#touch-sensor)
...
![](/img/parts/controller/cm-530/cm510_external_io.png)
...
![](/img/edu/bioloid/premium_led_circuit.png)
...
![](/img/edu/bioloid/premium_diy_sensor_01.png)

![](/img/edu/bioloid/premium_diy_sensor_02.png)
...
![](/img/edu/bioloid/premium_diy_sensor_03.png)
...
![](/img/edu/bioloid/premium_gripper_assy_01.png)

### Making a gripper

![](/img/edu/bioloid/premium_gripper_assy_02.jpg)
...
![](/img/edu/bioloid/premium_gripper_assy_03.png)
...
[How to Download motion file]: /docs/software/rplus1/motion#download-motion
