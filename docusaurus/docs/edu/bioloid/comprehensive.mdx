...
# Getting Started
## Part List
![](/img/edu/bioloid/comprehensive_partlist_en.png)
...
5. Execute Firmware Wizard by pressing `Control Restoration` icon on RoboPlus Manager.
    ...
    ![Firmware-Recovery-1](/img/edu/bioloid/bioloid_entry_001.png)

    ![Firmware-Recovery-2](/img/edu/bioloid/bioloid_entry_002.png)
...
6. Select the port connected to the controller.
  Users must set manually the port connected to the controller. Finish other programs and continue the process since the controller cannot be recognized in case the port is in use.  Select the port connected to the controller and press "Find" button.
    ...
    ![Firmware-Recovery-3](/img/edu/bioloid/bioloid_entry_003.png)
...
7. Turn the power of the controller off and on.
  To find the controller, the controller to be restored must be turned off and on.
    ...
    ![Firmware-Recovery-4](/img/edu/bioloid/bioloid_entry_004.png)
...
8. Check the controller information.
  When the controller is found, the information of current controller and the firmware to download are appeared.  Check the model name whether the controller is connected by the user or not.  (The version of controller information is for Boot Loader, not for firmware.)
    ...
    ![Firmware-Recovery-5](/img/edu/bioloid/bioloid_entry_005.png)
...
9. Start the firmware installation again.
  Press "Next" button to start firmware restoration. Please be careful not to interrupt the connection or turn the power off until it is completed.
    ...
    ![Firmware-Recovery-6](/img/edu/bioloid/bioloid_entry_006.png)

10. Check the controller firmware re-installation result.

    ![Firmware-Recovery-7](/img/edu/bioloid/bioloid_entry_007.png)
...
[How to Download Task Code]: /docs/software/rplus1/task/getting_started#program-download
[img_011]: /img/edu/bioloid/bioloid_entry_tutorial_printscr_01.png
[img_012]: /img/edu/bioloid/bioloid_entry_tutorial_printscr_02.png
[img_013]: /img/edu/bioloid/bioloid_entry_tutorial_printscr_03.png
[img_014]: /img/edu/bioloid/bioloid_entry_tutorial_printscr_04.png
[img_015]: /img/edu/bioloid/bioloid_entry_tutorial_printscr_05.png
[img_016]: /img/edu/bioloid/bioloid_entry_tutorial_printscr_06.png
[img_017]: /img/edu/bioloid/bioloid_entry_tutorial_printscr_07.png
[img_018]: /img/edu/bioloid/bioloid_entry_tutorial_printscr_08.png
[img_019]: /img/edu/bioloid/bioloid_entry_tutorial_printscr_09.png
[img_020]: /img/edu/bioloid/bioloid_entry_tutorial_printscr_10.png
[img_021]: /img/edu/bioloid/bioloid_entry_tutorial_printscr_11.png
[img_022]: /img/edu/bioloid/bioloid_entry_tutorial_printscr_12.png
[img_023]: /img/edu/bioloid/bioloid_entry_tutorial_printscr_13.png
...
[img_024]: /img/edu/bioloid/bioloid_entry_tutorial_led.png
...
[img_025]: /img/edu/bioloid/bioloid_entry_tutorial_attackingduck_01.png
[img_026]: /img/edu/bioloid/bioloid_entry_tutorial_attackingduck_02.png
[img_027]: /img/edu/bioloid/bioloid_entry_tutorial_attackingduck_03.png
[img_028]: /img/edu/bioloid/bioloid_entry_tutorial_attackingduck_04.png
...
[img_029]: /img/edu/bioloid/bioloid_entry_tutorial_obstaclecar_01.png
[img_030]: /img/edu/bioloid/bioloid_entry_tutorial_obstaclecar_02.png
[img_031]: /img/edu/bioloid/bioloid_entry_tutorial_obstaclecar_03.png
[img_032]: /img/edu/bioloid/bioloid_entry_tutorial_obstaclecar_04.png
[img_033]: /img/edu/bioloid/bioloid_entry_tutorial_obstaclecar_05.png
...
[img_034]: /img/edu/bioloid/bioloid_entry_tutorial_droid_01.png
[img_035]: /img/edu/bioloid/bioloid_entry_tutorial_droid_02.png
[img_036]: /img/edu/bioloid/bioloid_entry_tutorial_droid_03.png
[img_037]: /img/edu/bioloid/bioloid_entry_tutorial_droid_04.png
[img_038]: /img/edu/bioloid/bioloid_entry_tutorial_droid_05.png
[img_039]: /img/edu/bioloid/bioloid_entry_tutorial_droid_06.png
[img_040]: /img/edu/bioloid/bioloid_entry_tutorial_droid_07.png
[img_041]: /img/edu/bioloid/bioloid_entry_tutorial_droid_08.png
[img_042]: /img/edu/bioloid/bioloid_entry_tutorial_droid_09.png
[img_043]: /img/edu/bioloid/bioloid_entry_tutorial_droid_10.png
[img_044]: /img/edu/bioloid/bioloid_entry_tutorial_droid_11.png
[img_045]: /img/edu/bioloid/bioloid_entry_tutorial_droid_12.png
[img_046]: /img/edu/bioloid/bioloid_entry_tutorial_droid_13.png
[img_047]: /img/edu/bioloid/bioloid_entry_tutorial_droid_14.png
...
[img_048]: /img/edu/bioloid/bioloid_entry_tutorial_droid_15.png
[img_049]: /img/edu/bioloid/bioloid_entry_tutorial_droid_16.png
[img_050]: /img/edu/bioloid/bioloid_entry_tutorial_droid_17.png
[img_051]: /img/edu/bioloid/bioloid_entry_tutorial_droid_18.png
[img_052]: /img/edu/bioloid/bioloid_entry_tutorial_droid_19.png
[img_053]: /img/edu/bioloid/bioloid_entry_tutorial_droid_20.png
...
[How to Download Task Code]: #download-task-code
[How to Download Motion File]: #download-motion-file
[img_054]: /img/edu/bioloid/bioloid_entry_tutorial_droid_21.png
...
[img_055]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_01.png
[img_056]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_02.png
[img_057]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_03.png
[img_058]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_04.png
[img_059]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_05.png
[img_060]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_06.png
[img_061]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_07.png
[img_062]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_08.png
[img_063]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_09.png
[img_064]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_10.png
[img_065]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_11.png
[img_066]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_12.png
[img_067]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_13.png
[img_068]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_14.png
[img_069]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_15.png
[img_070]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_16.png
[img_071]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_17.png
[img_072]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_18.png
[img_073]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_19.png
[img_074]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_20.png
[img_075]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_21.png
[img_076]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_22.png
[img_077]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_23.png
[img_078]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_24.png
[img_079]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_25.png
[img_080]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_26.png
[img_081]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_27.png
[img_082]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_28.png
[img_083]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_29.png
[img_084]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_30.png
[img_085]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_31.png
[img_086]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_32.png
[img_087]: /img/edu/bioloid/bioloid_entry_tutorial_convert_tsk_33.png
...
2. Select the correct COM port (if you know) or else use the "Automatic Search" function  to easily find out the appropriate port. .
    ...
    ![CM-5_to_PC-02](/img/parts/controller/cm-5/cm_5_connect_pc_02.png)
...
3. Select the download menu.
    ...
    ![CM-5_to_PC-03](/img/parts/controller/cm-5/cm_5_connect_pc_03.png)

    If the program has an error, you must find the error and correct it. (See "rule check error messages")

4. Download the program.

    ![CM-5_to_PC-04](/img/parts/controller/cm-5/cm_5_connect_pc_04.png)
...
3. Click on the "Download Motion" menu and wait for the download to complete.
    ...
    ![Download_Motion-01](/img/edu/bioloid/bioloid_down_motion_01.png)

4. Verify that the contents of the file motion have been copied to the robot motion as seen below.

    ![Download_Motion-02](/img/edu/bioloid/bioloid_down_motion_02.png)
...
[img_ex_01]: /img/edu/bioloid/bioloid_entry_crossinggate.png
[img_ex_02]: /img/edu/bioloid/bioloid_entry_universal_gauge.jpg
[img_ex_03]: /img/edu/bioloid/bioloid_entry_sound_level.jpg
[img_ex_04]: /img/edu/bioloid/bioloid_entry_crocodilemouth.jpg
[img_ex_05]: /img/edu/bioloid/bioloid_entry_pantilt.jpg
[img_ex_06]: /img/edu/bioloid/bioloid_entry_parkinggate.jpg
[img_ex_07]: /img/edu/bioloid/bioloid_entry_melodycar.png
[img_ex_08]: /img/edu/bioloid/bioloid_entry_robot_arm.png
[img_ex_09]: /img/edu/bioloid/bioloid_entry_obstacledetection.jpg
[img_ex_10]: /img/edu/bioloid/bioloid_entry_greetingpenguin.jpg
[img_ex_11]: /img/edu/bioloid/bioloid_entry_attackingduck.jpg
[img_ex_12]: /img/edu/bioloid/bioloid_entry_melodycar.png
[img_ex_13]: /img/edu/bioloid/bioloid_entry_clappingpenguin.png
[img_ex_14]: /img/edu/bioloid/bioloid_entry_walkingdroid.png
...
[img_inter_ex_01]: /img/edu/bioloid/bioloid_intermediate_probingrobot.jpg
[img_inter_ex_02]: /img/edu/bioloid/bioloid_intermediate_excavator.jpg
[img_inter_ex_03]: /img/edu/bioloid/bioloid_intermediate_flower.jpg
[img_inter_ex_04]: /img/edu/bioloid/bioloid_intermediate_fawn.jpg
[img_inter_ex_05]: /img/edu/bioloid/bioloid_intermediate_turtle.jpg
[img_inter_ex_06]: /img/edu/bioloid/bioloid_intermediate_spider.jpg
[img_inter_ex_07]: /img/edu/bioloid/bioloid_intermediate_gerwalk.jpg
[img_inter_ex_08]: /img/edu/bioloid/bioloid_intermediate_battledroid.jpg
...
[img_adv_ex_01]: /img/edu/bioloid/bioloid_advanced_dinosaur.jpg
[img_adv_ex_02]: /img/edu/bioloid/bioloid_advanced_puppy.jpg
[img_adv_ex_03]: /img/edu/bioloid/bioloid_advanced_kingspider.jpg
[img_adv_ex_04]: /img/edu/bioloid/bioloid_advanced_humanoid.jpg
...
2. Click “Connect”.
    ...
    ![DXL_Management_01](/img/software/rplus1/manager/dxl_management_01.png)
...
5. Click on the ID List combo box to see a list of possible ID's. Select the ID, then click Apply.
    ...
    ![DXL_Management_02](/img/software/rplus1/manager/dxl_management_02.png)
...
2. Click “Connect”.
    ...
    ![DXL_Management_03](/img/software/rplus1/manager/dxl_management_03.png)
...
4. To set to Wheel Mode, change the CW/CCW Angle Limit value to “0.”  Or, simply click on the "Wheel Mode" button.
    ...
    ![DXL_Management_04](/img/software/rplus1/manager/dxl_management_04.png)
...
2. If you are unable to find any DYNAMIXEL as in the image below, click on "DYNAMIXEL Search". If the communication speed is not set to 1Mbps, the "DYNAMIXEL Search" function automatically resets the controller’s communication speed to 1Mbps to enable it to be recognized.
  ...
  ![DXL_Management_05](/img/software/rplus1/manager/dxl_management_05.png)
...
- Communication with the Zig2Serial and various robots
  ...
  ![Control_Multiple_Robots_01](/img/edu/bioloid/bioloid_ctrl_multi_robot_01.png)

- Communication with the RC-100 and various robots

  ![Control_Multiple_Robots_02](/img/edu/bioloid/bioloid_ctrl_multi_robot_02.png)
...
- Communication with the Zig2Serial and various robots
  ...
  ![Control_Multiple_Robots_03](/img/edu/bioloid/bioloid_ctrl_multi_robot_03.png)

- Communication with the RC-100 and various robots

  ![Control_Multiple_Robots_04](/img/edu/bioloid/bioloid_ctrl_multi_robot_04.png)
