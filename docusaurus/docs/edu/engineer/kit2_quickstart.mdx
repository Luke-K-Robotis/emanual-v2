...
## Download Examples
**NOTE**: Before downloading the example files for ENGINEER KIT 2, the firmware of the CM-550 controller must be updated. [Instructions to Update CM-550 firmware using R+ Manager 2.0 software](/docs/software/rplus2/manager#firmware-update)
...
![](/img/edu/engineer/kit2/engineer2_app_execution.png)
...
![](/img/edu/engineer/kit2/kit2_streaming_bluetooth.png)

### MAX-E2
Run `ROBOTIS ENGINEER` Kit2 App and select **MAX-E2**.

#### Remote Controller Screen
![](/img/edu/engineer/kit2/max2_controller.jpg)
...
|                           Icon                           | Description                                                                                                                      |
|:--------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------|
|  ![](/img/edu/engineer/kit2/icon_remote.png)   | **REMOTE**<br /> Control and change MAX-E2 to various modes as FIGHT/ SOCCER/ etc.                                                 |
| ![](/img/edu/engineer/kit2/icon_streaming.png) | **STREAMING**<br />Control the robot by watching videos taken from Raspberry Pi camera on your smart device and selecting buttons. |
|   ![](/img/edu/engineer/kit1/icon_face.png)    | **FACE**<br />Certain motions as greetings is available by face detection using Raspberry PI camera.                               |

#### MAX-E2 Options
|                         Icon                          | Description                                                                  |
|:-----------------------------------------------------:|:-----------------------------------------------------------------------------|
| ![](/img/edu/engineer/kit1/icon_motor.png)  | **MOTOR**<br /> Check the motor operation of the robot.                        |
| ![](/img/edu/engineer/kit1/icon_offset.png) | **OFFSET**<br /> Alter the DYNAMIXEL's position value, posture of robots, etc. |

![](/img/edu/engineer/kit2/kit2_motor_inspection_layout.png)
> MOTOR Inspection

![](/img/edu/engineer/kit2/kit2_offset_layout.png)
> OFFSET Adjustment  
...
![](/img/edu/engineer/kit2/commando_demo.png)
...
#### Commando Mode Menu
![](/img/edu/engineer/kit1/icon_remote.png)
...
![](/img/edu/engineer/kit2/commando_control.png)
...
#### Scorpi Demo Screen
![](/img/edu/engineer/kit2/scorpi_demo.png)
...
|                         아이콘                         | 메뉴 설명                                                                                                                                                                                                              |
|:------------------------------------------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](/img/edu/engineer/kit1/icon_remote.png)  | **REMOTE** <br />Control Scorpi's moves, directions, speed, and various motions with the tail and the claws.                                                                                                             |
| ![](/img/edu/engineer/kit2/icon_gesture.png) | **GESTURE** <br />After running the gesture mode, hold the screen of the smart device upwards. In this state, tilt the device to move the robot. If you shake the device strongly, the robot attacks by moving its tail. |

![](/img/edu/engineer/kit2/scorpi_control.png)  
  > Scorpi REMOTE Mode Screen

![](/img/edu/engineer/kit2/scorpi_gesture.png)  
  > GESTURE Mode Screen  
...
[How to download Python Example Source Code]: https://emanual.robotis.com/docs/en/popup/engineer/python_download_pc/
