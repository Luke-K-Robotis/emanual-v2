...
# Introduction
![](/img/edu/engineer/kit1/enginner_main.png)
...
## Parts List
![](/img/edu/engineer/kit1/kit1_parts_list.png)
...
#### CM-550 Layout
![](/img/edu/engineer/kit1/cm550_1.png)

![](/img/edu/engineer/kit1/cm550_2.png)
...
![](/img/edu/engineer/kit1/2xl430_intro.png)
...
![](/img/edu/engineer/kit1/2xl430_assembly_caution_1.png)

![](/img/edu/engineer/kit1/2xl430_assembly_caution_2.png)
...
##### Check DYNAMIXEL ID
![](/img/edu/engineer/kit1/2xl430_id.png)

##### Check DYNAMIXEL Horn Position
![](/img/edu/engineer/kit1/2xl430_horn.png)  
...
![](/img/edu/engineer/kit1/rivet_assembly_6mm.png)  
...
![](/img/edu/engineer/kit1/rivet_assembly_12mm.png)
...
![](/img/edu/engineer/kit1/cable_assembly_1.png)

##### Wiring through Idler Cap

![](/img/edu/engineer/kit1/cable_assembly_2.png)
...
![](/img/edu/engineer/kit1/icon_task_48.png)  
...
![](/img/edu/engineer/kit1/icon_engineer_48.png)  
...
![](/img/edu/engineer/kit1/engineer_app_1.png)
...
![](/img/edu/engineer/kit1/engineer_app_configuration.png)
...
1. Turn on the CM-550 controller with power switch.  
  ![](/img/edu/engineer/kit1/bluetooth_connection_1.png)

2. Press the `MODE` button until green light flashes.  
  ![](/img/edu/engineer/kit1/bluetooth_connection_2.png)
...
3. Press the `START` button.  
  ![](/img/edu/engineer/kit1/bluetooth_connection_3.png)
...
4. Launch the `ROBOTIS ENGINEER` app from the smart device and press the Bluetooth icon.  
  ![](/img/edu/engineer/kit1/bluetooth_connection_4.png)
...
6. Enter the last two characters of BLE MAC address in the left box and press `Search` icon.  
  ![](/img/edu/engineer/kit1/bluetooth_connection_6.png)

7. Select the BLE MAC address from the search list.  
  ![](/img/edu/engineer/kit1/bluetooth_connection_7.png)
...
![](/img/edu/engineer/kit1/engineer_app_emotion_1.png)

#### Select Mode

Press the `Mode` button to display supported modes and options.

![](/img/edu/engineer/kit1/engineer_app_emotion_3.png)

##### Mode Menu

|                         Icon                          | Mode Description                                                                                                                                                                                                    |
|:-----------------------------------------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|  ![](/img/edu/engineer/kit1/icon_demo.png)  | **DEMO : Emotion Recognition**<br />This default demo mode expresses Dr.R’s emotion on the smart device screen.<br />Touch the robot or smart device will affect to Dr.R’s emotion and behavior.                        |
|  ![](/img/edu/engineer/kit1/icon_face.png)  | **FACE : Face Recognition**<br />The robot detects and tracks the face with the camera of the smart device.<br />AR technology will overlay an image on the detected face.                                              |
| ![](/img/edu/engineer/kit1/icon_object.png) | **OBJECT : Object Recognition**<br />The robot recognizes machine learned objects with the smart device camera.<br />Dr.R can distinguish 12 different objects including banana, pen, car key, wallet, paper money etc. |
| ![](/img/edu/engineer/kit1/icon_voice.png)  | **VOICE : Voice Recognition**<br />The robot recognizes registered voice commands.<br />Commands such as mode change, option menu execution, and termination are registered.                                            |
|  ![](/img/edu/engineer/kit1/icon_clap.png)  | **CLAP : Clap Detection**<br />The robot detects clapping sound with the controller microphone.<br />Dr.R will clap as many as perceived claps.                                                                         |

##### Option Menu

|                         Icon                          | Option Description                                                                                          |
|:-----------------------------------------------------:|:------------------------------------------------------------------------------------------------------------|
| ![](/img/edu/engineer/kit1/icon_motor.png)  | **MOTOR : DYNAMIXEL Inspection**<br />This feature inspects each joint of the robot.                          |
| ![](/img/edu/engineer/kit1/icon_offset.png) | **OFFSET : Motion Offset**<br />This feature calibrates the offset position of each joint for proper motions. |
...
![](/img/edu/engineer/kit1/max_controller.png)
...
|                          Icon                          | Mode Description                                                                             |
|:------------------------------------------------------:|:---------------------------------------------------------------------------------------------|
| ![](/img/edu/engineer/kit1/icon_remote.png)  | **REMOTE** : Use smart device as a remote controller.                                        |
| ![](/img/edu/engineer/kit1/icon_gesture.png) | **GESTURE** : Use registered gestures in the smart device to control the robot.              |
|  ![](/img/edu/engineer/kit1/icon_clap.png)   | **CLAP** : The robot detects clapping sound and MAX-E1 will clap as many as perceived claps. |

### SPI
#### Remote Controller Screen

![](/img/edu/engineer/kit1/spi_controller.png)
...
|:-----------------------------------------------------:|:------------------------------------------------------------------------------------------|
| ![](/img/edu/engineer/kit1/icon_remote.png) | **REMOTE** : Use smart device as a remote controller.                                     |
| ![](/img/edu/engineer/kit1/icon_music.png)  | **MUSIC** : SPI and smart device play music together.                                     |
|  ![](/img/edu/engineer/kit1/icon_clap.png)  | **CLAP** : The robot detects clapping sound and SPI will clap as many as perceived claps. |
...
1. Launch the robot example from the main screen, and select `OFFSET` from the option menu.  
  ![](/img/edu/engineer/kit1/engineer_app_motor_offset.png)

2.  Select the joint ID to adjust offset from the screen and adjust menu will appear.  
  ![](/img/edu/engineer/kit1/engineer_app_motor_offset_2.png)
...
3. Select `OK` to save the offset value. The confirmation message will appear.  
  ...
  ![](/img/edu/engineer/kit1/engineer_app_motor_offset_3.png)

4. Below buttons will reset or reload offset values of each joint.  
  ![](/img/edu/engineer/kit1/engineer_app_motor_offset_4.png)
...
1. Open a Command Prompt as an administrator.
  ...
  - Type **CMD** into the Windows search box and click the resulting “Command Prompt” as an administrator. 
    ...
    ![](/img/edu/engineer/kit1/obj_classification_cmd_01.png)

2. Command Prompt will be popped if you get access to CMD in the administrator mode.   

    ![](/img/edu/engineer/kit1/obj_classification_cmd_02.png)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_cmd_03.png)

4. As shown in the picture below, new pip package will be installed.

    ![](/img/edu/engineer/kit1/obj_classification_cmd_04.png)
...
1. Create Folder named `!R+Smart`
    ...
    ![](/img/edu/engineer/kit1/obj_classification_mkdir_01.png)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_mkdir_02.png)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_mkdir_03.png)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_tensor_01.png)
...
2. It will ask you if you want to proceed to the next step. Press `y`, and then press `Enter` key to install the Python version and new packages.
    ...
    ![](/img/edu/engineer/kit1/obj_classification_tensor_02.png)

3. As shown in the picture, you can see all the packages are successfully installed.  

    ![](/img/edu/engineer/kit1/obj_classification_tensor_03.png)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_tensor_04.png)
...
:::
    ...
    ![](/img/edu/engineer/kit1/obj_classification_tensor_05.png)
...
2. Move the downloaded file `retrain.py` in `!R+Smart` folder. Create a `photos` folder in `!R+Smart` to add images for an object detection.  
    ...
    ![](/img/edu/engineer/kit1/obj_classification_tensor_retrain.png)
...
3. Create subfolders named `001 dummy`, `002 banana` and `003 pineapple` or something like that, which contains images matching a detected object characteristic for an object detection.  
    ...
    ![](/img/edu/engineer/kit1/obj_classification_image_01.png)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_img_learning_01.png)
...
2. After completion of training,  `Smart_OC.txt` and  `Smart_OC.pb` files will be created in the `!R+Smart` folder.
   ...
   ![](/img/edu/engineer/kit1/obj_classification_oc.png)
...
2. Enter  `RoboPlus` > `ROBOTIS ENGINEER` > `CUSTOM` of your device folder. 
    ...
    ![](/img/edu/engineer/kit1/obj_classification_application_01.png)  
    ![](/img/edu/engineer/kit1/obj_classification_application_02.png)  
    ![](/img/edu/engineer/kit1/obj_classification_application_03.png)

3. Create a folder named `Project 1` in the `CUSTOM` folder. 

    ![](/img/edu/engineer/kit1/obj_classification_application_04.png)
...
4. Create a `Db` folder to store training files.  
    ...
    ![](/img/edu/engineer/kit1/obj_classification_application_05.png)

5. Copy `Smart_OC.txt` and `Smart_OC.pb` files from `!R+Smart` and then paste them into the `Db` folder.   

    ![](/img/edu/engineer/kit1/obj_classification_application_06.png)
...
7. Click `User` tab.
    ...
    ![](/img/edu/engineer/kit1/obj_classification_test_01.png)

8. Click a configuration icon of a folder `Project 1`.    

    ![](/img/edu/engineer/kit1/obj_classification_test_02.png)

9. Select `Object Classifier` at `Vision` section.

    ![](/img/edu/engineer/kit1/obj_classification_test_03.png)

10. To test object detection, select your custom object in the list.

    ![](/img/edu/engineer/kit1/obj_classification_test_04.png)

11. Detect objects in real time.  

    ![](/img/edu/engineer/kit1/obj_classification_test_05.png)   
...
![](/img/edu/engineer/kit1/engineer_edu_metarials.png)
...
5. Click the `Check for Updates` button to install the latest updates.  
  ![](/img/edu/engineer/kit1/BLE_signal_power_02.png)  

6. Go to `ALL PRODUCTS` tab or use shortcut key(`Ctrl` + `A`).  
  ![](/img/edu/engineer/kit1/BLE_signal_power_04.png)

7. Select `CM-550` from the product list.  
  ![](/img/edu/engineer/kit1/BLE_signal_power_05.png)

8.  Click `Update & Test` button.  
  ![](/img/edu/engineer/kit1/BLE_signal_power_06.png)

9. Click `Next` button.  
  ![](/img/edu/engineer/kit1/BLE_signal_power_07.png)

10. Select the port where the controller is connected to.  
  ![](/img/edu/engineer/kit1/BLE_signal_power_08.png)

11. Confirm the Baudrate (The default baudrate is fixed to 57600 bps).  
  ![](/img/edu/engineer/kit1/BLE_signal_power_09.png)

12. Once CM-550 controller is detected, click `Next`.  
  ![](/img/edu/engineer/kit1/BLE_signal_power_10.png)
...
16. Select the `BLE Signal Power` on the right section of the control table and click `Save` button.  
  The bigger value will increase the signal strength.  
    ...
    ![](/img/edu/engineer/kit1/BLE_signal_power_14.png)
...
17. Confirm the changed `BLE Signal Power` value.  
  ![](/img/edu/engineer/kit1/BLE_signal_power_15.png)
...
5. The battery has separate connectors for the charger and the robot. Please disconnect the `Robot Connector` from the robot when charging the battery.  
  ![](/img/edu/engineer/kit1/battery_charging_5.png)


## Battery Level Check
![](/img/edu/engineer/kit1/battery_check.png)
...
![](/img/edu/engineer/kit1/charger_fuse_1.png)

![](/img/edu/engineer/kit1/charger_fuse_2.png)



[See the more detail of CM-550 e-Manual]: /docs/parts/controller/cm-550
[2XL430-W250 eManual]: /docs/dxl/x/2xl430-w250
...
[How to Connect CM-550 Controller to PC]: https://emanual.robotis.com/docs/en/popup/engineer/connect_controller_pc/
[How to Download Task Example via PC]: https://emanual.robotis.com/docs/en/popup/engineer/task_download_pc/
[How to Download Motion Example via PC]: https://emanual.robotis.com/docs/en/popup/engineer/motion_download_pc/
[How to Connect CM-550 Controller to Mobile]: https://emanual.robotis.com/docs/en/popup/engineer/connect_controller_mobile/
[How to Download Task Example via Mobile]: https://emanual.robotis.com/docs/en/popup/engineer/task_download_mobile/
[How to Download Motion Example via Mobile]: https://emanual.robotis.com/docs/en/popup/engineer/motion_download_mobile/
[ENGINEER App Installation]: https://emanual.robotis.com/docs/en/popup/engineer/engineer_app_installation/
