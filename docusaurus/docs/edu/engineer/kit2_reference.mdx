...
3. Select Robotis_Rpi_XXXX in the network list.
    ...
    ![](/img/edu/engineer/kit2/kit2_wifi_01.png)
...
4. Enter `robotis0` to connect, when password input window appears.
    ...
    ![](/img/edu/engineer/kit2/kit2_wifi_02.png)
...
3. Open the File Explore (Windows 10 Short Key: `Win` + `E`) from your PC.
    ...
    ![img Update Needed](/img/edu/engineer/kit2/sbc_update/file_explore_01.png)

4. Type **\\\raspberrypi.local**, and `robotis` folder appears.

    ![img Update Needed](/img/edu/engineer/kit2/sbc_update/file_explore_02.png)

5. Access to the `robotis` folder, and drop the downloaded `dxl.rts` file to the folder.

    ![](/img/edu/engineer/kit2/sbc_update/copy_rts.png)

    ![](/img/edu/engineer/kit2/sbc_update/copy_rts_02.png)
...
7. Click **Write** and wait for the write to complete.
    ...
    ![](/img/edu/engineer/kit2/wait_write_complete.png)
