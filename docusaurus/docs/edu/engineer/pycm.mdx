...
- direction : const.V or const.H   
  ...
  ![cm550_const_v](/img/edu/engineer/kit2/pycm_api/cm550_const_v.png)
  > const.V (vertical)
    

  ![cm550_const_h](/img/edu/engineer/kit2/pycm_api/cm550_const_h.png)
  > const.H (horizontal)
...
- acceleration value of range -32768 ~ 32767 (unit: 0.001G)  
  ![cm550_accel_range](/img/edu/engineer/kit2/pycm_api/cm550_accel_range.png)
...
- Gyro value of range -32768 ~ 32767 (unit: 0.01&deg;/s)  
  ![cm550_image_gyro_range](/img/edu/engineer/kit2/pycm_api/cm550_image_gyro_range.png)
...
- roll value of range -18000 ~ 18000 (unit: 0.01&deg;)  
  ![cm550_rpy_roll_range](/img/edu/engineer/kit2/pycm_api/cm550_rpy_roll_range.png)
...
[OLLO_JOINT_POSITION]: /docs/parts/motor/servo_motor
[OLLO_JOINT_SPEED]: /docs/parts/motor/servo_motor
[OLLO_IR]: /docs/parts/sensor/irss-10
...
[OLLO_DMS]: /docs/parts/sensor/dms-80
[OLLO_TOUCH]: /docs/parts/sensor/ts-10
[OLLO_LED]: /docs/parts/display/lm-10
[OLLO_USER]: /docs/edu/bioloid/gp#make-your-own-sensor
