...
## Other Controllers
ROBOTIS provides a range of [Educational Kits](/docs/edu) and [DYNAMIXEL System](https://emanual.robotis.com/docs/en/platform/) that accompany a dedicated controller.
...
### R+ Software Suite
The R+ (Roboplus) Software suite is ROBOTIS' first party robot controller software offering. R+ is offered in a variety of forms to enable users to start the programming style they feel most comfortable with. See provided [R+ Software](https://emanual.robotis.com/docs/en/software/#roboplus-r).
