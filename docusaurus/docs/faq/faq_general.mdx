...
# [Task Rule Check](/docs/software/rplus1/task/task_misc#rule-check)
...
**R+ 2.0**
  ...
  - [R+ Design 2.0](/docs/software/rplus2/design)
...
- See [Error Messages](/docs/software/rplus1/task/task_misc#error-messages).

# What shall I do if the rule check error shows up while I am writing RoboPlus Task code?
- See [Rule Check](/docs/software/rplus1/task/task_misc#rule-check).
...
[Change System Preferences]: https://emanual.robotis.com/docs/en/popup/general/change_system_preference_osx/
