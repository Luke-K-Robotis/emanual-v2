...
# Introduction
![](/img/parts/communication/bt-410_dongle_product.webp)
...
1. Connect the BT-410 dongle to PC and check assigned port number from the Device Manager. Then connect using the Tera Term terminal program through the respective COM port.
    ...
    ![](/img/parts/communication/bt-410_dongle_02.webp)
    ...
    ![](/img/parts/communication/bt-410_dongle_03.webp)

2. Select assigned COM port for BT-410 dongle.

    ![](/img/parts/communication/bt-410_dongle_04.webp)

3. Go to Setup > Serial port.

    ![](/img/parts/communication/bt-410_dongle_05.webp)

4. Set the Baud rate to 57600.

    ![](/img/parts/communication/bt-410_dongle_06.webp)

5. Go to Setup > Terminal.

    ![](/img/parts/communication/bt-410_dongle_07.webp)

6. Enable Local echo.

    ![](/img/parts/communication/bt-410_dongle_08.webp)
...
4. Disable Auto Pairing  
  Enter "AT+BTAUTOPAIR=0"
    ...
    ![](/img/parts/communication/bt-410_dongle_13.webp)

    A few seconds later, below message will be displayed.

    ![](/img/parts/communication/bt-410_dongle_14.webp)

5. Enable Auto Pairing  
  Enter "AT+BTAUTOPAIR=1"

    ![](/img/parts/communication/bt-410_dongle_15.webp)

    A few seconds later, below message will be displayed.

    ![](/img/parts/communication/bt-410_dongle_16.webp)
...
1. Connect **BT-410 Dongle** to the **USB Port** of PC.
    ...
    ![](/img/parts/communication/bt-410_17.webp)
