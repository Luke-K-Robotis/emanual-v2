...
- Recover controller firmware with [RoboPlus Manager] (v1.0.30.0 or higher) or [RoboPlus Manager 2.0](https://emanual.robotis.com/docs/en/software/rplus2/manager/)
...
[RoboPlus Manager 2.0]: https://emanual.robotis.com/docs/en/software/rplus2/manager/
