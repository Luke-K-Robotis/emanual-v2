...
## Using DYNAMIXEL-X
To use ROBOTIS [software](https://emanual.robotis.com/docs/en/software/#roboplus-r) (R+ Task, R+ Motion 및 R+ Manager) with [DYNAMIXEL-X](https://emanual.robotis.com/docs/en/dxl/x/#x-series) series, [Configuring DYNAMIXEL Channle](#configuring-dynamixel-channel) is required.
...
[How to install ROBOTIS virtual COM port for Windows]: https://emanual.robotis.com/docs/en/popup/usb_driver_install/
