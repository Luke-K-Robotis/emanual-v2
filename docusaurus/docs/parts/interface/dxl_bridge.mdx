...
- For more detailes about Instruction Packet, see [DYNAMIXEL Protocol 1.0](https://emanual.robotis.com/docs/en/dxl/protocol1/#instruction-packet) or [Protocol 2.0](https://emanual.robotis.com/docs/en/dxl/protocol2/#instruction-packet) depending on what DYNAMIXEL is in use. 
