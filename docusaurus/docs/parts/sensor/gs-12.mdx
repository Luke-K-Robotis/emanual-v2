...
![](/img/parts/sensors/gs-12_product.webp)

> Gyro Sensor(GS-12)

![](/img/parts/sensors/gyro_new.webp)
...
# Pinout
![](/img/parts/sensors/gs-12_pinout.webp)
...
- You can READ the value using the [User’s Device Parameter] in RoboPlus Task.
  ...
  ![](/img/parts/sensors/gs-12_01.webp)
...
- You may sample it out like below. It reads 10 values per 0.1 sec and makes an average. This value can be used as the standard value.
  ...
  ![](/img/parts/sensors/gs-12_02.webp)
...
[User’s Device Parameter]: https://emanual.robotis.com/docs/en/software/rplus1/task/programming_02#user-devices/
