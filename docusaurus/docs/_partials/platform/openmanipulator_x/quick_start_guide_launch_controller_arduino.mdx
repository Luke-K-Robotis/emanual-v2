...
<img src="/img/platform/openmanipulator_x/open_manipulator_start_pose.webp" width="250" />
...
1. Connect OpenCR to PC with a micro USB cable, and connect OpenMANIPULATOR-X to OpenCR, then supply 12V Power to OpenCR as shown below.  
  ...
  ![](/img/platform/openmanipulator_x/OpenManipulator_opencr_setup2.webp)
...
4. Open the downloaded processing file in Processing IDE : `open_manipulator_processing` > `Chain` > `Chain.pde`.  
  ![](/img/platform/openmanipulator_x/processing_open1.webp)  
  ![](/img/platform/openmanipulator_x/processing_open2.webp)  
  ![](/img/platform/openmanipulator_x/processing_run.webp)

5. Run the processing source code, and the following graphical GUI will be displayed.

    ![](/img/platform/openmanipulator_x/OpenManipulator_chain_processing_2.webp)
