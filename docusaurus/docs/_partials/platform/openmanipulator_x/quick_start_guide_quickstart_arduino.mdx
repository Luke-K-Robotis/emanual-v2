...
4. Upload the example to OpenCR.  
  ![](/img/platform/openmanipulator_x/upload_chain_example.webp)
...
2. Launch Processing and go to `Tools` > `Add Tool..`.
    ...
    ![](/img/platform/openmanipulator_x/processing_add_tools.webp)

3. In the `Libraries` tab, search for `ControlP5` and install it.

    ![](/img/platform/openmanipulator_x/OpenManipulator_chain_processing_1.webp)
