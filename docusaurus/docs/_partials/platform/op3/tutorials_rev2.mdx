...
1. execution result screen  
    ...
    ![](/img/platform/op3/op3_manager_01.webp)  
...
2. execution result of ROBOTIS-OP3(Init pose in RVIZ)  
    ...
    ![](/img/platform/op3/op3_manager_02.webp)
...
- rviz screen  
  ...
  ![](/img/platform/op3/op3_bringup_visualization_01.webp)  

  - TF Tree  

    ![](/img/platform/op3/op3_bringup_visualization_04.webp)  
...
![](/img/platform/op3/op3_gui_diagram.webp)  
...
![](/img/platform/op3/op3_gui_initial_pose.webp)
...
- Follow the below procedure to configure modules that control corresponding joint of ROBOTIS-OP3.  
    ...
    2. Confirm from the joint status table below the module buttons that corresponding joints are set correctly.  
      ![](/img/platform/op3/op3_gui_set_module.webp)

- `Get Mode` button will report which module is assigned for each joint.  

  ![](/img/platform/op3/op3_gui_get_module.webp)
...
![](/img/platform/op3/op3_gui_walking_tuner_01.webp)

![](/img/platform/op3/op3_gui_walking_tuner_02.webp)

##### Start / Stop Walking
1. `start` button : Initiate walking  
2. `stop` button : Stop walking. When stopped, walking related parameters will be reset.  

  ![](/img/platform/op3/op3_gui_walking_tuner_03.webp)
...
3. `Apply` button : Apply modified parameters from the GUI to `walking_module`.  
  ...
  ![](/img/platform/op3/op3_gui_walking_tuner_04.webp)
...
2. Select `Motion` tab of the gui demo program.
    ...
    ![](/img/platform/op3/op3_gui_action_01.webp)

3. Click the action button to play  

    ![](/img/platform/op3/op3_gui_action_02.webp)
...
2. Select `Head Control` tab of the gui demo program.  
  ![](/img/platform/op3/op3_gui_control_head_01.webp)
...
3. Change the value for the specific joint.  
  ...
  ![](/img/platform/op3/op3_gui_control_head_02.webp)  
  ![](/img/platform/op3/op3_gui_control_head_03.webp)  
...
- Preparation : Set the module and move to the tab
  ...
  2. Select `Online Walking` tab of the gui demo program.
    ...
    ![](/img/platform/op3/op3_online_walking_01.webp)
...
- Controlling walking of ROBOTIS-OP3
  ...
  4. Send a walking command to `op3_manager`
    ...
    ![](/img/platform/op3/op3_online_walking_02.webp)
...
![](/img/platform/op3/op3_offset_tuner_diagram.webp)  
...
![](/img/platform/op3/op3_offset_tuner_diagram.webp)  
- After   
![](/img/platform/op3/op3_tuner_diagram.webp)  
...
!<a href="/img/platform/op3/op3_tuner_execution.webp" target="_blank">launch image</a>
...
![](/img/platform/op3/op3_tuner_offset_01.webp)  
1. go `Initial Pose`   
...
![](/img/platform/op3/op3_tuner_gain_01.webp)  
1. go `Initial Pose`   
2. Select tab of `Kinematics Group`  
3. Click the `Refresh` Button for getting current states of joints  
...
![](/img/platform/op3/thormang3_action_editor_tui.webp)
...
![](/img/platform/op3/thormang3_action_editor_tui_command_list.webp)
...
2. Find the page where the "walking_init page" is by typing "list"  
    ...
    ![](/img/platform/op3/thormang3_action_editor_tui_action_editing_example1.webp)

3. Exit the list and go to any blank page by typing "page [x]"(for example, page 15).

    ![](/img/platform/op3/thormang3_action_editor_tui_action_editing_example2.webp)

4. And copy the page 1 to page [x].  

    ![](/img/platform/op3/thormang3_action_editor_tui_action_editing_example3.webp)

5. Go to "walking_init" pose by typing "play"  
6. Turn off the torque of ID 2, 4 and 8 by typing "off 2 4 8"  

    ![](/img/platform/op3/thormang3_action_editor_tui_action_editing_example4.webp)

7. After getting the desired pose turn torque on again by simple typing on. And insert the pose to step 1 by typing "i 1"  

    ![](/img/platform/op3/thormang3_action_editor_tui_action_editing_example5.webp)

8. Edit "Pause Time", "Time" of STP1 and "Page Step" as shown below.  

    ![](/img/platform/op3/thormang3_action_editor_tui_action_editing_example6.webp)
...
3. Description  
    ...
    - How to calibrate  
        ...
        - If you check the `use_second_filter` you can get an image which is detected with two HSV variations.   
          ...
          ![](/img/platform/op3/ball_detector_node_04.webp)

        - If you check the `debug_image` you can check the HSV filtered, binary image.   

          ![](/img/platform/op3/ball_detector_node_05.webp)
...
3. Set the walking parameters     
    ...
    ![](/img/platform/op3/op3_online_walking_footstep_01.webp)

4. Set a interactive marker in rviz 3d screen and Move the marker to the target pose of feet.   

    ![](/img/platform/op3/op3_online_walking_footstep_02.webp)

    ![](/img/platform/op3/op3_online_walking_footstep_04.webp)

5. plan the path and send a walking message to ROBOTIS-OP3     

    ![](/img/platform/op3/op3_online_walking_footstep_03.webp)

    ![](/img/platform/op3/op3_online_walking_footstep_05.webp)
...
![](/img/platform/op3/op3_web_setting_01.webp)
...
##### Ball Detector parameters
  ![](/img/platform/op3/op3_web_setting_02.webp)
...
##### Camera Setting parameters
  ![](/img/platform/op3/op3_web_setting_06.webp)
  > Modified parameter values will be saved automatically.  
...
![](/img/platform/op3/op3_manager_03.webp)  
...
```  
 ...
 - rqt_graph  
   ![](/img/platform/op3/op3_read_write_graph.webp)
