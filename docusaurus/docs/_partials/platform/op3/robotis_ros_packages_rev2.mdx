...
- Walking parameters
 ...
 - YAML format
   - x_offset: offset in the x-direction (front and back) [m]  
     ...
     ![](/img/platform/op3/op3_walking_module_image142.webp)

   - y_offset: offset in the y-direction (left and right) [m]  

     ![](/img/platform/op3/op3_walking_module_image143.webp)

   - z_offset: offset in the z-direction (up and down) [m]  

     ![](/img/platform/op3/op3_walking_module_image144.webp)

   - roll_offset: roll offset (x-coordinate) [degree]  

     ![](/img/platform/op3/op3_walking_module_image145.webp)

   - pitch_offset: pitch offset (y-coordinate) [degree]  

     ![](/img/platform/op3/op3_walking_module_image146.webp)
   ...
   - pelvis_offset: roll offset (x-coordinate) at the pelvis level. Values are for DYNAMIXEL position values for hip roll joints [degree]  
     ...
     ![](/img/platform/op3/op3_walking_module_image155.webp)
...
![](/img/platform/op3/op3_urdf_rviz.webp)
...
![](/img/platform/op3/op3_walk_tuner.webp)
