...
![](/img/icon_unfold.png) **Click here to expand more details about How to install ROS 2.**
</summary>
...
2. Copy the CLI commands located in the green box and paste into your terminal with `ctrl` + `shift` + `v`  
  ![](/img/platform/turtlebot3/quick_start/quick_start/ros2_install1-.png)    
  
3. Generally, ros-jazzy-desktop is recommended for the `Remote PC`  
  ![](/img/platform/turtlebot3/quick_start/quick_start/ros2_install2-.png)  
