...
![](/img/platform/turtlebot3/manipulation/open_manipulator_gazebo_1.png)
...
<details>
<summary>
![](/img/icon_unfold.png) Click here to expand more details about the firmware upload using **Arduino IDE**
</summary>
