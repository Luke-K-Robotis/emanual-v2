...
```
![](/img/platform/turtlebot3/simulation/turtlebot3_empty_world_sim.png)
...
```
![](/img/platform/turtlebot3/simulation/turtlebot3_world_sim.png)
...
```
![](/img/platform/turtlebot3/simulation/turtlebot3_house_sim.png)
