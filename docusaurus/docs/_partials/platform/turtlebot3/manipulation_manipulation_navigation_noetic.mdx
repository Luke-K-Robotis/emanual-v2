Be sure to read [Navigation](/docs/platform/turtlebot3/navigation#navigation) manual before use of the following instruction.
...
![](/img/platform/turtlebot3/manipulation/tb3_omx_nav.webp)
