...
1. Empty World  
![](/img/platform/turtlebot3/simulation/turtlebot3_empty_world.webp)  
**[Remote PC]**  
```bash
...
2. TurtleBot3 World  
![](/img/platform/turtlebot3/simulation/turtlebot3_world_bugger.webp)  
**[Remote PC]**  
```bash
...
3. TurtleBot3 House  
![](/img/platform/turtlebot3/simulation/turtlebot3_house.webp)  
**[Remote PC]**  
```bash
