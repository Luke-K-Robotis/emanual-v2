...
1. Click the `2D Pose Estimate` button in the RViz menu.  
  ![](/img/platform/turtlebot3/navigation/2d_pose_button.webp)
...
![](/img/platform/turtlebot3/navigation/tb3_amcl_particle_01.webp)
![](/img/platform/turtlebot3/navigation/tb3_amcl_particle_02.webp)
6. Terminate the keyboard teleoperation node by entering `Ctrl` + `C` to the teleop node terminal in order to prevent different **cmd_vel** values are published from multiple nodes during Navigation.


### Set Navigation Goal
1. Click the `2D Nav Goal` button in the RViz menu.    
  ![](/img/platform/turtlebot3/navigation/2d_nav_goal_button.webp)
2. Click on the map to set the destination of the robot and drag the green arrow toward the direction where the robot will be facing. 
  ...
  ![](/img/platform/turtlebot3/navigation/2d_nav_goal.webp)
