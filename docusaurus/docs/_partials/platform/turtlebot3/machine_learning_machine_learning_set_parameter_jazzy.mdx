...
| ![](/img/platform/turtlebot3/machine_learning/sample_360.png) | ![](/img/platform/turtlebot3/machine_learning/sample_24.png) |
|:-----------------------------------------------------------------------:|:----------------------------------------------------------------------:|
...
yaw_reward = 1 - (2 * abs(self.goal_angle) / math.pi)
```  
<img src="/img/platform/turtlebot3/machine_learning/yaw_reward.png" width="700" />
