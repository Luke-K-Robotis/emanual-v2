...
**Note** : When using a U2D2 [reduce the response latency of the USB port](https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_wizard2/#graph-optimization) to ensure stable communication at higher Baud rates.
