...
PWM Control Mode is similar to the Wheel Mode of [AX](https://emanual.robotis.com/docs/en/dxl/ax/ax-12w/#cw-compliance-margin) and [RX](https://emanual.robotis.com/docs/en/dxl/rx/rx-10/#moving-speed-32) series.
