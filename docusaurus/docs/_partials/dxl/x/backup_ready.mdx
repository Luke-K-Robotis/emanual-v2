The value in this address indicates whether a saved backup of the control table exists in the actuator's memory. For more information see [Control Table Backup Packet](https://emanual.robotis.com/docs/en/dxl/protocol2/#control-table-backup-0x20).
