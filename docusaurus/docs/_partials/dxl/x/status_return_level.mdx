...
**NOTE** : If the [Instruction Packet ID](https://emanual.robotis.com/docs/en/dxl/protocol2/) is set to the [Broadcast ID(0xFE)](https://emanual.robotis.com/docs/en/dxl/protocol2/#packet-id), a Status Packet will not be returned for READ or WRITE Instructions regardless of Status Return Level (68). For more details, please refer to the `Status Packet` section of the [DYNAMIXEL Protocol 2.0] page.
