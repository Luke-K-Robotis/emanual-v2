...
### Arduino IDE Setup
**NOTE**: This page only explain the setup process of OpenCR of the linux envirnment. If you want to use OpenCR in windows or mac environments, please refer to [Arduino IDE for using OpenCR](https://emanual.robotis.com/docs/en/parts/controller/opencr10/#arduino-ide).
...
**NOTE**: Please refer to [Arduino IDE for using OpenCR(linux)](https://emanual.robotis.com/docs/en/parts/controller/opencr10/#install-on-linux) for detailed setting method.
