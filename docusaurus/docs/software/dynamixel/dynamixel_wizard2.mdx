...
3. Select Protocol Type and instruction to use. In this example, `Write` instruction for Protocol Type `2.0` is selected.
    ...
    **NOTE** : Protocol Type can be different depending on a model of DYNAMIXEL. Confirm [Protocol Type](https://emanual.robotis.com/docs/en/popup/faq_protocol_compatibility_table/) of your DYNAMIXEL.
...
**Supported DYNAMIXEL**
- [DYNAMIXEL-X](https://emanual.robotis.com/docs/en/dxl/x/) (Firmware **v45** or **above**, For X330 Series: Firmware **v46** or **above**) 
- [DYNAMIXEL-P](https://emanual.robotis.com/docs/en/dxl/p/) (Firmware **v12** or **above**)
...
1. Go to `Tool` > `Calibration`
    ...
    **NOTE**: `Calibration` itme will be disabled at the menu for non-supported DYNAMIXEL such as [AX Series](https://emanual.robotis.com/docs/en/dxl/#ax-series)
...
1. Go to `Tool` > `Self-Diagnosis`
    ...
    **NOTE** : `Self-Diagnosis` item will be disabled at the menu for non-suppored DYNAMIXEL such as [RX Series](https://emanual.robotis.com/docs/en/dxl/#rx-series)
