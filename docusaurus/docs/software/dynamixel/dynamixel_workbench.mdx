...
- [Porting the OpenCR1.0 board to the Arduino IDE](https://emanual.robotis.com/docs/en/parts/controller/opencr10/#porting-to-arduino-idelinux)
...
- [Porting the OpenCM9.04 board to the Arduino IDE](https://emanual.robotis.com/docs/en/parts/controller/opencm904/#porting-the-opencm904-board-to-the-arduino-ide)
...
[How to Setup](https://emanual.robotis.com/docs/en/parts/interface/u2d2/)
...
**TIP**: Please follow a [link](https://emanual.robotis.com/docs/en/parts/controller/opencm485exp/) for getting more information about pin
...
-`Torque Enable`, which is the data of [Control Table](https://emanual.robotis.com/docs/en/faq/faq_dynamixel/) of DYNAMIXEL, is not supposed to be set by users, but it's enabled by itself during initialization.  
...
[dynamixel_workbench_msgs/DynamixelInfo]: https://emanual.robotis.com/docs/en/popup/dynamixel_workbench_msgs_DynamixelInfo/
[dynamixel_workbench_msgs/DynamixelCommand]: https://emanual.robotis.com/docs/en/popup/dynamixel_workbench_msgs_DynamixelCommand/
[dynamixel_workbench_msgs/DynamixelStateList]: https://emanual.robotis.com/docs/en/popup/dynamixel_workbench_msgs_DynamixelStateList/
...
[How to set Industrial filter into joint trajectory]: https://emanual.robotis.com/docs/en/popup/how_to_set_smoothing_filter/
