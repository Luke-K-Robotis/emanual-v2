...
1. [Install Dynamixel Wizard 2.0](https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_wizard2/#software-installation)
2. [Scan the motor and Operate it](https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_wizard2/#basic-features)
3. [Check and set the motor ID](https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_wizard2/#id-inspection)
4. [If the firmware is outdated, update it.](https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_wizard2/#firmware-update)
