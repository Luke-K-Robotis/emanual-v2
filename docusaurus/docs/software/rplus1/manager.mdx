...
![](/img/software/rplus1/manager/roboplus_manager_001.webp)
...
![](/img/software/rplus1/manager/roboplus_manager_005.webp)
...
1. When the controller is connected, the controller's firmware version will be retrieved. If a newer firmware is available, it will ask whether to download the latest firmware.
    ...
    ![](/img/software/rplus1/manager/roboplus_manager_006.webp)

2. When the 'OK' button is pressed, it will begin updating the firmware.

    ![](/img/software/rplus1/manager/roboplus_manager_007.webp)

3. You can check your controller's model number and firmware version.

    ![](/img/software/rplus1/manager/roboplus_manager_008.webp)
...
4. Press the "Next" button to begin updating your firmware. Be careful not to turn the power off or disconnect the cable while the firmware is being updated.
    ...
    ![](/img/software/rplus1/manager/roboplus_manager_009.webp)

5. Once the firmware has been updated, Press the "Finish" button to return to the controller maintenance page.

    ![](/img/software/rplus1/manager/roboplus_manager_010.webp)
...
![](/img/software/rplus1/manager/roboplus_manager_017.webp)
...
![](/img/software/rplus1/manager/roboplus_manager_018.webp)
...
![](/img/software/rplus1/manager/roboplus_manager_019.webp)
...
![](/img/software/rplus1/manager/roboplus_manager_020.webp)
...
![](/img/software/rplus1/manager/roboplus_manager_021.webp)
...
![](/img/software/rplus1/manager/roboplus_manager_022.webp)
...
![](/img/software/rplus1/manager/roboplus_manager_023.webp)
...
1. Attach Zig-100 to Zig2Serial and connect Zig2Serial to the PC's serial port.(Please refer to [ZIG2Serial] for connection)  
    ...
    ![](/img/software/rplus1/manager/roboplus_manager_024.webp)
...
5. When the Zigbee module is connected, a window to set functions is displayed.
  ...
  - Can set to "Wait" mode.
    ...
    ![](/img/software/rplus1/manager/roboplus_manager_028.webp)

6. If no ZIg100 module is detected, check whether the module has been connected properly.

    ![](/img/software/rplus1/manager/roboplus_manager_029.webp)
