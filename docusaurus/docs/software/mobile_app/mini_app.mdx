...
![](/img/software/mobile/mini_app_001.webp)
...
![](/img/software/mobile/mini_app_002.webp)
...
![](/img/software/mobile/mini_app_003.webp)

![](/img/software/mobile/mini_app_004.webp)
...
![](/img/software/mobile/mini_app_005.webp)
...
![](/img/software/mobile/mini_app_008.webp)
...
![](/img/software/mobile/mini_app_010.webp)
...
![](/img/software/mobile/mini_app_013.webp)
![](/img/software/mobile/mini_app_014.webp)
...
- More information on Key-Frame, Motion Unit and Motion is available at [Motion Data](https://emanual.robotis.com/docs/en/software/rplus2/motion/#motion-data)
...
- Edit Button Row
  ...
  - Add a button row : Press the `Add Button` button in the `Edit` tab to add a new line at the top row.
    ...
    ![](/img/software/mobile/mini_app_015.webp)
    ![](/img/software/mobile/mini_app_016.webp)
    ![](/img/software/mobile/mini_app_017.webp)

  - Change button row order : Touch the right side of the row then drag up or down to move the row.

    ![](/img/software/mobile/mini_app_018.webp)
    ![](/img/software/mobile/mini_app_019.webp)
    ![](/img/software/mobile/mini_app_020.webp)

  - Delete button row : Touch the right side of the row then slide to the left to delete the row.

    ![](/img/software/mobile/mini_app_021.webp)
    ![](/img/software/mobile/mini_app_022.webp)
    ![](/img/software/mobile/mini_app_023.webp)

- Edit Button

  - Edit Button : Touch `+` to add a new button. Touch other existing command buttons to edit.

    ![](/img/software/mobile/mini_app_024.webp)
    ![](/img/software/mobile/mini_app_025.webp)
    ![](/img/software/mobile/mini_app_026.webp)
...
- Use the motion file setting to input motion call numbers  
  ...
  ![](/img/software/mobile/mini_app_027.webp)
  ![](/img/software/mobile/mini_app_028.webp)
  ![](/img/software/mobile/mini_app_029.webp)
...
- Move the robot by holding your smart device and making a gesture.
  ...
  ![](/img/software/mobile/mini_app_030.webp)
...
- While touching the center of the screen, tilt the smart device to operate the robot.
  ...
  ![](/img/software/mobile/mini_app_031.webp)
  ![](/img/software/mobile/mini_app_032.webp)
...
- Register Gestures
  ...
  ![](/img/software/mobile/mini_app_033.webp)
  ![](/img/software/mobile/mini_app_034.webp)
  ![](/img/software/mobile/mini_app_035.webp)
  ...
  ![](/img/software/mobile/mini_app_036.webp)
  ![](/img/software/mobile/mini_app_037.webp)
...
- Edit Slope
  ...
  ![](/img/software/mobile/mini_app_038.webp)
  ![](/img/software/mobile/mini_app_039.webp)
  ![](/img/software/mobile/mini_app_040.webp)

  The pre-defined directions are defined by the smart device in the right hand as shown below.
  

  ![](/img/software/mobile/mini_app_041.webp)
...
![](/img/software/mobile/mini_app_042.webp)
![](/img/software/mobile/mini_app_043.webp)
![](/img/software/mobile/mini_app_044.webp)
...
- Add Voice Command
  ...
  ![](/img/software/mobile/mini_app_045.webp)
  ![](/img/software/mobile/mini_app_046.webp)
  ![](/img/software/mobile/mini_app_047.webp)
...
- Voice Recognition Training Function?
  ...
  ![](/img/software/mobile/mini_app_048.webp)
  ![](/img/software/mobile/mini_app_049.webp)
  ![](/img/software/mobile/mini_app_050.webp)
...
![](/img/software/mobile/mini_app_051.webp)
...
![](/img/software/mobile/mini_app_052_en.webp)

- Soccer Mode
  - 2 available modes : Defense and Offense

  ![](/img/software/mobile/mini_app_053_en.webp)
...
![](/img/software/mobile/mini_app_060.webp)
...
- Server/Client Setting
  ...
  - If set correctly, the Server smart device will show the message ‘Test’ when the Client performs the test.
    ...
    ![](/img/software/mobile/mini_app_061.webp)
    ![](/img/software/mobile/mini_app_062.webp)
  ...
  - Go into the following setting menu in your smart device; System – Wireless & networks – Tethering & portable hotspot – and check ‘Portable Wi-Fi hotspot’.
    ...
    ![](/img/software/mobile/mini_app_064.webp)
    ![](/img/software/mobile/mini_app_065.webp)

  - You can change the name of the smart device to be displayed on the other devices under the ‘Set up Wi-Fi hotspot’ setting.

    ![](/img/software/mobile/mini_app_066.webp)
    ![](/img/software/mobile/mini_app_067.webp)
...
![](/img/software/mobile/mini_app_068.webp)
![](/img/software/mobile/mini_app_069.webp)
![](/img/software/mobile/mini_app_070.webp)
![](/img/software/mobile/mini_app_071.webp)
...
![](/img/software/mobile/mini_app_072.webp)
![](/img/software/mobile/mini_app_073.webp)
![](/img/software/mobile/mini_app_074.webp)

Once a motion file is registered, the ‘list’ button will be shown on the ‘add command’ window. Select the ‘list’ button to show the list of motion pages in the motion file. Select one of the motion pages shown, then its motion name and motion page number will be automatically inputted on the screen.

![](/img/software/mobile/mini_app_075.webp)
![](/img/software/mobile/mini_app_076.webp)
![](/img/software/mobile/mini_app_077.webp)
...
![](/img/software/mobile/mini_app_078.webp)
![](/img/software/mobile/mini_app_079.webp)
![](/img/software/mobile/mini_app_080.webp)
![](/img/software/mobile/mini_app_081.webp)
...
![](/img/software/mobile/mini_app_082.webp)
![](/img/software/mobile/mini_app_083.webp)
...
![](/img/software/mobile/mini_app_084.webp)
![](/img/software/mobile/mini_app_085.webp)
![](/img/software/mobile/mini_app_086.webp)
...
- ROBOTIS-MINI Initial Position
  ...
  ![](/img/software/mobile/mini_app_087.webp)
  ![](/img/software/mobile/mini_app_088.webp)
  ![](/img/software/mobile/mini_app_089.webp)
...
![](/img/software/mobile/mini_app_090.webp)
![](/img/software/mobile/mini_app_091.webp)
![](/img/software/mobile/mini_app_092.webp)
...
![](/img/software/mobile/mini_app_093.webp)
![](/img/software/mobile/mini_app_094.webp)
