...
In order to use ROBOTIS MINI on ios (for iPhone/iPad), [BT-410](https://emanual.robotis.com/docs/en/parts/communication/bt-410/) is required for a bluetooth comunication between a smart device and the ROBOTIS MINI. 
