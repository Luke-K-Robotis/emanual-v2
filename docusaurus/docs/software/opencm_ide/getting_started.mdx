...
![](/img/software/opencm_ide/opencm_ide_001.webp)
...
![](/img/software/opencm_ide/opencm_ide_002.webp)
...
![](/img/software/opencm_ide/opencm_ide_003.webp)
...
![](/img/software/opencm_ide/opencm_ide_008.webp)
...
![](/img/software/opencm_ide/opencm_ide_015.webp)
...
![](/img/software/opencm_ide/opencm_ide_020.webp)

As in the figure below, select the Open button.

![](/img/software/opencm_ide/opencm_ide_021.webp)

The ROBOTIS OpenCM is executed as shown below.

![](/img/software/opencm_ide/opencm_ide_022.webp)

#### Open the Example Blink

Go to File → Examples → 01. Basics → b_Blink

![](/img/software/opencm_ide/opencm_ide_023.webp)

#### Select Board

Select ROBOTIS OpenCM9.04.

![](/img/software/opencm_ide/opencm_ide_024.webp)

#### Select Serial Port.

Select tty.usbmodemXXX. The number on the end is different for each PC.

![](/img/software/opencm_ide/opencm_ide_025.webp)

#### Proceed to Download

Click on the Download button as shown below. As the download begins the board’s green LED is continuously turned on. Once the download is complete the board resets and the Blink example is executed, and the LED blinks.

![](/img/software/opencm_ide/opencm_ide_026.webp)
...
![](/img/software/opencm_ide/opencm_ide_027.webp)

If you unzip the file it will create a ROBOTIS folder as shown below.

![](/img/software/opencm_ide/opencm_ide_028.webp)
...
![](/img/software/opencm_ide/opencm_ide_029.webp)
...
![](/img/software/opencm_ide/opencm_ide_031.webp)
...
![](/img/software/opencm_ide/opencm_ide_032.webp)

Click on the Execute button.

![](/img/software/opencm_ide/opencm_ide_033.webp)

Then the program will run as shown below.

![](/img/software/opencm_ide/opencm_ide_034.webp)

#### Open the Example Blink

Go to File → Examples → 01. Basics → b_Blink

![](/img/software/opencm_ide/opencm_ide_035.webp)

#### Select Board

In Tools → Board, select ROBOTIS OpenCM9.04.

![](/img/software/opencm_ide/opencm_ide_036.webp)
...
![](/img/software/opencm_ide/opencm_ide_037.webp)
...
![](/img/software/opencm_ide/opencm_ide_038.webp)
...
![](/img/software/opencm_ide/opencm_ide_039.webp)
...
| ![](/img/software/opencm_ide/opencm_ide_040.gif) | Executes only the compilation and prints a message on the status bar or console stating whether it was fail or success |
| ![](/img/software/opencm_ide/opencm_ide_041.gif) |  Executes compilation and proceeds to download right away. Make sure the board is connected when using this function   |
| ![](/img/software/opencm_ide/opencm_ide_042.gif) |                                                   Creates a new file                                                   |
| ![](/img/software/opencm_ide/opencm_ide_043.gif) |                                                      Opens a file                                                      |
| ![](/img/software/opencm_ide/opencm_ide_044.gif) |                                                 Saves the current file                                                 |
| ![](/img/software/opencm_ide/opencm_ide_045.gif) |                                                Runs the serial monitor                                                 |
...
![](/img/software/opencm_ide/opencm_ide_046.webp)
...
![](/img/software/opencm_ide/opencm_ide_047.webp)
...
![](/img/software/opencm_ide/opencm_ide_048.webp)
...
![](/img/software/opencm_ide/opencm_ide_049.webp)

Codes such as below are automatically organized neatly by pressing Ctrl+T.

![](/img/software/opencm_ide/opencm_ide_050.webp)
...
![](/img/software/opencm_ide/opencm_ide_051.webp)

![](/img/software/opencm_ide/opencm_ide_052.webp)

If you select a block as shown above and then press Ctrl+/ it will comment the entire block as shown below.

![](/img/software/opencm_ide/opencm_ide_053.webp)
...
![](/img/software/opencm_ide/opencm_ide_056.webp)
...
![](/img/software/opencm_ide/opencm_ide_059.webp)
...
![](/img/software/opencm_ide/opencm_ide_060.webp)
...
![](/img/software/opencm_ide/opencm_ide_061.webp)
...
![](/img/software/opencm_ide/opencm_ide_062.webp)

![](/img/software/opencm_ide/opencm_ide_063.webp)
...
![](/img/software/opencm_ide/opencm_ide_064.webp)

![](/img/software/opencm_ide/opencm_ide_065.webp)
...
1. Sketchbook location : This is the user’s default work directory. Sketch files will be saved and opened from this directory.
    ...
    ![](/img/software/opencm_ide/opencm_ide_066.webp)

2. Editor language: This changes the font of the program to a different language.

    ![](/img/software/opencm_ide/opencm_ide_067.webp)
...
![](/img/software/opencm_ide/opencm_ide_068.webp)

In the case of Mac, access the path below.
`Documents/ROBOTIS/libraries`

![](/img/software/opencm_ide/opencm_ide_069.webp)

![](/img/software/opencm_ide/opencm_ide_070.webp)
...
![](/img/software/opencm_ide/opencm_ide_071.webp)

![](/img/software/opencm_ide/opencm_ide_072.webp)
...
![](/img/software/opencm_ide/opencm_ide_073.webp)
...
![](/img/software/opencm_ide/opencm_ide_074.webp)
...
![](/img/software/opencm_ide/opencm_ide_075.webp)
...
![](/img/software/opencm_ide/opencm_ide_076.webp)
...
![](/img/software/opencm_ide/opencm_ide_077.webp)

Now we unplug the power and plug in again to check.

![](/img/software/opencm_ide/opencm_ide_078.webp)
...
![](/img/software/opencm_ide/opencm_ide_079.webp)
...
![](/img/software/opencm_ide/opencm_ide_080.webp)
...
2. Confirming Operation  
    ...
    ![](/img/software/opencm_ide/opencm_ide_081.webp)
...
3. Operation Code  
    ...
    ![](/img/software/opencm_ide/opencm_ide_082.webp)
    ...
    ![](/img/software/opencm_ide/opencm_ide_083.webp)
...
2. Confirming Operation  
    ...
    ![](/img/software/opencm_ide/opencm_ide_084.webp)
...
3. Operation Code  
    ...
    ![](/img/software/opencm_ide/opencm_ide_085.webp)
...
1. Connectivity and Sensor Internal Structure  
    ...
    ![](/img/software/opencm_ide/opencm_ide_086.webp)
...
2. Confirming Operation  
    ...
    ![](/img/software/opencm_ide/opencm_ide_089.webp)
...
2. Operation Code  
    ...
    ![](/img/software/opencm_ide/opencm_ide_090.webp)

    ![](/img/software/opencm_ide/opencm_ide_091.webp)
...
![](/img/software/opencm_ide/opencm_ide_092.webp)
...
![](/img/software/opencm_ide/opencm_ide_093.webp)
...
![](/img/software/opencm_ide/opencm_ide_094.webp)
...
![](/img/software/opencm_ide/opencm_ide_095.webp)
...
![](/img/software/opencm_ide/opencm_ide_096.webp)
...
![](/img/software/opencm_ide/opencm_ide_097.webp)
...
![](/img/software/opencm_ide/opencm_ide_098.webp)
...
![](/img/software/opencm_ide/opencm_ide_099.webp)
...
![](/img/software/opencm_ide/opencm_ide_100.webp)
...
![](/img/software/opencm_ide/opencm_ide_101.webp)
...
![](/img/software/opencm_ide/opencm_ide_102.webp)
...
![](/img/software/opencm_ide/opencm_ide_103.webp)
...
![](/img/software/opencm_ide/opencm_ide_104.webp)
...
![](/img/software/opencm_ide/opencm_ide_107.webp)
...
![](/img/software/opencm_ide/opencm_ide_108.webp)
...
![](/img/software/opencm_ide/opencm_ide_109.webp)
...
![](/img/software/opencm_ide/opencm_ide_110.webp)
...
![](/img/software/opencm_ide/opencm_ide_111.webp)
...
![](/img/software/opencm_ide/opencm_ide_112.webp)

![](/img/software/opencm_ide/opencm_ide_113.webp)
...
![](/img/software/opencm_ide/opencm_ide_114.webp)
...
![](/img/software/opencm_ide/opencm_ide_115.webp)
...
![](/img/software/opencm_ide/opencm_ide_116.webp)
...
![](/img/software/opencm_ide/opencm_ide_117.webp)
...
![](/img/software/opencm_ide/opencm_ide_118.webp)
...
![](/img/software/opencm_ide/opencm_ide_119.webp)
...
![](/img/software/opencm_ide/opencm_ide_120.webp)
...
![](/img/software/opencm_ide/opencm_ide_123.webp)
...
![](/img/software/opencm_ide/opencm_ide_124.webp)
...
![](/img/software/opencm_ide/opencm_ide_125.webp)
...
![](/img/software/opencm_ide/opencm_ide_126.webp)
...
![](/img/software/opencm_ide/opencm_ide_127.webp)
...
![](/img/software/opencm_ide/opencm_ide_128.webp)
...
![](/img/software/opencm_ide/opencm_ide_129.webp)
...
![](/img/software/opencm_ide/opencm_ide_132.webp)

![](/img/software/opencm_ide/opencm_ide_133.webp)
...
![](/img/software/opencm_ide/opencm_ide_134.webp)

![](/img/software/opencm_ide/opencm_ide_135.webp)
...
![](/img/software/opencm_ide/opencm_ide_136.webp)
...
![](/img/software/opencm_ide/opencm_ide_137.webp)

Once you select the examples the following codes appear.

![](/img/software/opencm_ide/opencm_ide_138.webp)
...
![](/img/software/opencm_ide/opencm_ide_139.webp)

![](/img/software/opencm_ide/opencm_ide_140.webp)

![](/img/software/opencm_ide/opencm_ide_141.webp)
