...
![](/img/software/opencm_ide/opencm_ide_001.png)
...
![](/img/software/opencm_ide/opencm_ide_002.png)
...
![](/img/software/opencm_ide/opencm_ide_003.png)
...
![](/img/software/opencm_ide/opencm_ide_008.png)
...
![](/img/software/opencm_ide/opencm_ide_015.png)
...
![](/img/software/opencm_ide/opencm_ide_020.png)

As in the figure below, select the Open button.

![](/img/software/opencm_ide/opencm_ide_021.png)

The ROBOTIS OpenCM is executed as shown below.

![](/img/software/opencm_ide/opencm_ide_022.png)

#### Open the Example Blink

Go to File → Examples → 01. Basics → b_Blink

![](/img/software/opencm_ide/opencm_ide_023.png)

#### Select Board

Select ROBOTIS OpenCM9.04.

![](/img/software/opencm_ide/opencm_ide_024.png)

#### Select Serial Port.

Select tty.usbmodemXXX. The number on the end is different for each PC.

![](/img/software/opencm_ide/opencm_ide_025.png)

#### Proceed to Download

Click on the Download button as shown below. As the download begins the board’s green LED is continuously turned on. Once the download is complete the board resets and the Blink example is executed, and the LED blinks.

![](/img/software/opencm_ide/opencm_ide_026.png)
...
![](/img/software/opencm_ide/opencm_ide_027.png)

If you unzip the file it will create a ROBOTIS folder as shown below.

![](/img/software/opencm_ide/opencm_ide_028.png)
...
![](/img/software/opencm_ide/opencm_ide_029.png)
...
![](/img/software/opencm_ide/opencm_ide_031.png)
...
![](/img/software/opencm_ide/opencm_ide_032.png)

Click on the Execute button.

![](/img/software/opencm_ide/opencm_ide_033.png)

Then the program will run as shown below.

![](/img/software/opencm_ide/opencm_ide_034.png)

#### Open the Example Blink

Go to File → Examples → 01. Basics → b_Blink

![](/img/software/opencm_ide/opencm_ide_035.png)

#### Select Board

In Tools → Board, select ROBOTIS OpenCM9.04.

![](/img/software/opencm_ide/opencm_ide_036.png)
...
![](/img/software/opencm_ide/opencm_ide_037.png)
...
![](/img/software/opencm_ide/opencm_ide_038.png)
...
![](/img/software/opencm_ide/opencm_ide_039.png)
...
![](/img/software/opencm_ide/opencm_ide_046.png)
...
![](/img/software/opencm_ide/opencm_ide_047.png)
...
![](/img/software/opencm_ide/opencm_ide_048.png)
...
![](/img/software/opencm_ide/opencm_ide_049.png)

Codes such as below are automatically organized neatly by pressing Ctrl+T.

![](/img/software/opencm_ide/opencm_ide_050.png)
...
![](/img/software/opencm_ide/opencm_ide_051.png)

![](/img/software/opencm_ide/opencm_ide_052.png)

If you select a block as shown above and then press Ctrl+/ it will comment the entire block as shown below.

![](/img/software/opencm_ide/opencm_ide_053.png)
...
![](/img/software/opencm_ide/opencm_ide_056.png)
...
![](/img/software/opencm_ide/opencm_ide_059.png)
...
![](/img/software/opencm_ide/opencm_ide_060.png)
...
![](/img/software/opencm_ide/opencm_ide_061.png)
...
![](/img/software/opencm_ide/opencm_ide_062.png)

![](/img/software/opencm_ide/opencm_ide_063.png)
...
![](/img/software/opencm_ide/opencm_ide_064.png)

![](/img/software/opencm_ide/opencm_ide_065.png)
...
1. Sketchbook location : This is the user’s default work directory. Sketch files will be saved and opened from this directory.
    ...
    ![](/img/software/opencm_ide/opencm_ide_066.png)

2. Editor language: This changes the font of the program to a different language.

    ![](/img/software/opencm_ide/opencm_ide_067.png)
...
![](/img/software/opencm_ide/opencm_ide_068.png)

In the case of Mac, access the path below.
`Documents/ROBOTIS/libraries`

![](/img/software/opencm_ide/opencm_ide_069.png)

![](/img/software/opencm_ide/opencm_ide_070.png)
...
![](/img/software/opencm_ide/opencm_ide_071.png)

![](/img/software/opencm_ide/opencm_ide_072.png)
...
![](/img/software/opencm_ide/opencm_ide_073.png)
...
![](/img/software/opencm_ide/opencm_ide_079.png)
...
2. Confirming Operation  
    ...
    ![](/img/software/opencm_ide/opencm_ide_081.png)
...
3. Operation Code  
    ...
    ![](/img/software/opencm_ide/opencm_ide_082.png)
    ...
    ![](/img/software/opencm_ide/opencm_ide_083.png)
...
3. Operation Code  
    ...
    ![](/img/software/opencm_ide/opencm_ide_085.png)
...
1. Connectivity and Sensor Internal Structure  
    ...
    ![](/img/software/opencm_ide/opencm_ide_086.png)
...
2. Operation Code  
    ...
    ![](/img/software/opencm_ide/opencm_ide_087.png)
...
2. Confirming Operation  
    ...
    ![](/img/software/opencm_ide/opencm_ide_089.png)
...
2. Operation Code  
    ...
    ![](/img/software/opencm_ide/opencm_ide_090.png)

    ![](/img/software/opencm_ide/opencm_ide_091.png)
...
![](/img/software/opencm_ide/opencm_ide_094.png)
...
![](/img/software/opencm_ide/opencm_ide_100.png)
...
![](/img/software/opencm_ide/opencm_ide_101.png)
...
![](/img/software/opencm_ide/opencm_ide_102.png)
...
![](/img/software/opencm_ide/opencm_ide_103.png)
...
![](/img/software/opencm_ide/opencm_ide_104.png)
...
![](/img/software/opencm_ide/opencm_ide_107.png)
...
![](/img/software/opencm_ide/opencm_ide_108.png)
...
![](/img/software/opencm_ide/opencm_ide_109.png)
...
![](/img/software/opencm_ide/opencm_ide_110.png)
...
![](/img/software/opencm_ide/opencm_ide_111.png)
...
![](/img/software/opencm_ide/opencm_ide_114.png)
...
![](/img/software/opencm_ide/opencm_ide_115.png)
...
![](/img/software/opencm_ide/opencm_ide_116.png)
...
![](/img/software/opencm_ide/opencm_ide_117.png)
...
![](/img/software/opencm_ide/opencm_ide_118.png)
...
![](/img/software/opencm_ide/opencm_ide_119.png)
...
![](/img/software/opencm_ide/opencm_ide_120.png)
...
![](/img/software/opencm_ide/opencm_ide_123.png)
...
![](/img/software/opencm_ide/opencm_ide_124.png)
...
![](/img/software/opencm_ide/opencm_ide_125.png)
...
![](/img/software/opencm_ide/opencm_ide_126.png)
...
![](/img/software/opencm_ide/opencm_ide_127.png)
...
![](/img/software/opencm_ide/opencm_ide_128.png)
...
![](/img/software/opencm_ide/opencm_ide_129.png)
...
![](/img/software/opencm_ide/opencm_ide_131.png)
...
![](/img/software/opencm_ide/opencm_ide_132.png)

![](/img/software/opencm_ide/opencm_ide_133.png)
...
![](/img/software/opencm_ide/opencm_ide_134.png)

![](/img/software/opencm_ide/opencm_ide_135.png)
...
![](/img/software/opencm_ide/opencm_ide_136.png)
...
![](/img/software/opencm_ide/opencm_ide_137.png)

Once you select the examples the following codes appear.

![](/img/software/opencm_ide/opencm_ide_138.png)
