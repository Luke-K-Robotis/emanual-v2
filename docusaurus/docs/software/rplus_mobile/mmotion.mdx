...
![](/img/software/mobile/mobile_motion_22.jpg)
...
![](/img/software/mobile/mobile_motion_26.jpg)

> Make a pose by moving the motors with the torque off.

![](/img/software/mobile/mobile_motion_27.jpg)
...
![](/img/software/mobile/mobile_motion_36.jpg)
 
1. Enter the name of the new motion group to be created.
2. Click the OK button.

![](/img/software/mobile/mobile_motion_37.jpg)
...
![](/img/software/mobile/mobile_motion_41.jpg)
