...
# Menu Description
![](/img/software/mobile/mobile_motion_01.gif)
...
![](/img/software/mobile/mobile_motion_02.gif) 
...
![](/img/software/mobile/mobile_motion_03.gif) 
...
![](/img/software/mobile/mobile_motion_25.gif)

1. Move to the 51st frame on the timeline.
2. Turn off the torque.

![](/img/software/mobile/mobile_motion_26.webp)

> Make a pose by moving the motors with the torque off.

![](/img/software/mobile/mobile_motion_27.webp)
