...
## Program Layout
![](/img/software/rplus2/scratch/roboplus_scratch_01.webp)
...
![](/img/software/rplus2/scratch/roboplus_scratch_02.webp)
...
![](/img/software/rplus2/scratch/roboplus_scratch_03.webp)
...
![](/img/software/rplus2/scratch/roboplus_scratch_04.webp)

1. Connect the BT-210 module to the Controller.
2. Power on the Controller.
3. Pair the BT-210 module to your PC: [How to Connect BT-210 to PC](https://emanual.robotis.com/docs/en/edu/mini/#connect-to-mini)
...
![](/img/software/rplus2/scratch/roboplus_scratch_05.webp)
