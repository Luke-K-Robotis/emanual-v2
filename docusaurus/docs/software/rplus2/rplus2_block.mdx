...
![](/img/software/rplus2/block/block_search.webp)
> Searching `ROBOTIS` will also find R+Block

![](/img/software/rplus2/block/block_install.webp)
> Install
...
![](/img/software/rplus2/block/menu.webp)
...
![](/img/software/rplus2/block/change_product.webp)
...
![](/img/software/rplus2/block/change_blocklevel.webp)
...
![](/img/software/rplus2/block/block_trash_01.webp)

## Zoom In/Out
Pinch gesture on the workspace area will allow to zoom in or out the screen.

![](/img/software/rplus2/block/block_zoom.webp)
...
![](/img/software/rplus2/block/block_hide_02.webp)
...
![](/img/software/rplus2/block/block_delete.webp)  
...
![](/img/software/rplus2/block/block_undoredo.webp)
...
![](/img/software/rplus2/block/block_run_01.webp)
...
![](/img/software/rplus2/block/block_run_02.webp)

If the robot is connected, "Waiting..." message will appear on the screen.

![](/img/software/rplus2/block/block_run_03.webp)
...
![](/img/software/rplus2/block/block_run_04.webp)
...
![](/img/software/rplus2/block/block_option_menu.webp)

## Settings
`Bluetooth`, `e-Manual`, `Version Information` can be found.

![](/img/software/rplus2/block/block_option_setting.webp)
...
![](/img/software/rplus2/block/block_option_bluetooth.webp)

### e-Manual
Online manual can be found.

![](/img/software/rplus2/block/block_option_emanual.webp)

### Version Info
Current version of the program can be found.

![](/img/software/rplus2/block/block_option_version.webp)

## Workspace
Save, load, clear or create a new workspace from this menu.

![](/img/software/rplus2/block/block_option_project.webp)

### Save
Saves current workspace.

![](/img/software/rplus2/block/block_option_save_01.webp)
> Enter the name and tap `OK` button.

![](/img/software/rplus2/block/block_option_save_02.webp)
...
![](/img/software/rplus2/block/block_option_load.webp)

### Clear
Clears all the blocks in the workspace.  
Workspace name and `Start` block will remain.

![](/img/software/rplus2/block/block_option_erase.webp)

### New
Create a new workspace.

![](/img/software/rplus2/block/block_option_create_01.webp)
> Enter the workspace name and tap `OK` button.

![](/img/software/rplus2/block/block_option_create_02.webp)

### Delete
Lists up the saved workspace. To delete the workspace, select and hold the workspace file.

![](/img/software/rplus2/block/block_option_delete.webp)

## Task
The code can be converted to Task code and be downloaded.

![](/img/software/rplus2/block/block_option_task.webp)

This requires R+Task. If R+Task is not installed, Google Play will appear on the screen.

![](/img/software/rplus2/block/block_option_task_search.webp)
> Enter `ROBOTIS` and search for `R+m.Task2` in the Google Play

![](/img/software/rplus2/block/block_option_task_install.webp)
> Install R+m.Task2
...
![](/img/software/rplus2/block/block_option_convert.webp)
...
![](/img/software/rplus2/block/block_option_download.webp)
