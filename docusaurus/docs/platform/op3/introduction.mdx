...
import ChargingBattery from '@site/docs/_partials/platform/op3/charging_battery.mdx';
import IntroductionRev2 from '@site/docs/_partials/platform/op3/introduction_rev2.mdx';
...
# Introduction
## What is OP3?
![](/img/platform/op3/op3_product_rev2.webp)
...
- Here are some mechanical differences :
  ...
  ![](/img/platform/op3/op3_002_rev2.webp)
  - The location of the I/O ports has been changed.

  ![](/img/platform/op3/op3_003_rev3.webp)
...
![](/img/platform/op3/op3_005_rev3-1.webp)

## Layout
![](/img/platform/op3/op3_006_rev3.webp)

![](/img/platform/op3/op3_007_rev3.webp)
