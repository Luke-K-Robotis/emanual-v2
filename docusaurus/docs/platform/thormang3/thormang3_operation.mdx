...
### What is OPC
![](/img/platform/thormang3/thormang3_046.webp)
...
3. Run Visualization Tool  
  ...
  ```
    ...
    ![](/img/platform/thormang3/thormang3_047.webp)
...
6. Check all joints are switched to selected mode.  
    ![](/img/platform/thormang3/thormang3_048.webp)
...
7. Initial Posture  
  ...
  Click `Robot Init Pose` button at the top of demo program(Effective regardless of current mode)  
    ...
    ![](/img/platform/thormang3/thormang3_049.webp)

    ![](/img/platform/thormang3/thormang3_050.webp)
...
1. Move to Robot Init Pose
  - Click `Robot Init Pose` button on the top.  
    ...
    ![](/img/platform/thormang3/thormang3_051.webp)
...
2. Measure FT Air  
  ...
  - **THORMANG3 must be hanging on the lift for this procedure.**
    ...
    ![](/img/platform/thormang3/thormang3_052.webp)
...
3. Measure FT Ground  
    ...
    ![](/img/platform/thormang3/thormang3_053.webp)
...
- Assemble LaserScan  
  ...
  Click `Make PointCloud` button in the `Basic Control` of the demo program.  
      ...
      ![](/img/platform/thormang3/thormang3_056.webp)
  ...
  3. Check the pointcloud  
    Assembled pointcloud can be seen on the RViz screen.  
      ...
      - Check PointCloud on the 3D screen  
        ...
        ![](/img/platform/thormang3/thormang3_057.webp)
...
- Head Joint Control  
  ...
  ![](/img/platform/thormang3/thormang3_058.webp)
...
![](/img/platform/thormang3/thormang3_059.webp)
...
![](/img/platform/thormang3/thormang3_060.webp)
...
1. Move to Robot Init Pose
  - Click the `Robot Init Pose` button.  
    ...
    ![](/img/platform/thormang3/thormang3_061.webp)
...
3. Set Mode
  - Click the `Walking Module` button to switch to Walking Mode.
    ...
    ![](/img/platform/thormang3/thormang3_062.webp)

4. Balance On
  - Select the `Walking` tab from the demo program.
  - Click `On` button in the `Balance Control`.

    ![](/img/platform/thormang3/thormang3_063.webp)
    ...
    ![](/img/platform/thormang3/thormang3_064.webp)
...
![](/img/platform/thormang3/thormang3_075.webp)
...
```  
![](/img/platform/thormang3/thormang3_tuner_client.webp)   

### How to use GUI program
![](/img/platform/thormang3/thormang3_tuner_client_01.webp)    
