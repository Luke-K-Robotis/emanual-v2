...
```
    ...
    ![](/img/platform/turtlebot3/basic_examples/panorama/panorama_view.png)
...
```
    ...
    ![](/img/platform/turtlebot3/basic_examples/automatic_parking/scan.png)

    - `/scan_spot`

    ![](/img/platform/turtlebot3/basic_examples/automatic_parking/scan_spot.png)
...
```
    ...
    ![](/img/platform/turtlebot3/basic_examples/load_multiple_turtlebot3s/multi_turtlebot_rqt.png)
