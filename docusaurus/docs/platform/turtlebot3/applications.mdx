...
- Make sure to run the [Bringup](/docs/platform/turtlebot3/bringup#bringup) instructions before use of the instruction
...
```
    ...
    ![](/img/platform/turtlebot3/basic_examples/panorama/panorama_view.webp)
...
```
    ...
    **NOTE**: Specify `${TB3_MODEL}`: `burger`, `waffle`, `waffle_pi` before excuting the command. Set the permanent export setting by following [Export TURTLEBOT3_MODEL](/docs/platform/turtlebot3/export_turtlebot3_model) instruction.
...
```
    ...
    ![](/img/platform/turtlebot3/basic_examples/automatic_parking/scan.webp)

    - `/scan_spot`

    ![](/img/platform/turtlebot3/basic_examples/automatic_parking/scan_spot.webp)
...
```
    ...
    ![](/img/platform/turtlebot3/basic_examples/load_multiple_turtlebot3s/multi_turtlebot_rqt.webp)
...
[virtual slam by multiple turtlebot3s]: /docs/platform/turtlebot3/simulation#2-excute-slam
