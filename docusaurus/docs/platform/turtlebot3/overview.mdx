...
![](/img/platform/turtlebot3/logo/logo_raspberry_pi.webp) **Rasbperry Pi 4**  
...
![](/img/platform/turtlebot3/logo/logo_nvidia.webp) **Jetson Nano**  
...
- TurtleBot3 Providers  
  ![](/img/platform/turtlebot3/logo/logo_platform_providers.webp)

- TurtleBot3 Partners and Research Collaborators  
  ![](/img/platform/turtlebot3/logo/logo_platform_sponsors.webp)

  \* Each collaboration member's web page can be found [here][partners].

- TurtleBot3 Distributors  
  ![](/img/platform/turtlebot3/logo/logo_platform_players.webp)
