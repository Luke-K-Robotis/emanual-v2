...
![](/img/platform/turtlebot3/overview/overview/turtlebot3_with_logo.png)



:::tip

![](/img/platform/turtlebot3/logo/logo_raspberry_pi.png) **Rasbperry Pi 4**  
...
![](/img/platform/turtlebot3/logo/logo_nvidia.jpg) **Jetson Nano**  
...
<details>
<summary>
![](/img/icon_unfold.png) TurtleBot3 is a collaborative project...
</summary>
...
- TurtleBot3 Providers  
  ![](/img/platform/turtlebot3/logo/logo_platform_providers.png)

- TurtleBot3 Partners and Research Collaborators  
  ![](/img/platform/turtlebot3/logo/logo_platform_sponsors.png)

  \* Each collaboration member's web page can be found [here][partners].

- TurtleBot3 Distributors  
  ![](/img/platform/turtlebot3/logo/logo_platform_players.png)
...
<details>
<summary>
![](/img/icon_unfold.png) Check out these ROS and TurtleBot3 Publications:
</summary>
...
<details>
<summary>
![](/img/icon_unfold.png) Click to expand recent news.
</summary>
