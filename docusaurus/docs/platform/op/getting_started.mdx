...
![](/img/platform/op/op_product.webp)

<iframe width="560" height="315" src="https://www.youtube.com/embed/tJpvahsOkRM" frameborder="0" allowfullscreen></iframe>

![](/img/platform/op/op_introduction_01.webp)

![](/img/platform/op/op_introduction_02.webp)
...
# Getting Started
## Package Contents
![](/img/platform/op/op_partlist.webp)
...
## Layout
![](/img/platform/op/op_layout_01.webp)

![](/img/platform/op/op_layout_02.webp)

## Charging Battery
![](/img/platform/op/op_battery_charge_01.webp)

**Charging Status**

![](/img/platform/op/op_battery_charge_02.webp)
...
:::
    ...
    ![](/img/platform/op/op_003.webp)

4. Switching On  
  Turn rocker switch on located on the back lower right side of DARWIN-OP.

    ![](/img/platform/op/op_004.webp)

Once power is on the following will take place sequentially

|Status|Description|
|:---:|:---:|
|![](/img/platform/op/op_005.webp)|The eye LED is turned on<br />Power is on|
|![](/img/platform/op/op_006.webp)|The head LED is turned on green<br />The PC inside DARWIN-OP operating system is booting|
|![](/img/platform/op/op_007.webp)|The head LED is turned on amber<br />Demo program is loaded and DARWIN-OP is ready to operate|
|![](/img/platform/op/op_008.webp)|Demo program is loaded and DARWIN-OP is ready to operate|
...
|![](/img/platform/op/op_013.webp)|![](/img/platform/op/op_014.webp)|![](/img/platform/op/op_015.webp)|![](/img/platform/op/op_016.webp)|
|:---:|:---:|:---:|:---:|
|1. Thank you|2. Introduction|3. Wow|4. Sit Down|
|![](/img/platform/op/op_017.webp)|![](/img/platform/op/op_018.webp)|![](/img/platform/op/op_019.webp)|![](/img/platform/op/op_020.webp)|
...
3. Select a color(s) card and place it in front of DARWIN-OP. The card should be approximately 15cm (about 6in) in front of DARWIN-OP.
  ...
  ![](/img/platform/op/op_023.webp)![](/img/platform/op/op_024.webp)![](/img/platform/op/op_025.webp)
