...
# Getting Started
## Package Contents
![](/img/platform/op/op_partlist.jpg)
...
## Layout
![](/img/platform/op/op_layout_01.jpg)

![](/img/platform/op/op_layout_02.jpg)

## Charging Battery
![](/img/platform/op/op_battery_charge_01.jpg)

**Charging Status**

![](/img/platform/op/op_battery_charge_02.jpg)
...
:::
    ...
    ![](/img/platform/op/op_003.jpg)

4. Switching On  
  Turn rocker switch on located on the back lower right side of DARWIN-OP.

    ![](/img/platform/op/op_004.jpg)

Once power is on the following will take place sequentially

|Status|Description|
|:---:|:---:|
|![](/img/platform/op/op_005.jpg)|The eye LED is turned on<br />Power is on|
|![](/img/platform/op/op_006.jpg)|The head LED is turned on green<br />The PC inside DARWIN-OP operating system is booting|
|![](/img/platform/op/op_007.jpg)|The head LED is turned on amber<br />Demo program is loaded and DARWIN-OP is ready to operate|
|![](/img/platform/op/op_008.jpg)|Demo program is loaded and DARWIN-OP is ready to operate|
...
|![](/img/platform/op/op_013.jpg)|![](/img/platform/op/op_014.jpg)|![](/img/platform/op/op_015.jpg)|![](/img/platform/op/op_016.jpg)|
|:---:|:---:|:---:|:---:|
|1. Thank you|2. Introduction|3. Wow|4. Sit Down|
|![](/img/platform/op/op_017.jpg)|![](/img/platform/op/op_018.jpg)|![](/img/platform/op/op_019.jpg)|![](/img/platform/op/op_020.jpg)|
...
3. Select a color(s) card and place it in front of DARWIN-OP. The card should be approximately 15cm (about 6in) in front of DARWIN-OP.
  ...
  ![](/img/platform/op/op_023.jpg)![](/img/platform/op/op_024.jpg)![](/img/platform/op/op_025.jpg)
