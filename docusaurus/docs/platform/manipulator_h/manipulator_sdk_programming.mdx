...
- Installation Package
  ...
  - Start Visual Studio go to “Project Properties -> VC++ Directories -> Include Directories” set Eigen’s source directory.
    ...
    ![](/img/platform/manipulator_h/manipulator_h_046.webp)

    ![](/img/platform/manipulator_h/manipulator_h_047.webp)

    ![](/img/platform/manipulator_h/manipulator_h_048.webp)
...
![](/img/platform/manipulator_h/manipulator_h_070.webp)
...
![](/img/platform/manipulator_h/manipulator_h_071.webp)
...
![](/img/platform/manipulator_h/manipulator_h_072.webp)

![](/img/platform/manipulator_h/manipulator_h_073.webp)

![](/img/platform/manipulator_h/manipulator_h_074.webp)
...
## SDK Flowchart
![](/img/platform/manipulator_h/manipulator_h_075.webp)
